...
Examples:
- "weather in California" ΓåÆ query_type: weather, is_specific: false, needs_clarification: false, items: []
- "cattle breeds for my farm" ΓåÆ query_type: livestock, is_specific: true, needs_clarification: true, items: ["cattle"]
- "animal recommendation for maize field" ΓåÆ query_type: mixed, is_specific: false, needs_clarification: true, items: ["maize"]
- "my tomato plants have yellow leaves" ΓåÆ query_type: crops, is_specific: true, needs_clarification: false, items: ["tomato"]"""
...
CRITICAL: Options must be direct answers to the exact question you asked.
...
CRITICAL: Options must directly answer your question and stay in the same intent category.
...
Examples:
- "weather in Hayward, California" ΓåÆ location: "Hayward, California", is_forecast: false, forecast_days: null
- "150 day forecast for New York" ΓåÆ location: "New York", is_forecast: true, forecast_days: 150
- "weather for my tomato farm in Boston" ΓåÆ location: "Boston", is_forecast: false, has_farm_context: true"""
                        parsed_query_result[0] = weather_parser.invoke(parse_prompt)
                    except Exception as e:
                        exception_result[0] = e
