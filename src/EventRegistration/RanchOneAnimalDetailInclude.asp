...
End if
		...
		<td align="center"  valign = "top" class = "body" ><br>                        
           <table border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  width = "200" >
				<tr>
					<td align = "center" class = "body"><a href = "Details.asp?ID=<%=alpacaID%>" ><img src = "<%= PhotoID %>" width="90" border = "0"></a>
					</td>
				</tr>
			</table>
	      			...
	      			<a href = "Details.asp?ID=<%=alpacaID%>" class = "body"><%=Trim(rs("FullName"))%></a><br>
								...
								<% If Len(rs("price")) > 2 Then %>
									...
									<% End If %>
										...
										<div align = "right">	<a href = "Details.asp?ID=<%=alpacaID%>" class = "body">View Details</a></div><br>
