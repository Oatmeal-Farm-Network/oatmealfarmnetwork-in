...
End if
		...
		<td align="center"  valign = "top" class = "list" ><br>                        
           <table border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" height = "130" width = "162" >
				<tr>
					<td align = "center" class = "body"><a href = "Details.asp?ID=<%=alpacaID%>" ><img src = "/uploads/<%= PhotoID %>" height="110" border = "0"></a><br>
					<%=rs("Category")%>
					</td>
				</tr>
			</table>
