...
<!--#Include virtual="JudgesHeader.asp"--> 

<a name="Top"></a>
<% PageTitleText = "Add a Judge"  %>
...
if completion="True" then %>
  <font color = "brown"><b>Your Judge has been added. Use the form below to add another Judge or click on the <a href = "JudgeEditJudges.asp?EventID=<%=eventid%>" class = "menu2" >Edit Judges</a> to make changes.</b></font>
...
<form  name="form" action="JudgesAddJudgeHandleForm.asp?EventID=<%=EventID%>" method = "post">
...
<tr><td  align = "center" colspan = "2">
				...
				<input type=submit class = "regsubmit2" value = "Add Judge" >
	</form>
		</td>
...
<table width = "900" align = "center">
   <tr><td class="Menu2" align = "center"><b><i>Note: To edit judges please select <a href = "JudgeEditJudges.asp?EventID=<%=eventid%>" class = "menu2" >Edit Judges</a>.</i></b>
   </td>
   </tr>
   </table>
<br>
