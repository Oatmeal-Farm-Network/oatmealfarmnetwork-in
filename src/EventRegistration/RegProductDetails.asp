...
<% else %>
<table border = "0"  valign = "top" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0  width = "400" ><tr><td ><IMG alt="main image" border=0  name='but1' src="<%=buttonimages(1)%>" align = "center" width = "400"></td></tr></table>
<% end if%>
</td></tr></table>		
