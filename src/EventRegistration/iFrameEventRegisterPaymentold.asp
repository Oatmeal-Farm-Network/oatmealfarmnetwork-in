...
<BODY border="0" onload="location.href='#top'"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"   align = "center"><table border = "0" width = "100%" height = "100%" bgcolor = "<% =backgroundcolor%>"><tr><td valign = "top">
<table width = "700" align = "center" border = "0">
<tr><td class = "body"><a name="top"></a><br />
<h1>Confirm Your Order</h1>
Double check your order and then select the button on the bottom of this page:
</td>
</tr>
</table>
...
<table  border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" width = "700" align = "center" bgcolor = "white" border = "1">	
<tr>
...
<tr>
  <td class = "body" width= "380"><img src = "images/px.gif" width = "5" height = "1" alt = "Event registration"><b>Service</b></td>
  <td class = "body" align = "center" width = "110"><b>Price</b></td>
  <td class = "body" align = "center" width = "100"><b>Quantity</b></td>
  <td class = "body" align = "right" width = "100"><b>Total</b></td>
</tr>
</table>
</td>
</tr>
	...
	if not rs.eof then %>
	  ...
	  <tr >
		<td class = "body" colspan = "4" height = "30">
	       <img src = "/images/px.gif" width = "5" alt = "Sponsorship Options"><b>Sponsorships</b>
	     </td>
	   </tr>
	<%
...
if SponsorQTYArray(SponsorshipLevelID) < 1 and OldSponsorQTY > 0  and NOT(Update = "True") then
 ...
 if len(SponsorQTYArray(SponsorshipLevelID)) > 0 then
    ...
    <td class = "body" align = "right" width = "110">	
 		<%=SponsorQTYArray(SponsorshipLevelID)%>
...
<% If FirstGroup = True then
 ...
 <% end if  %>  
    <tr ><td class = "body" colspan = "4" height ="30"><img src = "/images/px.gif" width = "5"  alt = "Vendor Registration"><b>Vendor Options</b></td></tr>
	<%
	counter = 0
	While Not rs.eof  
	counter = counter + 1
...
<% If FirstGroup = True then
 ...
 <% end if  %>  
	<tr ><td class = "body" colspan = "4" height ="30"><img src = "/images/px.gif"  width = "5" alt = "Class Registration"><b>Classes</b></td></tr>
	<%
...
<% if len(Paypal) > o and   len(PaypalEmail) > 0 then %>
...
<form action="https://www.paypal.com/cgi-bin/webscr" target= "Blank" method="post">
    ...
    <input type="hidden" name="return" value="http://www.sojaa.com/fibermaniaRegistration.asp">
    <input type="hidden" name="cbt" value="Complete Your Registration">
       <input type="hidden" name="cancel_return" value="http://www.sojaa.com/fibermaniaRegistration.asp">
    <input type="hidden" name="notify_url" value="Http://www.AndresenEvents.com/EventOrderCompletion2.asp">   
