...
<% if len(session("peopleID")) > 0 then %> 
 ...
 <table border = "0" width = "100%" height = "100%" bgcolor = "<% =backgroundcolor%>"><tr><td valign = "top"><br />
...
if len(PeopleID) > 0 then
sql2 = "select * from Animal where PeopleID = " & PeopleID & " order by AnimalsName "
	acounter = 1
	Set rs2 = Server.CreateObject("ADODB.Recordset")
	rs2.Open sql2, conn, 3, 3 
...
<form action= "iFrameEventRegister.asp?EventID=<%=EventID%>&Update=True#FormTop" name="OrderForm" method = "post">


<%
sql = "select RegistrationID from RegistrationTemp where Status='Draft' and EventId = " & EventID & " and PeopleID =" & PeopleID & " Order by ItemPrice Desc"
	Set rs = Server.CreateObject("ADODB.Recordset")
	rs.Open sql, conn, 3, 3   
	if not rs.eof then
	...
	Query =  Query & " Values ('Draft', " & EventID & " , " & PeopleID & ")" 
		Conn.Execute(Query) 
	rs.close	
...
<%
 ...
 sqlp = "select * from AnimalHalterClassesLookup where SpeciesID = 1"
      ...
      <% if len(AnimalIDArray(counterx))> 0 then %>
         ...
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=AnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister.asp?RemoveHalterAnimal=True&AnimalID=<%=AnimalIDArray(counterx)%>#Halter" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & PeopleID & " and RegistrationType = 'Production'"
  ...
  <select size="1" name="ProductionAnimalIDArray(<%=counterx %>)" width = "300" style="width: 300px" onchange="submit();">
    ...
    sqlp = "select * from AnimalProductionClassesLookup where SpeciesID = 1"
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(ProductionAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=ProductionAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister.asp?RemoveProductionAnimal=True&AnimalID=<%=ProductionAnimalIDArray(counterx)%>#Production" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & PeopleID & " and RegistrationType = 'Companion'"
  ...
  <select size="1" name="CompanionAnimalIDArray(<%=counterx %>)"  width = "300" style="width: 300px" onchange="submit();">
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(CompanionAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=CompanionAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister.asp?RemoveCompanionAnimal=True&AnimalID=<%=CompanionAnimalIDArray(counterx)%>#Companion" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & PeopleID & " and RegistrationType = 'Fleece'"
  ...
  <select size="1" name="FleeceAnimalIDArray(<%=counterx %>)" width = "300" style="width: 300px"  onchange="submit();">
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(FleeceAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=FleeceAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister.asp?RemoveFleeceAnimal=True&AnimalID=<%=FleeceAnimalIDArray(counterx)%>#Fleece" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & PeopleID & " and RegistrationType = 'SpinOff'"
  ...
  <select size="1" name="SpinOffAnimalIDArray(<%=counterx %>)"  width = "300" style="width: 300px" onchange="submit();">
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(SpinOffAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=SpinOffAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister.asp?RemoveSpinOffAnimal=True&AnimalID=<%=SpinOffAnimalIDArray(counterx)%>#SpinOff" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
<form action= "iFrameEventRegisterPayment.asp?EventID=<%=EventID%>&EventName=<%=EventName%>&OrderTotal=<%=OrderTotal%>&PeopleID=<%=PeopleID%>#Top" name="OrderForm" method = "post">
