...
if DisplayStallQTY > 0 and UpdateDisplayStallPrice > 0 then
	EmailTransactionList = EmailTransactionList & "<tr><td><font face=arial size:2;>Display Stalls</font></td><td><font face=arial size:2;>" & formatcurrency(UpdateDisplayStallPrice) & "</font></td><td><font face=arial size:2;>" & DisplayStallQTY & "</font></td><td><font face=arial size:2;>" &  formatcurrency(UpdateDisplayStallPrice * DisplayStallQTY)   & "</font></td></tr>"
end if
...
if tempQTY > 0 and tempPrice > 0 then
	EmailTransactionList = EmailTransactionList & "<tr><td><font face=arial size:2;>" & tempItemName & "</font></td><td align = right><font face=arial size:2;>" & formatcurrency(tempQTY) & "</font></td><td align = right><font face=arial size:2;>" & tempQTY & "</font></td><td align = right><font face=arial size:2;>" &  formatcurrency(tempPrice * tempQTY)   & "</font></td></tr>"
end if
...
Query =  " UPDATE registrationtemp Set Status = 'Paid'" 
	Query =  Query & " where PeopleID = " & PeopleID & " and EventID = " & EventID & " ;" 
