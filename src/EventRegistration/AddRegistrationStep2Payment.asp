...
<table border = "0" width = "100%" height = "100%" ><tr><td valign = "top" class = "body">
<%
NoPaymentAmount=request.QueryString("NoPaymentAmount")

NoPaymentType=request.QueryString("NoPaymentType")

if len(NoPaymentAmount) > 1 or len(NoPaymentType) > 1 then %>
<font color = 'brown'><b>Registration not completed. <ul>
<%  if len(NoPaymentAmount) > 1 then%>
<li>Please enter a payment amount.</li>
<% end if %>

<%  if len(NoPaymentType) > 1 then%>
<li>Please enter a payment type.</li>
<% end if %>
</ul></b></font>
<% end if %>
</td></tr>
...
<tr><td class = "body" align = "center"><a name="top"></a>
</td>
</tr>
</table>
...
<table  border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" width = "650" align = "center">
  <tr><td height = "4"><img src = "images/px.gif" height = "1" width = "1"></td>	
	<tr>
		...
		<table  border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" width = "650" align = "center">	
		<tr>
  <td class = "body" width= "403"><img src = "images/px.gif" width = "9" height = "1" alt = "Event registration"><b>Service</b></td>
  <td class = "body" align = "center" width = "80"><b>Price</b></td>
  <td class = "body" align = "center" width = "27"><b># &nbsp;&nbsp;</b></td>
  <td class = "body" align = "right" width = "140"><b><img src = "images/px.gif" width = "4" height = "1" />Total<img src = "images/pox.gif" width = "15" height = "1" /></b></td>
</tr>
</table>
</td>
</tr>
...
<img src = "/images/px.gif" width = "5" alt = "Livestock Event registration"> </td>
 ...
 <img src = "/images/px.gif" width = "5" alt = "Livestock event registration"> </td>
  <td class = "body" align = "right" width = "140"> <%=formatcurrency(AnimalTotal,2)%>
...
<% end if %>
	...
	<img src = "/images/px.gif" width = "5" alt = "Elitricity Registration">
...
<% if MaxQTY > 0 then %>  
  ...
  <td class = "body" align = "right">    <input type = "text" value = "<%= SpinOffFee %>" name = "SpinOffFee">
    <% if showdiscount = True then %>   
...
i = 0
 ...
 <img src = "/images/px.gif" width = "5" alt = "Livestock event registration"> </td>
  <td class = "body" align = "right" width = "140"> <%= formatcurrency(AdvertsingQTYArray2(AdvertisingLevelID) * AdvertisingLevelPrice) %>
...
DontNeedTableArray(VendorLevelID) = "Yes"
 ...
 if VendorQTYArray(VendorLevelID) > 0 then %>
   <tr>
	...
	<td class = "body" align = "right" width = "80">	
		<%= formatcurrency(VendorStallPrice) %>
    </td>
    <td class = "body" align = "right" width = "27">	
...
<% end if
 ...
 if MaxExtraTables > 0 then %>
	...
	<img src = "/images/px.gif" width = "5" alt = "Vendor Registration"></td>
</tr>
<% end if %>
<% end if %>
<% 
...
i = 0
 ...
 <tr>
    ...
    <td class = "body" align = "right" classes = "27">	
 		<%=ClassesQTYArray(ClassInfoID)%>


    </td>
	<td class = "body" align = "right" classes = "140">	
		<% if len(ClassInfoStudentFee) > 0 and ClassInfoStudentFee > 0 then %>
...
<% If FirstGroup = True then
 ...
 <% end if  %>  
	...
	<tr ><td class = "body" colspan = "4" height = "30" align = "right" ><b>Total Amount:</b><img src = "/images/px.gif" width = "5" alt = "<%=EventName%> Event Registration"><b><%=formatcurrency(OrderTotal,2) %><img src = "/images/px.gif" width = "10" alt = "<%=EventName%> Event Registration"></b>
		<br /><br />
		</td>
	</tr>

		<tr ><td class = "body" colspan = "4" height = "30" align = "right" >	<form  name=UpdatePagesform method="post" action="AddRegistrationOrderCompletion.asp?EventID=<%=EventID%>&CurrentPeopleID=<%=CurrentPeopleID %>"><b><%  if len(NoPaymentAmount) > 1 then%><font color = "brown"><% end if %>Amount Paid:<%  if len(NoPaymentAmount) > 1 then%></font><% end if %></b><img src = "/images/px.gif" width = "5" alt = "<%=EventName%> Event Registration">$<input type = "text" class="positive" name="PaymentAmount" size ="5"/>
	...
	<tr ><td class = "body" colspan = "4" height = "30" align = "right" ><b><%  if len(NoPaymentType) > 1 then%><font color = "brown"><% end if %>Payment Type:<%  if len(NoPaymentType) > 1 then%></font><% end if %></b><img src = "/images/px.gif" width = "5" alt = "<%=EventName%> Event Registration">	
...
<INPUT TYPE=RADIO NAME="PaymentType" VALUE="Online Payment">Online Payment
	...
	<td class = "body" colspan = "2" height = "30"  >
			<a href = "AddRegistrationStep2.asp?EventID=<%=EventID %>&CurrentPeopleID=<%=CurrentPeopleID %>" class = "body">Go back and make changes.</a>
		</td>
		<td class = "body" colspan = "2" height = "30" align = "right" >
		
		 <input type="hidden" name="OrderTotal" value="<%=OrderTotal %>" >
			 <input type=submit value="Finalize Registration"  class = "regsubmit2" >
		</td>
	</tr>
	</form>
