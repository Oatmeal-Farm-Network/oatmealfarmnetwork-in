...
If Request.Querystring("UpdatePhotoContest" ) = "True" Then
...
%>
<!--#Include file="PhotoContestHeader.asp"--> 

<table border = "0"  cellpadding=0 cellspacing=0 width = "960" align = "center" >
	<tr>
	   <td  valign = "top"   colspan = "3"><br><h2>Photo Contest Overview</h2></td>
	</tr>
...
sql = "select * from Services, ServiceTypeLookup where Services.ServiceTypeLookupID = ServiceTypeLookup.ServiceTypeLookupID and ServiceType = 'PhotoContest' and EventID =  " & EventID & " Order by ServicesID Desc"
'response.write(sql)
...
<form  name=PhotoContestform method="post" action="PhotoContestHome.asp?EventID=<%=EventID%>&UpdatePhotoContest=True">
