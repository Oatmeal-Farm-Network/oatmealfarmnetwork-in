...
<a name="Top"></a>
<table border = "0" cellspacing="0" cellpadding = "0" align = "center" width = "<%=textwidth%>" >
<tr><td class = "roundedtop" align = "left">
		<H1><div align = "left">Add a Registration - Step 2 Place Order</div></H1>
        </td></tr>
        <tr><td class = "roundedBottom" align = "center" width = "<%=textwidth%>">
<br>
...
'response.Write("CurrentPeopleID="  & CurrentPeopleID )
 ...
 <table border = "0" width = "<%=screenwidth - 35%>" height = "100%" bgcolor = "<% =backgroundcolor%>"><tr><td valign = "top">
...
<form action= "AddRegistrationStep2.asp?EventID=<%=EventID%>&CurrentPeopleID=<%=CurrentPeopleiD%>&Update=True#FormTop" name="OrderForm" method = "post">


<%
sql = "select RegistrationID from RegistrationTemp where Status='Draft' and EventId = " & EventID & " and PeopleID =" & CurrentPeopleID & " Order by ItemPrice Desc"
	Set rs = Server.CreateObject("ADODB.Recordset")
	rs.Open sql, conn, 3, 3   
	if not rs.eof then
	...
	Query =  "INSERT INTO RegistrationTemp (Status, EventID, PeopleID)"
	Query =  Query & " Values ('Draft', " & EventID & " , " & CurrentPeopleID & ")" 
		Conn.Execute(Query) 
	rs.close	
    sql = "select RegistrationID from RegistrationTemp where Status='Draft' and EventId = " & EventID & " and PeopleID =" & CurrentPeopleID & " Order by RegistrationID Desc"
...
rs.close
	...
	If rs.eof Then	
		...
		if len(Halternotes) > -1 then
		    Query =  Query & " Halternotes, "
		end if
		if len(VendorNotes) > -1 then
...
<table  border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  width = "<%=screenwidth - 35%>" align = "center">	
<tr><td class = "roundedtop" align = "left">
<table  border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" width = "100%" align = "center">	
<tr>
  <td class = "body" ><img src = "images/px.gif" width = "5" height = "1" alt = "Event registration"><h3>Service</h3></td>
...
if NOT(Update = "True") then 
	...
	sql = "select * from RegistrationTemp where Status='Draft' and EventId = " & EventID & " and PeopleID =" & CurrentPeopleID & " Order by ItemPrice"
	Set rs = Server.CreateObject("ADODB.Recordset")
	rs.Open sql, conn, 3, 3
	while not rs.eof    
...
if Update = "True" then 
	...
	sql = "select RegistrationID from RegistrationTemp where Status='Draft' and EventId = " & EventID & " and PeopleID =" & CurrentPeopleID & " and ServiceDescription = '" & UpdateServiceDescription & "' Order by RegistrationID Desc"
	Set rs = Server.CreateObject("ADODB.Recordset")
	rs.Open sql, conn, 3, 3   
	If rs.eof Then	
...
Wend
 ...
 if ShowAdvertising = True then 
  sql = "select * from AdvertisingLevels  where AvaliableByItself = True and EventID = " & EventID 
	...
	sql2 = "select RegistrationID from RegistrationTemp where Status='Draft' and EventId = " & EventID & " and PeopleID =" & CurrentPeopleID & " and ServiceDescription = '" & UpdateServiceDescription & "' Order by RegistrationID Desc"
...
sql4 = "select * from SponsorshipLevelbenefits, ExtraOptions where OptionType ='Vendor' and SponsorshipLevelbenefits.ExtraOptionID = ExtraOptions.ExtraOptionsID and SponsorshipLevelQTY > 0 and ExtraOptions.EventID = " & EventID & " order by ExtraOptionsPrice"
...
<img src = "/images/px.gif" width = "5" alt = "Livestock Event Registration"> 
	...
	<td class = "body" align = "right" width = "110">	
		<%=formatcurrency(SponsorQTYArray(SponsorshipLevelID) * SponsorshipLevelPrice ) %><img src = "images/px.gif" width = "10" height = "1" alt = "Event registration">
...
<% if  ShowHalterShow = True and FeePerPen > 0 then %>
 ...
 <tr >
		<td class = "body" colspan = "4" height = "30"><a name ="Halter"></a>
	       ...
	       <small><i>Note: the number of animals that you can bring is limited by the number of stalls that you select.</i></small>
	     </td>
	   </tr>
...
<img src = "/images/px.gif" width = "5" alt = "Livestock Event registration"> </td>
 ...
 <img src = "/images/px.gif" width = "5" alt = "Livestock event registration"> </td>
  <td class = "body" align = "right" > <%=formatcurrency(AnimalTotal,2)%>
	...
	<img src = "/images/px.gif" width = "5" alt = "Halter Show Registration">
 </td>
</tr> 
...
<%
 ...
 sqlp = "select * from AnimalHalterClassesLookup where SpeciesID = 1"
      ...
      <% if len(AnimalIDArray(counterx))> 0 then %>
         ...
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=AnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "AddRegistrationStep2.asp?RemoveHalterAnimal=True&AnimalID=<%=AnimalIDArray(counterx)%>#Halter" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
<img src = "/images/px.gif" width = "5" alt = "Livestock Event registration"> </td>
 ...
 <img src = "/images/px.gif" width = "5" alt = "Livestock event registration"> </td>
  <td class = "body" align = "right" > <%=formatcurrency(ProductionPriceTotal,2)%>
	...
	<img src = "/images/px.gif" width = "5" alt = "Production Class Registration">
 </td>
</tr> 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & CurrentPeopleID & " and RegistrationType = 'Production'"
  ...
  <select size="1" name="ProductionAnimalIDArray(<%=counterx %>)" width = "300" style="width: 300px" onchange="submit();">
    ...
    sqlp = "select * from AnimalProductionClassesLookup where SpeciesID = 1"
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(ProductionAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=ProductionAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "AddRegistrationStep2.asp?RemoveProductionAnimal=True&AnimalID=<%=ProductionAnimalIDArray(counterx)%>#Production" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & CurrentPeopleID & " and RegistrationType = 'Companion'"
  ...
  <select size="1" name="CompanionAnimalIDArray(<%=counterx %>)"  width = "300" style="width: 300px" onchange="submit();">
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(CompanionAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=CompanionAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "AddRegistrationStep2.asp?RemoveCompanionAnimal=True&AnimalID=<%=CompanionAnimalIDArray(counterx)%>#Companion" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
<% end if %>
	...
	<img src = "/images/px.gif" width = "5" alt = "Unshown Animals Registration">
...
<img src = "/images/px.gif" width = "5" alt = "Electricity registration"> </td>
  <td class = "body" align = "right" >
  <% if ElectricityQTY > 0 then %>
	1
  <% else %>
...
<% OrderTotal = OrderTotal + ElectricityFee %>
	<img src = "/images/px.gif" width = "5" alt = "Electricity Registration">
 </td>
</tr> 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & CurrentPeopleID & " and RegistrationType = 'Fleece'"
  ...
  <select size="1" name="FleeceAnimalIDArray(<%=counterx %>)" width = "300" style="width: 300px"  onchange="submit();">
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(FleeceAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=FleeceAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "AddRegistrationStep2.asp?RemoveFleeceAnimal=True&AnimalID=<%=FleeceAnimalIDArray(counterx)%>#Fleece" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
If Not rs.eof Then	%>
	  <tr >
		<td class = "body" colspan = "4" height = "30">
	       <img src = "/images/px.gif" width = "5" alt = "Spin-Off Options"><h3>Spin-Off</h3>
	     </td>
	   </tr>
	    <tr ><td class = "body" colspan = "4" height = "5" ><img src = "/images/px.gif" width = "1" alt = "Sponsorship Registration"></td></tr>
 <tr ><td class = "body" colspan = "4" height = "1" bgcolor = "#abacab"><img src = "/images/px.gif" width = "1" alt = "Sponsorship Registration"></td></tr>
...
if Price1Discount > 0 and len(Price1DiscountStartDate) > 5 and len(Price1DiscountStartDate) > 5 then
  if DateDiff("d", Price1DiscountStartDate, now()) > 1 and DateDiff("d", Price1DiscountEndDate, now()) < 1 then
 	 FullSpinOffFee = SpinOffFee
 	 SpinOffFee = Price1Discount
 	  showdiscount = True
	end if 
end if
...
if len(SpinOffQTY) > 0  and len(SpinOffFee) > 0 then
	Price1Total = SpinOffQTY * SpinOffFee
	else
	Price1Total = 0
end if 
...
<% if MaxQTY > 0 then %>  
  ...
  <td class = "body" align = "right">    <input type = "hidden" value = "<%= SpinOffFee%>" name = "SpinOffFee">
    <% if showdiscount = True then %>   
 	   <small><strike><%=formatcurrency(FullSpinOffFee,2)%></strike></small><img src = "images/px.gif" width = "10" alt = "Flece Show Event Registration"><br>
 			<%=formatcurrency(SpinOffFee,2)%>
 			<% else %>
	  <%=formatcurrency(SpinOffFee,2)%>
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & CurrentPeopleID & " and RegistrationType = 'SpinOff'"
  ...
  <select size="1" name="SpinOffAnimalIDArray(<%=counterx %>)"  width = "300" style="width: 300px" onchange="submit();">
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(SpinOffAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=SpinOffAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "AddRegistrationStep2.asp?RemoveSpinOffAnimal=True&AnimalID=<%=SpinOffAnimalIDArray(counterx)%>#SpinOff" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
<% if order = "Even" then
 ...
 <img src = "/images/px.gif" width = "5" alt = "Livestock event registration"> </td>
  ...
  <% OrderTotal = OrderTotal + (AdvertsingQTYArray2(AdvertisingLevelID) * AdvertisingLevelPrice) %>
	<img src = "/images/px.gif" width = "5" alt = "Advertising Registration">
 </td>
</tr> 
...
<% 
end if ' if vegitarian Option = True %>
...
<form action= "AddRegistrationStep2Payment.asp?EventID=<%=EventID%>&EventName=<%=EventName%>&OrderTotal=<%=OrderTotal%>&PeopleID=<%=CurrentPeopleID%>#Top" name="OrderForm" method = "post">
<center>
<% if OrderTotal < 1 then %>
 <input type=submit value="Proceed to Complete Registration" disabled="disabled" class = "regsubmit2" >
<% else %>
 <input type=submit value="Proceed to Complete Registration"  class = "regsubmit2" >
<% end if %>
</center>
