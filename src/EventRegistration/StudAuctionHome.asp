...
If Request.Querystring("UpdateStudAuction" ) = "True" Then
...
<table border = "0"  cellpadding=0 cellspacing=0 width = "950" align = "center" >
	<tr>
	   <td  valign = "top"   colspan = "3"><br><h2>Stud Auction Overview</h2></td>
	</tr>
...
sql = "select * from Services, ServiceTypeLookup where Services.ServiceTypeLookupID = ServiceTypeLookup.ServiceTypeLookupID and ServiceType = 'Stud Auction' and EventID =  " & EventID & " Order by ServicesID Desc"
'response.write(sql)
...
<form  name=StudAuctionform method="post" action="StudAuctionHome.asp?EventID=<%=EventID%>&UpdateStudAuction=True">
