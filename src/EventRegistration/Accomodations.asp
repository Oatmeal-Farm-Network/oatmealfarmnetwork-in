...
<tr><td class = "body2" colspan = "2" ><br><h1><%=EventName %> Accomodations</h1>
</td>
</tr>
...
<table border = "3" bordercolor = "<%=PageHightlightColor%>" cellpadding=0 cellspacing=0 width = "<%=textwidth %>" bgcolor = "<%=PageHightlightColor%>" align = "center" >
	<tr>
		<td class = "body">	
