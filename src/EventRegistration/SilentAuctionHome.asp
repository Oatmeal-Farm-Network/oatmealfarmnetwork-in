...
<title>Silent Auction Registration</title>
...
<table border = "0"  cellpadding=0 cellspacing=0 width = "980" align = "center" >
	<tr>
	   <td  valign = "top"   colspan = "3"><br><h2>Silent Auction Overview</h2></td>
	</tr>
...
sql = "select * from Services, ServiceTypeLookup where Services.ServiceTypeLookupID = ServiceTypeLookup.ServiceTypeLookupID and ServiceType = 'Silent Auction' and EventID =  " & EventID & " Order by ServicesID Desc"
'response.write(sql)
...
<form  name=SilentAuctionform method="post" action="SilentAuctionHome.asp?EventID=<%=EventID%>&UpdateSilentAuction=True">
 <table border = "0"  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0  width = "980" align = "center" >
 <tbody>
	<tr>
	  <td valign = "top">
	...
	<tr >
	    <td class = "body" align = "right">Donations must be made by:&nbsp;</td>
...
<script language="JavaScript" type="text/javascript" src="/cgi-bin/wysiwyg-settings.js"></script>
 <b>Silent Auction Description:</b>
