...
<Table border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"   align = "center" valign = "top" width = "720">
		...
		<table border="0" cellspacing="0" cellpadding="5" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  width = "700" >
		     	<td  class = "body">
	
				<% If Len(Image1) > 2 then%>
						<img src = "<%=Image1%>" align = "<%=ImageOrientation1%>" width = "200" border = "1" Hspace="30" Vspace="10">
					<% End If %>
				<%=PageText%><br><br>
