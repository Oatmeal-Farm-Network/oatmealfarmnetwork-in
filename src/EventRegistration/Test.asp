...
<form>
<TEXTAREA  ID="textarea1" ><%=ClassInfoDescription%></textarea><br>
</form>
...
<tr>
 ...
 <td class = "body2"><small>Description:</small><br><TEXTAREA NAME="ClassInfoDescription(<%=rowcount%>)" cols="70" rows="11" wrap="file" ID="textarea1" ><%=ClassInfoDescription%></textarea><br>
