...
<Table border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  valign = "top" align = "right" width = "310" height = "320"><tr><td valign = "top" align = "right" ><IMG WIDTH=300 ID="myImage" NAME="myImage" SRC="/images/px.gif" valign = "top" >			
...
<%
  ...
  Set rs = Server.CreateObject("ADODB.Recordset")
		...
		<b>Types of events that you wish to view :</b><select  name="view">
