...
export const DIRECTORY_TYPE_TO_BUSINESS_TYPE = {
    ...
    'fisheries': 'Fisheries',
    'fishermen': 'Fishermen',   
    'food-aggregators': 'Food Aggregators',
    'food-cooperatives': 'Food Cooperative',
    'food-hubs': 'Food Hub',
    'grocery-stores': 'Grocery Store',
    'herb-and-tea-producers': 'Herb & Tea Producer',
    'hunger-relief-organizations': 'Hunger Relief Organization',
