...
export default function AboutCSA() {
  ...
  const capabilities = [
    { icon: <S><path d="M17 8C8 10 5.9 16.17 3.82 20.99"/><path d="M9.1 17.64C10.63 16.13 12.5 14.5 17 13"/><path d="M17 8c0 6-5 9-5 9"/></S>, title: 'Share & Subscription Setup', body: 'Define FPO share types — size, price, frequency (weekly, biweekly, seasonal) — and open subscriptions for members to join.' },
  ...
  return (
    <div className="min-h-screen font-sans" style={{ backgroundColor: '#f7f2e8' }}>
      <PageMeta
        title="FPO Shares | Oatmeal Farm Network"
        description="Run your Farmer Producer Organisation produce-share program on OFN — share setup, member rosters, distribution scheduling, payment tracking, and pickup management."
        canonical="https://oatmealfarmnetwork.in/platform/fpo"
      />
      <Header />
      ...
      <div className="mx-auto px-4 pt-2" style={{ maxWidth: '1300px' }}>
        <div className="relative w-full overflow-hidden rounded-xl">
          <img src="/images/CSABanner.webp" alt="FPO Shares" className="w-full object-cover" style={{ height: '260px', display: 'block' }} loading="eager" fetchPriority="high" width="1300" height="260" onError={e => { e.target.onerror = null; e.target.style.display = 'none'; }} />
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-8 py-6" style={{ maxWidth: '720px' }}>
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-xs font-bold uppercase tracking-widest" style={{ color: '#ffffff' }}>FPO Shares</span>
            </div>
            <h1 style={{ color: '#ffffff', fontFamily: "'Lora','Times New Roman',serif", fontSize: '2rem', fontWeight: 'bold', margin: '0 0 10px', lineHeight: 1.2 }}>
              Run Your FPO Share Program
            </h1>
            <p style={{ color: '#ffffff', fontSize: '0.92rem', margin: '0 0 16px', lineHeight: 1.6 }}>
              Manage shares, subscribers, pickup schedules, and payments for your Farmer Producer Organisation — all from one simple dashboard.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link to="/fpo" className="bg-white font-bold px-5 py-2.5 rounded-lg shadow hover:shadow-md transition text-sm" style={{ color: ACCENT }}>Browse FPO Programs</Link>
      ...
      <div className="mx-auto px-4 py-8" style={{ maxWidth: '1300px' }}>
        <section className="mt-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-3" style={{ fontFamily: "'Lora','Times New Roman',serif" }}>Farmer Producer Organisation shares, simplified</h2>
          <p className="text-gray-700 leading-relaxed">OFN's FPO tools let farms and producer groups launch and run subscription produce programs without spreadsheets or paper sign-up sheets. Set up share types, collect subscriptions, track who's paid, schedule distributions, and keep members informed with weekly newsletters — all in one place.</p>
        </section>
        ...
        <section className="mt-10 text-center bg-white border border-gray-200 rounded-2xl p-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-2" style={{ fontFamily: "'Lora','Times New Roman',serif" }}>Launch Your FPO Share Program</h3>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link to="/fpo/manage" className="px-6 py-3 rounded-lg text-white font-bold shadow hover:shadow-md transition" style={{ backgroundColor: ACCENT }}>Manage My FPO</Link>
