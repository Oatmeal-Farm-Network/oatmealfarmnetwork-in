...
export default function RelatedSuggestions({ heading = 'Related Saige suggestions', items = [] }) {
  if (!items || items.length === 0) return null;
  return (
    <div style={{ marginTop: 18, padding: 14, background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 12 }}>
      <div style={{ fontSize: 14, fontWeight: 700, color: '#14532d', marginBottom: 10 }}>{heading}</div>
