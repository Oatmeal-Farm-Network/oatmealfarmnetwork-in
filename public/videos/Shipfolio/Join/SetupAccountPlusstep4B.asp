...
if  len(PeopleID) < 2 then
		...
		Query =  Query & " '" & cstr(FormatDateTime(datenow,2)) & "') "
    response.Write("Query = " & Query)
else
...
<% if (Membership ="platinum" or Membership = "complete" or Membership ="plus" or Membership ="vendor" or membership = "basic") and ExistingAccount = false  then %>
...
If lcase(membership) = "plusmonth" then
Rate = 3.00
returnaddress = "http://www.LivestockOfAmerica.com/SignUpCompletionnoemail.asp?PeopleID=" & PeopleID
end if
