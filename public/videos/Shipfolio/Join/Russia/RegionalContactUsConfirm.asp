...
<% Title= "Livestock Of Russia"
Description = "Join Livestock Of Russia. An online marketplace for horses, cattle, dogs, donkeys, goats, chickens, turkeys, emus, rabbits, llamas, alpacas, pigs, and sheep."
currenturl = "https://www.LivestockOfTheWorld.com/join/Russia/"
Image = ""
 %>
...
<meta property="og:title" content="join Livestock Of Russia." />
...
<meta name="twitter:title" content="Livestock Of Russia" />
...
Dim objCDONTSmail
Dim smtpServer
strBody = "<font face='body'>This message was sent from the Livestock Of Russia Interest form."
' Body Data
strBody = strBody & "<br>Please Let Me Know When Livestock Of Russia is Available."
...
oMail.From = "Livestock Of Russia <livestockoftheworld@gmail.com>"
oMail.Subject = "Livestock Of Russia Interest form"
...
<table border="0" cellpadding="5" height = "300" cellspacing="0" width="600" align = 'center' >
    <tr>
      ...
      <br /><br />
        <center><img src ="https://www.globallivestocksolutions.com/Logos/LORLogo.jpg" width = 300 align = center alt = "Livestock Of Russia" /></center>
		<center><big><br><b>Thank You For Your Interest</b><br><br>
		 We will let you know as soon as Livestock Of Russia is available.<br><br>
		</big></center><br><br>
		</td>
	</tr>
</table>
