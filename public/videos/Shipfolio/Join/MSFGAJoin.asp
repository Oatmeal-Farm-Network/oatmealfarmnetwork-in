...
<tr>
<td width = "<%=centerwidth %>"  class = "body roundedtopandbottom" valign = "top"><img src ="/uploads/206356msfgalogo.jpg" width = "403"  align = "right" alt = "Free MSFGA membership"/><br>
<H1><div align = "center">Free Livestock Of America Membership for MSFGA Members</div></H1>Our goal is to offer a fast and simple way to list your goats for sale. 
<br><br />
