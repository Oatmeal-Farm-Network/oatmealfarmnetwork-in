...
<form  name=form method="post" action="/join/SetupAccountPlusstep3.asp">
...
<tr>
	<td align = "left" valign = top class = "body2">
		...
		<br />
               <select id="country" name="country" width="460" style="width: 460px" class = "formbox" ></select><br />
        <small>The list of States / Provinces will auto populate after you select your country.</small>
</tr>

<tr>
	<td  align = "left" class = "body2">
		<font color = "red"><b>*</font></b><b>State / Province</b>
		<br />
		<select name="state" id="state" width="460" style="width: 460px" class = "formbox"></select>
        <br/>
        <script language="javascript">
