...
<div class="container d-flex align-items-center justify-content-center">
  <div class = "row">
    <div class = "col body">
        <a name = "Top"></a><br /><br />
        <center><img src ="https://www.globallivestocksolutions.com/Logos/LOUKLogo.jpg" width = 300 align = center alt = "Livestock Of U.K." /></center>
        <H1><center>Livestock Of The U.K. is coming soon!<center></h1>
        Livestock Of The U.K. is not available yet, but please fill out the form below and we will let you know as soon as the site is available.
         <br><br>
    </div>
  </div>
</div>
