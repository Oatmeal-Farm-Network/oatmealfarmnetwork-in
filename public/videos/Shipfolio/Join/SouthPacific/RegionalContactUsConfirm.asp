...
<% Title= "Livestock Of South Pacific"
Description = "Join Livestock Of South Pacific. An online marketplace for horses, cattle, dogs, donkeys, goats, chickens, turkeys, emus, rabbits, llamas, alpacas, pigs, and sheep."
currenturl = "https://www.LivestockOfTheWorld.com/join/South Pacific/"
Image = ""
 %>
...
<meta property="og:title" content="join Livestock Of South Pacific." />
...
<meta name="twitter:title" content="Livestock Of South Pacific" />
...
Dim objCDONTSmail
Dim smtpServer
strBody = "<font face='body'>This message was sent from the Livestock Of South Pacific Interest form."
' Body Data
strBody = strBody & "<br>Please Let Me Know When Livestock Of South Pacific is Available."
...
oMail.From = "Livestock Of South Pacific <livestockoftheworld@gmail.com>"
oMail.Subject = "Livestock Of South Pacific Interest form"
...
<table border="0" cellpadding="5" height = "300" cellspacing="0" width="600" align = 'center' >
    <tr>
      ...
      <br /><br />
        <center><img src ="https://www.globallivestocksolutions.com/Logos/LOTSPLogo.jpg" width = 300 align = center alt = "Livestock Of South Pacific" /></center>
		<center><big><br><b>Thank You For Your Interest</b><br><br>
		 We will let you know as soon as The Livestock Of South Pacific is available.<br><br>
		</big></center><br><br>
		</td>
	</tr>
</table>
