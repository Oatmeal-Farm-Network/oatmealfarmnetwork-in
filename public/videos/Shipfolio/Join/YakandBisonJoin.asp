...
<img src = "yakandbison.jpg" width = 350 align = right />
<% end if %>
 

<h1>Bison and Yak Ranches</H1>
<h1>Get 1/2 Off Premium Memberships.</h1>
<big>List Unlimited Animals and Products for Sale!</big><br /><br />
...
There are no time limitations on how long your listings run, as long as you have an active account. There are no hidden costs and no commissions on sales. You can add, change, or eliminate information on your listings at any time. <br><br />
</td></tr>
</table>
<% else %>
