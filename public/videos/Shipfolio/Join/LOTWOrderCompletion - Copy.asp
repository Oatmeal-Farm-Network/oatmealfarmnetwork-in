...
ObjSendMail.From =  "Livestock of Canada <pacamail@theandresengroup.com>"
else
ObjSendMail.From =  "Livestock of America <pacamail@theandresengroup.com>"
end if

strSubject = "Your Livestock of America Membership has been Created"

strBody = "<font face='arial'>Dear " & PeopleFirstName & ",<br>" & vbCrLf 
strBody  = strBody &  "This e-mail has been sent to you from http://www.LivestockOfAmerica.com." & vbCrLf 
strBody = strBody & "<br>Your new account with Livestock of America has been successfully created.<br><br>" & vbCrLf 
strBody = strBody & "Thank you for registering with us.<br>"& vbCrLf 
strBody = strBody & "If you have not set your password yet please go to: "& vbCrLf 
strBody = strBody & "<a href = 'http://www.LivestockOfAmerica.com/SignUpCompletionPage.asp?PeopleID=" & PeopleID & "'>  http://www.LivestockOfAmerica.com/SignUpCompletionPage.asp?PeopleID=" & PeopleID & "</a><br>"& vbCrLf 
strBody = strBody & "(If the link does not work then copy and paste the link into your web browser).<br><br>"& vbCrLf 
if len(ReferringPeopleID) > 0 then
strBody = strBody & "<br><b>Since you reffered by " & ReferringBusinessName & " we have added two months to your membership!</b><br><br>"& vbCrLf 
end if
strBody = strBody & "If you have any questions please <a href = 'http://www.LivestockOfAmerica.com/ContactUs.asp' >contact us </a> and let us know.<br><br>" & vbCrLf 
strBody = strBody & "Thank you for joining Livestock Of America! </font><br><BR><BR>"& vbCrLf 

strBody = strBody & "<img src='http://www.livestockofamerica.com/massemails/LOALogo.jpg' width=299 height = 90 align = 'left'>" & vbCrLf 
...
ObjSendMail.Bcc= "webartistsbiz@gmail.com, NewCustomer@LivestockOfAmerica.com"
ObjSendMail.Subject = strSubject
ObjSendMail.From =  "Livestock Of America <NewCustomer@LivestockOfAmerica.com>"
...
if len(ReferringPeopleID) > 0 and SubscriptionLevel = 4 then

smtpServer = "mail.AlpacaInfinity.com"
ObjSendMail.From =  "Livestock of America <pacamail@theandresengroup.com>"
strSubject = "Livestock of America Referral"

strBody = "<font face='arial'>Dear " & ReferringPeopleFirstName & ",<br>" & vbCrLf
strBody  = strBody &  BusinessName & " signed up with  Livestock of America and they gave you credit for referring them.<br>"  & vbCrLf
strBody = strBody & "<br>As a thank you for referring " &  BusinessName & " <b>we have added two months to your membership and we will send you " & formatcurrency(referralamount,2) & "</b>, which we will send you at the end of the month with all other money that you have earned this month by referrals.<br><br>"  & vbCrLf

strBody = strBody & "If you have any questions please <a href = 'http://www.LivestockOfAmerica.com/ContactUs.asp' >contact us </a> and let us know.<br><br>"   & vbCrLf
strBody = strBody & "Thank you for choosing Livestock Of America! </font>"  & vbCrLf
...
ObjSendMail.To = ReferringPeopleEmail
ObjSendMail.BCC =   "Livestock Of America <NewCustomer@LivestockOfAmerica.com>"
ObjSendMail.Subject = strSubject
ObjSendMail.From =  "Livestock Of America <NewCustomer@LivestockOfAmerica.com>"
