...
<img src = "PigsJoin.jpg" width = 350 align = right />
<% end if %>
<H1>Sell your Pigs and Products at 1/2 Price</h1>
 

<h2>December is Pig Month</H2>
<big>Get 1/2 off a premium memberships this month.</big><br /><br />
...
<big>You can list your pigs and products only on the marketplace website for the country you do business in</big> (with the exception of the LOTW Holiday Bazaar, which is available to all premium members). If we do not have a marketplace for your country yet, we are sorry. Please <a href = "/contactus.asp" class = body>Contact Us</a> and let us know where your business is and we will keep you informed on when a website for your area will be available.
<br>
<br>
</td></tr></table>
...
<b>Discount Price: $24.47 USD / Year</b>
<br /><br />
...
<center>
<br />Full Price: $48.95 USD / Year<br />
<b>Discount Price: $24.47 USD / Year</b><br />
<form action= '/SetupAccount.asp?Membership=PremiumMonth&website=<%=website %>' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form></center>
</td>
</tr>
<tr>
...
There are no time limitations on how long ads run. There are no hidden costs and no commissions on sales. You can add, change, or eliminate information on your listings at any time. <br><br />
</td></tr>
</table>
<% else %>
...
<b>Discount Price: $24.47 USD / Year</b><br /></center>
