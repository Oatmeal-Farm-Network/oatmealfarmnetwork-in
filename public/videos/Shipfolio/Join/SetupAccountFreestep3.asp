...
<table border = "0" cellspacing="0" cellpadding = "5" align = "center" width = 480"  valign = "top" >
<tr><td class = "body">
...
'Update = "True" 
 ...
 if lcase(country) = "canada" then 
SubscribedWebsite = "Livestock Of Canada" %><br>
<big><b>Since, your business is in Canada, your animals will appear on LivestockOfCanada.com.</b></big>
<% end if %>

<% if (country = "United States (USA)" or lcase(country) = "united states") then
SubscribedWebsite = "Livestock Of America" 
 %><br>
<big><b>Since, your business is in the United States, your animals will appear on LivestockOfAmerica.com.</b></big>
<% 
country = "USA"
end if 
...
Query =  "INSERT INTO peoplewebsitesubscribe (SubscribedWebsite, PeopleId)" 
Query =  Query & " Values ('" & SubscribedWebsite & "'," 
