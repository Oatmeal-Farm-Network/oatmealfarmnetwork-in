...
<div class="container d-flex align-items-center justify-content-center">
  <div class = "row">
    <div class = "col body">
        <a name = "Top"></a>
        <H1><center>Not Available?<center></h1>
        Are you in an area where we don’t have a marketplace to support you yet? Please let us know and we will seriously consider adding a marketplace to support your community.
         <br><br>
...
What Area Are You In?<font color="maroon">*</font><br />
