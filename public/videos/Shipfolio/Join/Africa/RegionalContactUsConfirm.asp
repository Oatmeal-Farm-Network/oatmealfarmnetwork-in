...
<% Title= "Livestock Of Africa"
Description = "Join Livestock Of Africa. An online marketplace for horses, cattle, dogs, donkeys, goats, chickens, turkeys, emus, rabbits, llamas, alpacas, pigs, and sheep."
currenturl = "https://www.LivestockOfTheWorld.com/join/Africa/"
Image = ""
 %>
...
<meta property="og:title" content="join Livestock Of Africa." />
...
<meta name="twitter:title" content="Livestock Of Africa" />
...
'response.write("question=" & Mid(Question, 53, 1) )
...
Dim objCDONTSmail
Dim smtpServer
strBody = "<font face='body'>This message was sent from the Livestock Of Africa Interest form."
' Body Data
strBody = strBody & "<br>Please Let Me Know When Livestock Of Africa is Available."
...
oMail.From = "Livestock Of Africa <livestockoftheworld@gmail.com>"
oMail.Subject = "Livestock Of Africa Interest form"
...
<table border="0" cellpadding="5" height = "300" cellspacing="0" width="600" align = 'center' >
    <tr>
      ...
      <br /><br />
        <center><img src ="https://www.globallivestocksolutions.com/Logos/LOAfricaLogo.jpg" width = 300 align = center alt = "Livestock Of Africa" /></center>
		<center><big><br><b>Thank You For Your Interest</b><br><br>
		 We will let you know as soon as Livestock Of Africa is available.<br><br>
		</big></center><br><br>
		</td>
	</tr>
</table>
