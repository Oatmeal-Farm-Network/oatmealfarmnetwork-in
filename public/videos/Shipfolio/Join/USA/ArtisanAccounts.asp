...
currenturl = "https://www.OatmealFarmNetwork.com/join/"
...
available = True 
BusinessTypeID = 11
MembershipType = "Artisan Food Producer Memberships"
MembershipImage = "ArtisanAccountHeader.jpg"
 %>
...
<!--#Include virtual="/Header.asp"--><div class="container-fluid" id="grad1" >
    ...
    <div>
      <div class = "body">
        <h1>Artisan Producer Memberships</h1>
          </div>
        </div>
    </div>
    </div>
...
<div class ="row">
    <div class ="col" >
      Membership Categories<br />
        ...
        <br />   <br />
            <a class="regsubmit2 body" href="/Join/USA/ArtisanAccounts.asp">&nbsp;Artisan Food Producer&nbsp;</a> &nbsp;
            <a class="roundedtopandbottom body" href="/Join/USA/OtherAccounts.asp">&nbsp;Other&nbsp;</a> 
    </div>
     <div>
      <br /><b>Coming Soon!</b> We are working hard to add functionality that will allow you to order fresh ingredients directly from farms, and receive orders directly from local restaurants.
    </div>
...
<br />
  ...
  <tr><td height = 1 colspan = <%=colspan%>  bgcolor = "#abacab"></td></tr>
       <tr >
         <td width = "220"><font size = 4>Business Profile</font></td>
        <td align = "center"><font color="#6f9243">&#x2714;</font></td>
         <td align = "center"><font color="#6f9243">&#x2714;</font></td>
                 <% if showpremium = true then %>
         <td align = "center"><font color="#6f9243">&#x2714;</font></td>
...
<% end if %>
     ...
     <tr><td height = 1 colspan = <%=colspan%> bgcolor = "#abacab"></td></tr>
      ...
      <tr >
         ...
         <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Intro&Subscription=Artisan' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form></center>
         
         </td>
         <td align = "center">
            <%=CurrencyCode %><strike><%= BasicMonthlyRate%></strike>&nbsp;<b>$9.99</b><%=LocalCurrency%>  / Month
             <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Basic&Subscription=Artisan' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form>
            ...
            <td align = "center">
             ...
             Not Available Yet
        <% else %>  
         <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Business&Subscription=Artisan' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form>
         <% end if %>       
   ...
   if showMarketplaces = True then %>
         <td align = "center"><b><%=CurrencyCode %><%= GlobalMonthlyRate%>&nbsp;<%=LocalCurrency%>  / Month</b>
          <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Global&Subscription=Artisan' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form></center></td></td>
      </tr>
    <% end if  %>
    </table>
<br />
