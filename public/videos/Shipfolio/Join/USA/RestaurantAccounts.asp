...
available = True 
BusinessTypeID = 9
MembershipType = "Restaurant Memberships"
MembershipImage = "RestaurantAccountHeader.jpg"
 %>
...
<div class ="row">
    <div class ="col" >
      Membership Categories<br />
         <a class="roundedtopandbottom body" href="/Join/USA/FarmAccounts.asp">&nbsp;Farm / Ranch&nbsp;</a>&nbsp;
            ...
            <a class="regsubmit2 body" href="/Join/USA/RestaurantAccounts.asp">&nbsp;Restaurant&nbsp;</a> 
        <br />   <br />
    ...
    <div>
      <br /><b>Coming Soon!</b> We are working hard to add functionality that will allow you to order fresh ingredients directly from farms.
    </div>
</div>
...
<% end if %>
     ...
     <tr><td height = 1 colspan = <%=colspan%> bgcolor = "#abacab"></td></tr>
      ...
      <tr >
         ...
         <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Intro&Subscription=Restaurant' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form></center>
         
         </td>
         <td align = "center">
        <%=CurrencyCode %><strike><%= BasicMonthlyRate%></strike>&nbsp;<b>$9.99</b><%=LocalCurrency%>  / Month</b> 
             <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Basic&Subscription=Restaurant' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form>
            ...
            <td align = "center">
             ...
             Not Available Yet
        <% else %>  
         <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Business&Subscription=Restaurant' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form>
         <% end if %>       
   ...
   if showMarketplaces = True then %>
         <td align = "center"><b><%=CurrencyCode %><%= GlobalMonthlyRate%>&nbsp;<%=LocalCurrency%>  / Month</b>
          <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Global' method = "post"><input type=submit value = "SELECT" class = "roundedtopandbottomyellow" ></form></center></td></td>
      </tr>
    <% end if  %>
    </table>
<br />
