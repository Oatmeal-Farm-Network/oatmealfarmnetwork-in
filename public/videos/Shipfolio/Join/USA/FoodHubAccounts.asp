    ...
    <div class ="col" >
      Membership Categories<br />
         <a class="roundedtopandbottom body" href="/Join/USA/FarmAccounts.asp">&nbsp;Farm / Ranch&nbsp;</a>&nbsp;
            <a class="regsubmit2 body" href="/Join/USA/FoodHubAccounts.asp">&nbsp;Food Hub&nbsp;</a> &nbsp;
...
<% end if %>
     ...
     <tr><td height = 1 colspan = <%=colspan%> bgcolor = "#abacab"></td></tr>
      ...
      <tr >
         ...
         <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Intro&Subscription=FoodHub' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form></center>
         
         </td>
         <td align = "center">
           <%=CurrencyCode %><strike><%= BasicMonthlyRate%></strike> <b>$9.99</b> &nbsp;<%=LocalCurrency%>  / Month
             <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Basic&Subscription=FoodHub' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form>
         ...
         <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Business&Subscription=FoodHub' method = "post"><input type=submit value = "SELECT" class = "regsubmit2" ></form>
