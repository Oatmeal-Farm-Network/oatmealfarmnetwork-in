...
<% Title= "Join The Oatmeal Farm Network"
...
<meta property="og:title" content="Join The Oatmeal Farm Network." />
...
if showcategories = True then %>
<div class ="row">
    <div class ="col" >
      Membership Categories<br />
         <a class="regsubmit2 body" href="/Join/USA/FarmAccounts.asp">&nbsp;Farm / Ranch&nbsp;</a>&nbsp;
...
<br />
     <table cellpadding = 0 cellspacing = 0 border = 0 width = "100%">
       <tr >
         ...
         <td class = "body" style="min-width:50px" ><b><center>Seedling</center></b></td>
          <td class = "body" style="min-width:50px" ><b><center>Spout</center></b></td>
         
         
         <% if showpremium = true then %>
           <td class = "body" style="min-width:50px" ><b><center>Harvest</center></b></td>
           <% end if %>
   ...
   <tr><td height = 1 colspan = <%=colspan%>  bgcolor = "#abacab"></td></tr>
       <tr >
         <td width = "220"><font size = 4><img src="images/px.gif" width = 10 height = 4 />AI AG Advisor</font></td>
...
<% end if %>
   ...
   <tr><td height = 1 colspan = "<%=colspan%>" bgcolor = "#abacab"></td></tr>
      <tr  >
         <td ><img src="images/px.gif" width = 10 height = 4 /><font size = 4>Basic Livestock Listings</font><br />
