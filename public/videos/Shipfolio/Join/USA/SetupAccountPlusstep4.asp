...
'response.redirect("SetupAccountPlusStep2.asp" & variables & "&Stepback=True&StateIndexFound=" & StateIndexFound & "&StateIndex=" & StateIndex & "&EmailsMatch=" & EmailsMatch  & "&passwordmismatch=" & passwordmismatch & "&SpecialChecterFound=" & SpecialChecterFound & "&MissingPassword=" & MissingPassword)
end if
...
<input type="submit" class ="rregsubmit2" value ="Pay Now" height = 130px border="0" name="Pay Now" >
</form>
</center>
<br /><br /><br /><br />
