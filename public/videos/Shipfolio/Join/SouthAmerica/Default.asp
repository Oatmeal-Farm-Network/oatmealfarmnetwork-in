...
<div class="container d-flex align-items-center justify-content-center">
  <div class = "row">
    <div class = "col body">
        ...
        <H1><center>Livestock Of South America is Coming Soon!<center></h1>
        Livestock Of South America is not available yet. Please fill out the form below and we will let you know as soon as the site is available.
         <br><br>
    </div>
  </div>
</div>
