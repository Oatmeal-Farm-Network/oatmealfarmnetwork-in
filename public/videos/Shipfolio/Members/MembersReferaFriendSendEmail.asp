...
strSubject = ReferringPeopleFirstName & " " & ReferringPeopleLastName & " Recommends That You Join Livestock Of America."
...
strBody = strBody & " Livestock of America is an online marketplace that offers opportunities for ranchers to sell animals (Alpacas, Llamas, Cattle, Working Dogs, Donkeys, Goats, Horses, Pigs, and Sheep), properties, businesses, and products. Livestock of America is the fastest growing livestock marketplace on the web and <b>prices start as low as FREE!</b><br><br>" & vbCrLf

strBody = strBody & "If you accept this referral and subscribe to a paid membership on Livestock of America please select " & ReferringRanchname & " as the ranch that referred you and you will receive 2 extra months membership for free and " & ReferringRanchname & " will receive a commission and 2 extra month’s membership for free. To learn more please go to <a href = 'http://www.livestockofamerica.com/referralprogram.asp?RPI=" & ReferringPeopleID & "'>http://www.livestockofamerica.com/referralprogram.asp</a> .<br><br>" & vbCrLf
