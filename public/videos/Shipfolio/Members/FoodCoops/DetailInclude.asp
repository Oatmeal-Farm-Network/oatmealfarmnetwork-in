...
<h3>&nbsp;<%=Trim(rs("FullName"))%></h3></a></td></tr>
<tr><td colspan = 2 height = 1 bgcolor = "#abacab"></td></tr>

<tr><td valign = "top"  class = "body" rowspan = "2" align = "center" width = "180" >
      <table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 align = "center" width= "180"><tr><td><a href = "Details.asp?ID=<%=AnimalID%>&DetailType=<%=DetailType%>&CurrentPeopleID=<%=CurrentpeopleID %>&screenwidth=<%=screenwidth %>" ><img src = "<%= PhotoID %>" width="150"  border = "1" bordercolor="black" class = "Image" style="border:1px solid black;" ></a><br><br></td></tr></table>
	</td>
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "<%=screenwidth -180 %>" align = "center">

 
<% If rs("Sold") = true Then %>
<tr>
	<td  class = "Body" colspan = "2" height = "25"><b><font color ="#155289" size = "3">Sold!</font></b></td>
</tr>
<%End If %>
<% If rs("SalePending")  = true Then %>
<tr>
	<td  class = "Body" colspan = "2" height = "25"><b><font color ="#155289" size = "3">Sale Pending</font></b></td>
</tr>
<%End If %>
...
%>			
<tr>
    <td  class = "Body" colspan = "2"><b><%=PriceComments%></b></td>
</tr>
<%End if%>	
...
<tr><td  class = "body2" align = "right" >
		Price:<img src = "images/px.gif" width = "3" alt = "<%=BusinessName %>" /></td><td class = "body">Free</td></tr>
<% end if
 If Len(rs("price")) > 2 Then %>
	<tr><td  class = "body2" align = "right" >
		Price:<img src = "images/px.gif" width = "3" alt = "<%=BusinessName %>" /></td>
<% else 
if not Free = "True" then %>
<tr><td  class = "body2" align = "right" >
		Price:<img src = "images/px.gif" width = "3" alt = "<%=BusinessName %>" /></td><td class = "body">Call for Price</td></tr>
<% End if
End If %>
<% If Len(rs("price")) > 2 Then %>
...
<tr><td  class = "Body2" align = "right" >Discount:<img src = "images/px.gif" width = "3" alt = "<%=Trim(rs("FullName"))%>" /></td>
		<td class = "body"><b><font color ="#990000"><%=Discount%>%</font></b></td>
</tr>
<tr>
		<td  class = "Body2" align = "right" >Discount Price:</td>
		<td class = "body" valign = "top"><b><font color ="#990000">
        <% Price = cLng(rs("Price")) %>
        <%=formatcurrency(Price * ((100-Discount)/100), 0)%></font></b></td>
</tr>
<%End If %>	

<td  class = "body2"  align = "right" width = "100">
<%
Color1 =rs("Color1")
Color2 = rs("Color2")
Color3 = rs("Color3")
...
<% If len(Color1) > 1 or len(Color2) > 1 or len(Color3) > 1 or len(Color4) > 1 or len(Color5) > 1 Then %>
	Color:<img src = "images/px.gif" width = "3" alt = "<%=Trim(rs("FullName"))%>" /><br>
<% end if %>
...
<% if DOBDay> 0 or DOBMonth> 0 or DOBYear> 0 then %>
		DOB:<img src = "images/px.gif" width = "3" alt = "<%=Trim(rs("FullName"))%>" /><br>
<% end if %>	
...
<%
		...
		%>
<% if len(sire) > 1 then %>
<td class = "body2" align = "right" >Sire:<img src = "images/px.gif" width = "3" alt = "<%=Trim(rs("FullName"))%>" /></td>
<% if SireChoice = 1 then  %>
...
<% if len(dam) > 1 then %>
<tr>
<td  class = "body2" align = "right">Dam:<img src = "images/px.gif" width = "3" alt = "<%=Trim(rs("FullName"))%>" /></td>
<%if DamChoice = 1 then %>
...
%>
  	...
  	<!--#Include file="ListServiceSireInclude.asp"--> 
...
<% end if %>
		...
		<tr><td>
			...
			<td class = "body"  >
				&nbsp;&nbsp;&nbsp;<a href = "Details.asp?ID=<%=AnimalID%>&DetailType=<%=DetailType%>&CurrentPeopleID=<%=CurrentpeopleID %>" class = "regsubmit2">LEARN MORE!</a><br><br><br>
				</td>
			</tr>
		</table>
		</td>
