...
strBody = strBody & "<tr><td colspan='2'><img src='https://www.globallivestocksolutions.com/logos/220pxwide/LivestockofAmerica.png' alt='Header Image' id='header-img' width = 340 style='max-width:340'></td></tr>"
strBody = strBody & "<tr><td colspan='2'><br>This email is from your contact us form on <a href='https://www.LivestockOfAmerica.com' class='body'>www.LivestockOfAmerica.com</a>. Please use the email address below to respond - <b>do not reply directly to this email- the sending email address is not monitored.<br><br></td></tr>"
...
strBody = strBody & "<tr><td colspan='2'><br><a href='https://www.LivestockOfAmerica.com' class='body'>www.LivestockOfAmerica.com</a> is part of the <a href='https://www.GlobalGrange.world' class='body'>Global Grange</a> Family of websites.<br><br></td></tr>"
...
strFrom = Email
strSubject = "Contact From Your Livestock of America Contact Page"
...
oMail.From = sitename & "<livestockemails@globalgrangestatusemails.info>"
