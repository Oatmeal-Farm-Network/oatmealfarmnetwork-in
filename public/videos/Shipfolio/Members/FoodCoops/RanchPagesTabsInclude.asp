...
sql = "SELECT count(*) as count from animals where PublishForSale = 1 and peopleID = " & CurrentPeopleID  
...
<div class="navbar navbar-expand-lg navbar-light justify-content-center"  >
    <div class="container "  style="background-color: #eeeeee; min-height:30px">
      ...
      <div class="collapse navbar-collapse" >
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            <a class="menu2 " href="RanchAnimallist.asp?CurrentPeopleID=<%=CurrentPeopleID %>"   aria-expanded="false">Animals For Sale&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;
          </li>
             <li class="nav-item dropdown">
            <a class="menu2 " href="RanchStudlist.asp?CurrentPeopleID=<%=CurrentPeopleID %>"   aria-expanded="false">Stud Services&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;
          </li>
           ...
           <li class="nav-item dropdown">
            <a class="menu2 dropdown-toggle " href="#" id="dropdown07" data-bs-toggle="dropdown" aria-expanded="false">Products</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <ul class="dropdown-menu" aria-labelledby="dropdown07" style="background-color: <%=menu2Color%>">
            <% sql2 = "SELECT distinct CatID, catname FROM SFCategories, productCategoriesList, sfProducts where catID = productCategoriesList.prodCategoryId and sfproducts.prodID = productcategoriesList.ProductID and prodForSale = 1 and sfproducts.peopleID = " & CurrentpeopleID & " order by catname"
			    ...
			    While Not rs2.eof %>    
                    <li><a class="menu2" href = "RanchStore.asp?catID=<%=rs2("CatID")%>&CurrentPeopleID=<%=CurrentpeopleID %>"><%=rs2("CatName")%></a> </li>
	                <% rs2.movenext
			    Wend %>
              </ul>
            </li>
          ...
          <li class="nav-item dropdown">
               <a class="menu2" href="Properties.asp?CurrentPeopleID=<%=CurrentPeopleID %>"  id="dropdown07"  aria-expanded="false">Properties</a>&nbsp;&nbsp;&nbsp;&nbsp;
          </li>
        <% end if %>
         <li class="nav-item dropdown">
              <a class="menu2" href="FarmListing.asp?CurrentPeopleID=<%=CurrentPeopleID %>"  id="dropdown07"  aria-expanded="false">About / Contact Us</a>&nbsp;&nbsp;&nbsp;&nbsp;
        </li>
        </ul>
      </div>
    </div>
