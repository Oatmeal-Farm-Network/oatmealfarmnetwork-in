...
<table cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center" width = "720" border = "0"><tr><td   valign="top" width = "420"  align = "left" class = "body">
	<%HideOBO = True %>	<!--#Include file="GeneralStatsInclude.asp"-->
</td>
...
<br>
<form  name=form method="post" action="OBOOfferSendEmail.asp?ID=<%=ID %>&CurrentPeopleID=<%=CurrentPeopleID %>">
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "600">
<tr><td colspan="4" align="center" width="536" class = "body"> 
...
<tr><td width="150" height="20" class = "body" align = "right" valign = "top">Offer:</td>
...
<tr><td width="150" height="20" class = "body" align = "right">First Name:*</td>
<td width="450" height="20" class = "body" align = "left"> 
<input name="FirstName" size = "40">
 </td></tr>
<tr><td width="150" height="20" class = "body" align = "right">Last Name:*</td>
			<td width="450" height="20" class = "body" align = "left"> 
...
<tr>
	<td  align = "center" colspan = "2"><input NAME="EMail" size="1" type ="text" class="emailbox">
