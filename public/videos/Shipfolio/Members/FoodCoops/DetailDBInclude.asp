...
str3 = "http://"
If Not(InStr(str1,str2) > 0) and Not(InStr(str1,str3) > 0) Then
image = "http://www.livestockofamerica.com/Uploads/" & image
End If 
...
str3 = "http://"
If  InStr(str1,str2) > 0 and Not(InStr(str1,str3) > 0) Then
image = "http://www.livestockofamerica.com/" & image
End If 

if trim(image) = "http://www.livestockofamerica.com/uploads/" then
image= "http://www.LivestockOfAmerica.com/Uploads/ImageNotAvailable.jpg"
end if
