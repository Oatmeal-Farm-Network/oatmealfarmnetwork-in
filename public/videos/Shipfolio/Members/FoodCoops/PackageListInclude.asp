...
Logo= "http://www.livestockofamerica.com/Uploads/" & Logo
End If 
str1 = lcase(Logo)
str2 = "uploads"
str3 = "http://"
If  InStr(str1,str2) > 0 and Not(InStr(str1,str3) > 0) Then
Logo = "http://www.livestockofamerica.com/" & Logo
End If 
end if
...
<a href ="/AlpacaRanchQuest/RanchPackageDetails.asp?packageid=<%=packageid %>&CurrentPeopleid=<%=CurrentPeopleid %>&TotalPrice=<%=TotalPrice %>" class = "PageText">
...
<br>
<div align = "right"><a href ="/alpacaranchquest/RanchPackageDetails.asp?packageid=<%=packageid %>&CurrentPeopleid=<%=Peopleid %>&TotalPrice=<%=TotalPrice %>" class = "PageText">
<FONT size = "2" COLOR="<%=LinkColor %>"
		...
		<br>
<% if Len(Logo) > 10 Then %>
<center><a href = "/alpacaranchquest/RanchHome.asp?CurrentPeopleid=<%=Peopleid%>" class = "PageText"><img src = "<%=Logo %>" border = "0" height = "50" align = "center"></a></center><br>
<% End If %>
<center><a href = "/alpacaranchquest/RanchHome.asp?CurrentPeopleid=<%=Peopleid%>" class = "PageText"><FONT size = "2" COLOR="<%=LinkColor %>"
			onMouseOver="this.style.color = '<%=LinkMouseoverColor %>'"
