    ...
    <div class="knowledgebase-grid">
        <div class="knowledgebase-card">
            <div class="card-image-container body">
                <img src="/members/images/KnowldegebasehomeLivestock.png" alt="Cows and sheep in a barn">
            </div>
        ...
        <div class="knowledgebase-card">
            <div class="card-image-container">
                <img src="/members/images/KnowledgebasehomePlant.png" alt="Healthy plant growing in a greenhouse">
            </div>
        ...
        <div class="knowledgebase-card">
            <div class="card-image-container">
                <img src="/members/images/KnowledgebasehomeIngredients.png" alt="Ingredients and spices on a table">
            </div>
            <h2>Ingredient Knowledgebase</h2>
            <p>A deep dive into the properties, sources, nutritional facts, and regulatory status of various raw materials and food components.</p>
