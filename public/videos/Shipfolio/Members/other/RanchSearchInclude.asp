...
<div class ="row">
    <div class = "col body roundedtopandbottom" valign = "top" width = 200>
     ...
     <select size="1" name="country_id" style="width: 190px" class = "formbox">
       ...
       sql = "select distinct people.country_id, name from people, business, country where people.businessid = business.businessid  and people.country_id = Country.country_id and (businesstypeid=2 or businesstypeid=3 ) order by name"
