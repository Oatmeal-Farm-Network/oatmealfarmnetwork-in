...
IngredientType = "Flours" 
DirectoryName = "Flours"
IngredientCategoryID = 5 ' Use the specific ID for Algae as defined in your IngredientType table
...
<div class="row">
    <div class="col body text-left">
        <img src="FloursIngredientHeader.webp" width="100%" alt="Delicious <%=IngredientType%>" />
        <br /> <br />
