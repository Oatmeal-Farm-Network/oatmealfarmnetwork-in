...
DirectoryName = "Spices"
IngredientCategoryID = 2 ' Use the specific ID for Algae as defined in your IngredientType table
...
<div class="row">
    <div class="col body text-left">
        <img src="SpicesIngredientHeader.webp" width="100%" alt="Delicious <%=IngredientType%>" />
        <br /> <br />
