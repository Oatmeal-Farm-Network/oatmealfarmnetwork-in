...
DirectoryName = "Peppers"
IngredientCategoryID = 24 ' Use the specific ID for Algae as defined in your IngredientType table
...
<div class="row">
    <div class="col body text-left">
        <img src="peppersIngredientHeader.webp" width="100%" alt="Delicious <%=IngredientType%>" />
        <br /> <br />
