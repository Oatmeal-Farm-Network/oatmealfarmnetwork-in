...
IngredientType = "Juices" 
DirectoryName = "Juices"
IngredientCategoryID = 31 ' Use the specific ID for Algae as defined in your IngredientType table
...
<div class="row">
    <div class="col body text-left">
        <img src="JuicesIngredientHeader.webp" width="100%" alt="Delicious <%=IngredientType%>" />
        <br /> <br />
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 body text-left">
                <div class="flex items-center">
                    <% if Len(IngredientImage) > 0 then %>
                        ...
                        <a href="/IngredientsDB/<%=DirectoryName%>/Varieties.asp?IngredientID=<%=IngredientID %>" class="body image-container">
                        <% end if %>
                    ...
                    <div style="margin-left: 1rem;">
                        <% if ingredientcount > 0 then %>
                        <a href="/IngredientsDB/<%=DirectoryName%>/Varieties.asp?IngredientID=<%=IngredientID %>" class="body"><b><%=IngredientName %></b> </a><br />
                        <% else %>
