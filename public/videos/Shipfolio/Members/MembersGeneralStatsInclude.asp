...
Set rs3 = Server.CreateObject("ADODB.Recordset")%>
 <a name="BasicFacts"></a><br /><table border = "0" cellspacing="0" cellpadding = "0" align = "center" width = "100%"><tr><td class = "roundedtop" align = "left">
...
<select size="1" name="PercentPeruvian">
	<option name = "PercentPeruvian" value= "<%=rs("PercentPeruvian")%>" selected><%=rs("PercentPeruvian")%></option>
...
<select size="1" name="PercentChilean">
	<option name = "PercentChilean1" value= "<%=rs("PercentChilean")%>" selected><%=rs("PercentChilean")%></option>
...
<td align = "left">
	...
	<option name = "PercentBolivian1" value= "<%=rs("PercentBolivian")%>" selected><%=rs("PercentBolivian")%></option>
	...
	<option name = "PercentUnknownOther1" value= "<%=rs("PercentUnknownOther")%>" selected><%=rs("PercentUnknownOther")%></option>
...
<td align = "left">
	...
	<option name = "PercentAccoyo1" value= "<%=rs("PercentAccoyo")%>" selected><%=rs("PercentAccoyo")%></option>
