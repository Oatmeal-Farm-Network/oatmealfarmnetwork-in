...
<!--#Include virtual="/Membersistration/Packagesheader.asp"--> 
		...
		rs2.close
			...
			rs2.Open sql2, conn, 3, 3   
				...
				count = 1
					...
					%>
					<a href ="http://www.alpacainfinity.com/Membersistration/Packagessample/Package.asp?PackageID=	<%=PackageID(count)%>" class = "body"><big><%=PackageName(count)%></big></a></h2><br>
