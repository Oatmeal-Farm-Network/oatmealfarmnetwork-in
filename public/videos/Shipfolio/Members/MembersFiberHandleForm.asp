...
animalIDArraycount = "animalIDArray(" & rowcount & ")"	
	...
	animalIDArray(rowcount)=Request.Form(animalIDArraycount)
	FiberIDArray(rowcount)=Request.Form(FiberIDcount) 
...
while (rowcount < TotalCount)
    ...
    Query =  Query & "  animalID = " & animalIDArray(rowcount) & " " 
	Query =  Query & " where FiberID = " & FiberIDArray(rowcount) & ";" 
...
Conn.Close
Set Conn = Nothing 
response.redirect("MembersEditAnimalFiber.asp?animalID=" & animalID & "&changesmade=True")
%>
 </Body>
</HTML>
