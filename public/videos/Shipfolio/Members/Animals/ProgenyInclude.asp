...
<td  class = 'body' align = "center" width = "140">
	...
	<% Else %>
	<a href = "Details.asp?ID=<%=CriaID%>&DetailType=<%=DetailType%>" class = "body"><img src= "https://www.livestockoftheworld.com/Uploads/ImageNotAvailable.jpg" width = "130" class = "pictures"></a>
...
<% Else %>
	...
	<tr>
		<td>
<a href = "Details.asp?ID=<%=CriaID%>&DetailType=<%=DetailType%>" class = "body"><img src= "https://www.livestockoftheworld.com/Uploads/ImageNotAvailable.jpg" width = "130" border = "0"></a>
		</td>
</tr>
</table>
<% End If %>
