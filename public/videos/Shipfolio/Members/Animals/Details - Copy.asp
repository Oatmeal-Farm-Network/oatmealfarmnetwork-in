...
If Not IsNumeric(ID) Or Len(ID) < 1 Then
...
cmd.Parameters.Append cmd.CreateParameter("@AnimalIDParam", 3, 1, , ID) ' adInteger, adParamInput
    ...
    <div class="progeny-grid">
        <% For i = 0 To UBound(progeny, 2) %>
            <div class="progeny-card">
                <a href="Details.asp?ID=<%=progeny(0, i)%>">
