    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <% Else %>
                <% While Not rs.EOF %>
                <div class="card mb-3">
                    <div class="card-header" style="background:#507033"><a href="/members/Animals/Details.asp?AnimalID=<%=rs("AnimalID")%>" class="text-white text-decoration-none h5"><%=rs("FullName")%></a></div>
                    <div class="row g-0">
                        ...
                        <div class="col-md-8"><div class="card-body">
                            ...
                            </p><a href="/members/Animals/Details.asp?AnimalID=<%=rs("AnimalID")%>" class="btn btn-secondary btn-sm">View Details</a>
                        </div></div>
                    </div>
                </div>
                <% rs.MoveNext : Wend %>
