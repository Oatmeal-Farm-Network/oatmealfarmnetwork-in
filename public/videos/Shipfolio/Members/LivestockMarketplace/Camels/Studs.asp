...
<div class="container-fluid d-none d-lg-block" id="grad1" align = "center" style=" min-height: 90px" >
    <div class = "row" align = "center" >
        <div class = "col body" >
            <h1><%=CurrentSpecies %> Stud Services</h1>
            <a href="Default.asp" class = "whitebody"><div align = Right><b><%=CurrentSpecies %> For Sale</b><img src = "https://www.Globallivestocksolutions.asp/images/px.gif" width = 8 height = 6 /></div></a>
        </div>
</div>
</div>
<div class="container-fluid d-none d-lg-block" align = "center" style ="min-height: 500px ">
<div class="row" align = "center">
...
<div class="container-fluid d-lg-none" id="grad1" style=" min-height: 90px" >
   <div class = "row" align = "center" >
        <div class = "col body">
            <h1><%=CurrentSpecies %> Stud Services</h1>
            <a href="default.asp" class = "body"><div align = right><b><%=CurrentSpecies %> For Sale</b></div></a>
        </div>
</div>
    </div>
