...
<div class="container-fluid d-none d-lg-block" align = "center" style="max-width: 1400px; min-height: 67px" >
    <div class = "row" align = "center" style="background-color: #638562" >
        <div class = "col body">
            <h1><%=CurrentSpecies %> Stud Services</h1>
            <a href="Default.asp" class = "body"><div align = Right><b><%=CurrentSpecies %> For Sale</b><img src = "https://www.Globallivestocksolutions.asp/images/px.gif" width = 8 height = 6 /></div></a>
        </div>
</div>
