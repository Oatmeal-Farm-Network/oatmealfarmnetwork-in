...
<% Photo1 = "https://www.LivestockOfAmerica.com/Chickens/Chickens.png"
Title = "Premium Chickens for Sale - Livestock of America" 
Description = "Explore a diverse selection of healthy and high-quality chickens for sale at Livestock of America. Our range includes various breeds, each raised with care and expertise. Find the perfect addition to your flock today!"%>
<title><%=Title %></title>
...
<meta name="subject" content="<%=CurrentSpecies2 %> For Sale" />

<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="<%=CurrentSpecies2 %> For Sale" />
...
<link rel="canonical" href="https://www.LivestockOfAmerica.com/cattle/Default.asp" />
...
currentminprice= trim(request.form("currentminprice"))
if len(currentminprice) > 0 then
else
currentminprice= trim(request.querystring("currentminprice"))
end if


if len(currentminprice) > 0 then

if clng(currentminprice) > 0 then
datafound = True
...
currentmaxprice= trim(request.form("currentmaxprice"))
if len(currentmaxprice) > 0 then
else
currentmaxprice= trim(request.querystring("currentmaxprice"))
end if


if len(currentmaxprice) > 0 then

if clng(currentmaxprice) > 0 then
datafound = True
...
if len(ColorSort) > 1 then
 ...
 searchvariables = searchvariables + "&currentminprice=" & currentminprice
 end if

  if len(currentmaxprice) > 1 then
 searchvariables = searchvariables + "&currentmaxprice=" & currentmaxprice
 end if
...
<div class="container-fluid d-none d-lg-block" id="grad1" align = "center" style=" min-height: 80px" >
    <div class = "row" align = "center" >
        <div class = "col" >
            <h1><%=CurrentSpecies2 %> For Sale</h1>
        </div>
</div>
</div>
    ...
    <div class = "row" align = "center" >
        <div class = "col" >
            ...
            <a href="Studs.asp" class = "body">
                <div align = right><b><%=CurrentSpecies %> Stud Services</b>&nbsp;&nbsp;&nbsp;</div></a>
            <% end if %>
            <br />
        </div>
</div>
...
<div class="row" align = "center">
  <div class="col-3" align = "left" style="min-width: 200px">
   ...
   <!--#Include virtual="/includefiles/SearchStandardInclude.asp"-->
  </div>
  <div class="col-9" align = "center" style="max-width: 1000px; min-height: 67px">
  <!--#Include virtual="/includefiles/DetailInclude2.asp"--> 
...
<div class="container-fluid d-lg-none dropshadow" id="grad1" >
   <div class = "row" align = "center">
        <div class = "col body">
            <h1><%=CurrentSpecies %> For Sale</h1>
            <% if ShowStuds = True then %>
            <a href="Studs.asp" class = "whitebody"><div align = right><b><%=CurrentSpecies %> Stud Services</b>
                <img src = "https://www.Globallivestocksolutions.com/images/px.gif" width = 8 height = 6 /></div></a>
  <% end if %>
        </div>
</div>
</div>
...
<div class="row" align = "left">
 ...
 <!--#Include virtual="/includefiles/SearchMobileInclude.asp"-->
...
<div>
 ...
 <!--#Include virtual="/includefiles/MobileDetailInclude.asp"--> 
