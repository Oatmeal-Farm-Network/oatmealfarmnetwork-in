...
<div class="container-fluid d-none d-lg-block" align = "center" style="max-width: 1400px; min-height: 67px" >
    <div class = "row" align = "center">
        <div class = "col body">
            ...
            <a href="Studs.asp" class = "body"><div align = right><b><%=CurrentSpecies %> Stud Services</b><img src = "https://www.Globallivestocksolutions.asp/images/px.gif" width = 8 height = 6 /></div></a>
            <% end if %>
        </div>
</div>
<div class="row" align = "center">
  ...
  <!--#Include virtual="/includefiles/DetailInclude.asp"--> 
