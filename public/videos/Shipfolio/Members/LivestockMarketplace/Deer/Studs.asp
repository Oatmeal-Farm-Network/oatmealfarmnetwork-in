...
<div class="container-fluid d-none d-lg-block" align = "center" style="max-width: 1400px; min-height: 67px" >
    <div class = "row" align = "center">
        <div class = "col body">
            <h1><%=CurrentBreed %> Stud Services</h1>
            <a href="Default.asp" class = "body"><div align = Right><b><%=CurrentBreed %> For Sale</b><img src = "https://www.Globallivestocksolutions.asp/images/px.gif" width = 8 height = 6 /></div></a>
        </div>
</div>
<div class="row" align = "center">
...
<div class="container-fluid d-lg-none dropshadow" >
   <div class = "row" align = "center">
        <div class = "col body">
            <h1><%=CurrentBreed %> Stud Services</h1>
            <a href="default.asp" class = "body"><div align = right><b><%=CurrentBreed %> For Sale</b></div></a>
        </div>
</div>
