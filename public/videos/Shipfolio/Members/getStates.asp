...
' Do NOT close 'conn' here if it's managed by globalvariables.asp and meant to persist for the entire request
' (e.g., if globalvariables.asp opens it once and you reuse it).
' If each ASP file needs to explicitly close its connections:
