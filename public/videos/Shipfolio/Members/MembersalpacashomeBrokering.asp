...
<table border = "0" cellspacing="0" cellpadding = "0" align = "center" ><tr><td class = "roundedtop" align = "left">
		<H1><div align = "left">Your Alpacas</div></H1>
        </td></tr>
...
<br />
<form action= 'MembersBrokeringHandleForm.asp' method = "post"  name = "Brokeringform">
<table border = "0" width = "800"  bgcolor = "white" cellpadding=0 cellspacing=0  align = "center" >
<tr><td width = "475" valign = "top" class = "body">

<%  sql = "select distinct Pricing.*, animals.ID, AGBrokered, FullName, PublishForSale, PublishStud from Animals, Pricing where Animals.ID =Pricing.ID  order by FullName"
...
<table width = "900"   border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0>
	...
	<td class = "body" align = "center" ><b>AG Brokered</b></td>
...
row = "odd"
 While  Not rs.eof  
	...
	AGBrokered(rowcount) =   rs("AGBrokered")
showstats = True
 If row = "even" Then %>
<tr>
<% Else %>
...
<% 		
		if AGBrokered(rowcount)  = "True" Or AGBrokered(rowcount)  = True  Or AGBrokered(rowcount) = 1 Then %>
			Yes<input type="radio" name="AGBrokered(<%= rowcount%>)" Value = "True" checked>
			No<input type="radio" name="AGBrokered(<%= rowcount%>)" Value = "False" >
		<% Else %>
			Yes<input type="radio" name="AGBrokered(<%= rowcount%>)" Value = "True" >
			No<input type="radio" name="AGBrokered(<%= rowcount%>)" Value = "False" checked>
		<% End If %>
	</td>
	<td class = "body" width = "250" align = "left">
