...
<table border = "0"  bordercolor = "#abacab" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 align = "center" width = "700"   valign = "top">

<tr>
<td class = "body" align = "center" width = "250"><b>Name</b></td>
<td class = "body" align = "center" width = "150"><b>Color</b></td>
<td class = "body" align = "center" width = "150"><b>DOB</b></td>
<td class = "body" align = "center" width = "150"><b>Price</b></td>
</tr>
...
%>
<tr ><td   class = "body">
  <a href = "Details.asp?ID=<%=alpacaID%>&DetailType=<%=DetailType%>&CurrentPeopleID=<%=CurrentpeopleID %>" class = "body"><%=Trim(rs("FullName"))%></a>
...
<b><%=formatcurrency(rs("Price") * ((100-Discount)/100), 0)%></b>
<% else %>
