...
<table border = "0" cellspacing="0" cellpadding = "0" align = "center" width = "<%=screenwidth - 22 %>">
<tr><td class = "roundedtop" align = "left"><h2>Welcome to <%=Sitenamelong %>!</h2></td></tr>
 </td></tr>
<tr><td class = "roundedBottom body" >
 To get start we recommend that you visit some of the following pages in the Membersistration Dashboard:
<ul>
<li><a href = "membersAccountContactsEdit.asp" class = "body">Your Account</a> - take a moment and make sure that your information is complete.</li>
<li><a href = "MemberssiteDesign.asp" class = "body">Farm Pages</a> - customize your farm pages (define colors & fonts, upload graphics, enter text about your business.)</li>
<li><a href = "MembersAnimalAdd1.asp" class = "body">Add <%=AnimalsSold %></a> - use our easy Add a New Animal Wizard to start entering your <%=AnimalsSold %>.</li>
<%if not Subscriptionlevel=18 then %>
<li><a href = "membersPlaceClassifiedAd0.asp" class = "body">Add Products</a> - enter your products for sale.</li>
<% end if %>
</ul>
</td></tr>
</table>
...
<font color = "darkgreen"><b><center>Required Fields are Indicated in Green.</center></b></font>

</td>
<tr><td class = "body">
<b><font color = "darkgreen"><b>Number of Animals in Listing</b></font></b>
</td>
<td class = "body">
...
<tr>
<td class = "body">
<b><font color = "darkgreen"><b>Category</b></font></b>
</td>
<td>
...
<tr><td class = "body"><font color = "darkgreen"><b>Species</b></font></td>
<td class = "body">
...
<% sql = "select distinct animals.ID, animals.speciesID, FullName, PublishForSale, PublishStud, ShowOnOurHerdPage, Lastupdated from Animals  where PeopleID = " & Session("PeopleID") & "  order by SpeciesID, trim(FullName) "
...
<h2>Logo Ad</h2>
<b>200 pixels x 200 pixels</b><br />
<% 
...
Logo ads randomly appear on list pages throughout the Livestock site(s) that you are a member of, until the end of August 2017.<br /><br />
...
<% end if %>
  <table border = "0" cellspacing="0" cellpadding = "0" align = "center" width = "100%"><tr><td class = "roundedtopandbottom" align = "left">
<H2><div align = "left">My Ranch Site</div></H2>
...
<% if subscriptionlevel < 4 then %>
<table border = '0' leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=2 cellspacing=0 align = 'left' width = '100%' bgcolor = "#F9E4C5"><tr><td class= "body" ></br>
<font color = maroon size = 4>Online Holiday Bazaar</font></br>
Your products will NOT appear on the online Holiday Bazaar because it's exclusive to Premium Members. But here's the good news: <a href="MembersRenewSubscription.asp?PeopleID=<%=peopleid %>" class =body>click here to upgrade to a Premium Membership!</a></br>
</td></tr></table>
<% end if %>
...
Not Set
<% end if %></small>
<a href = "MembersAdEdit2.asp?prodID=<%= prodID( rowcount)%>#BasicFacts" class = "body">&nbsp;&nbsp;<img src= "images/edit.gif" alt = "edit" height ="12" border = "0"></a>|&nbsp;<a href = "membersProductPhotos.asp?prodID=<%=prodid( rowcount)%>" class = "body"><img src= "images/Photo.gif" alt = "edit" height ="14" border = "0"></a><br>
</td></tr>
<% 
rowcount = rowcount + 1
	   rs.movenext
...
<a href = "MembersRenewSubscription.asp?PeopleID=<%=peopleID %>" class = "regsubmit2"><font face="verdana" size = '2' color = black>Renew or Upgrade Your Membership</font></a><br /><br />
</td>
</tr></table>
...
<table align= 'center' class='formbox' width = 100% border = 0 class = "formbox">
<tr><td class = "body" colspan = 2><h2>Add an Animal Listing</h2></td>

<tr><td class = "body"><b>Species</b><br />
...
<tr><td class = "body">
<br />
<b>Number of Animals in Listing </b><br />
