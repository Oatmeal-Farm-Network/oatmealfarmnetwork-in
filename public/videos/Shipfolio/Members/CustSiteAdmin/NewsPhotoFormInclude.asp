...
%>
    <table  border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "800">
		<tr>
			<td class = "body">
				<H1>Upload Photo for <%=rs("NewsHeadline") %></H1>			
			</td>
		</tr>
	</table>
   ...
   <table Border = "1" Bgcolor = "#dddddd" width = "750" align = "center">
		...
		<tr>
			...
			<td class = "body">
					<form name="frmSend" method="POST" enctype="multipart/form-data" action="NewsuploadImage.asp" >
...
<table  border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 >
					...
					<form action= 'NewsRemoveImage.asp' method = "post">
							Would you like to remove this image? 
							<input type = "hidden" name="ImageNewsID" value= "1" >
