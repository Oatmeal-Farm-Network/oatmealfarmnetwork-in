...
<HTML>
<HEAD>
 <title>Products Photo Order Results Page</title>
...
while (rowcount < TotalCount)
	...
	Query =  " UPDATE ProductsAdditionalPhotos Set PhotoOrder = '" +  Order(rowcount) + "' " 
...
%>
	...
	<tr >
		<td align = "right">
			<br><a  class = "body" href="ProductPhotos.asp"> Return to the Product Images Page</a>
			<br>
		</td>
	</tr>
</table>
