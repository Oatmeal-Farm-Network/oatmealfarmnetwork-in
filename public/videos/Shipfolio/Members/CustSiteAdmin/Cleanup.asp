...
<title><%= WebSiteName %> Alpaca Cleanup</title>
...
<% PageTitle = "Easy and Simple Cleanup" %>
...
<table width = "<%=bodywidth%>" border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" align = "Left" >
       <tr> 
		<td class = "body" valign = "top" >
			...
			<img border="0" src="images/Cleanup.jpg" align= "right" >
			Alpacas roam together in small herds. Clean-up is greatly facilitated because the herd naturally concentrate their urine and feces into only a few consolidated areas. These areas approximately 6ft in diameter are scattered throughout the pasture. The feces can be used as plant, tree or garden fertilizer, with or without composting. Additionally, alpacas naturally aid in their own parasite control by not grazing around these areas.<br>
			<br>
 

Alpacas make clean-up with simple tools easy.
