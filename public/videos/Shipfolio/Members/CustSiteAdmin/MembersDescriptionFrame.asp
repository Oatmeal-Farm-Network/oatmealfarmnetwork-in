...
sql = "select Description, StudDescription from Animals where ID=" & ID
...
<form action= 'MembersDescriptionHandleForm.asp' method = "post">
 ...
 <table border = "0" cellspacing="0" cellpadding = "0" align = "left" width = "<%=screenwidth -12%>">
<tr>
    <td class = "body" >
<a name="Description"></a>
<table border = "0" cellspacing="0" cellpadding = "0" align = "left" width = "<%=screenwidth -12%>" class = "formbox">
<tr>
    <td  align = "left"><H2>Description</H2>
...
If StudServicesPage = True And category = "Experienced Male" Or category = "Inexperienced Male" then%>
 ...
 <table border = "0" cellspacing="0" cellpadding = "0" align = "left" width = "<%=screenwidth-22 %>">
<tr>
    <td class = "body" >
    <br /><br />
<a name="studdescription"></a>
<table border = "0" cellspacing="0" cellpadding = "0" align = "left" width = "<%=screenwidth -22%>" class="formbox">
<tr>
    <td align = "left"><h2>Stud Breeding Description (Appears only on Your Stud Services Page) </h2>
...
<% end if %>
 ...
 <table border = "0"  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 align = "left" width = "<%=screenwidth - 42 %>">
    <tr> 
       <td class = "body" valign = "top">
	<form action= 'MembersStudDescriptionHandleForm.asp' method = "post">
	
	<input type = "hidden" name="ID" Value = "<%=  ID%>">
	<table width = "<%=screenwidth - 42 %>" cellpadding = 0 cellspacing = 0 border = 0>
    <tr >
		<td class = "body" valign = "top">
<% if mobiledevice = True or screenwidth < 600 then %>
