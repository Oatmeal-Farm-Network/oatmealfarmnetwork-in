...
Query =  "INSERT INTO Pricing (ID, StudFee, Price, Forsale, Discount, PriceComments  )" 
...
<table  border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0>
	<tr>
		<td class = "body"><img src = "images/WizardHeader.jpg">
			<a name="Add"></a>
			<H1>Step 7: Review</H1>
		Now that your animal has been added, please take a minute to review the information below:
		</td>
	</tr>
