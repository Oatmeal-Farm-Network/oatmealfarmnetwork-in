...
Dim TempCategoryType
	...
	TempCalendarPageID=Request.Form("CalendarPageID" ) 
...
sql = "select * from CalendarCategories where CategoryName = '" & TempNewCategory & "'" 
			'response.write(sql)
...
End If
		...
		Query =  "INSERT INTO CalendarCategories (CategoryName)" 
