...
<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  valign ="top" class = "roundedtopandbottom"  width = "980">
<tr><td>
...
While CatCounter < FinalCatCounter
	CatCounter= CatCounter +1 %>
			...
			<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  ><tr><td> <form action= 'SiteAdminEditCategory.asp' method = "post" style="margin-bottom:0;" >
...
'response.write(CategoryName(CatCounter,SubCatCounter) )
		...
		<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  ><tr><td><form action= 'SiteAdminEditCategory.asp' method = "post" style="margin-bottom:0;" ><div style="display: inline;"><img src = "images/SubLine.jpg" height = "16">
		<input name="TempCategoryType" value ="<%=TempCategoryType%>"  type="hidden">
...
%>
		...
		<td width = "300"   class = "body" valign = "top">
			...
			<form action= 'SiteAdminAddCategoryhandleform.asp' method = "post">
				<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  valign ="top" >
				<tr>
...
<form action= 'SiteAdminAddSubCategoryHandleform.asp' method = "post">
	<input name="CategoryType" type = "hidden" Value = "<%=TempCategoryType%>">
				<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  valign ="top" >
...
<form action= 'SiteAdimDeleteCategoryhandleform.asp' method = "post">
	<input name="CategoryType" type = "hidden" Value = "<%=TempCategoryType%>">
