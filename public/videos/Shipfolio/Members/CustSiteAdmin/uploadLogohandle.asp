...
' of a directory with write permissions, for example "C:\Inetpub\wwwroot"
  Dim uploadsDirVar
  uploadsDirVar = "E:\\Inetpub\\wwwroot\\virtual\\milkyway\\alpacainfinity.com\\www\\Uploads\\Logos\\" 
' ****************************************************
...
if Request.ServerVariables("REQUEST_METHOD") <> "POST" then
	...
	Query =  " UPDATE sfCustomers Set Logo = '" &  Filename & "' ,"
	Query =  Query & " LogoFileSize = '" &  filelength & "' " 
...
Logo =  Filename
%>
 <!-- #include file="LogoFormInclude.asp" -->
