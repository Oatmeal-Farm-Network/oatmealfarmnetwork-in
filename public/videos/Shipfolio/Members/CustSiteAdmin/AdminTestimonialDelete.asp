...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width="300" align = "center">
	...
	<form  name=form method="post" action="AdminTestimonialsadmin.asp">
...
<form  name=form method="post" action="AdminTestimonialDelete2.asp?TestimonialsID=<%=TestimonialsID%>">
