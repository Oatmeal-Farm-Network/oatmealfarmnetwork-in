...
<HTML>
<HEAD>
 <title>Edit a New Article</title>
...
<table>
	<tr>
		<td valign = "top">
			 <form action= 'EditNewsHandleForm.asp' method = "post">
...
<table border = "1" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 >
  	<tr>
		...
		<tr>
				<td  colspan = "3" valign = "top">
					Associate Image:<select size="1" name="ArticleImage1" >
					<option name = "ArticleImage" value= "<%=rs("Image1")%>" selected><%=rs("Image1")%></option>
					<option name = "ArticleImage" value= "" >No Image</option>
					<% count = 1
						while count < pcount
					%>
					...
					wend %>
						...
						Associate Image:<select size="1" name="ArticleImage2" >
					<option name = "ArticleImage" value= "<%=rs("Image2")%>" selected><%=rs("Image2")%></option>
					<option name = "ArticleImage" value= "" >No Image</option>
					<% count = 1
						while count < pcount
					%>
					...
					wend %>
						...
						Associate Image:<select size="1" name="ArticleImage3" >
					<option name = "ArticleImage" value= "<%=rs("Image3")%>" selected><%=rs("Image3")%></option>
									<option name = "ArticleImage" value= "" >No Image</option>
					<% count = 1
						while count < pcount
					%>
					...
					wend %>
						...
						Associate Image:<select size="1" name="ArticleImage4" >
					<option name = "ArticleImage" value= "<%=rs("Image4")%>" selected><%=rs("Image4")%></option>
									<option name = "ArticleImage" value= "">No Image</option>
					<% count = 1
						while count < pcount
					%>
					...
					wend %>
						...
						Associate Image:<select size="1" name="ArticleImage5" >
					<option name = "ArticleImage" value= "<%=rs("Image5")%>" selected><%=rs("Image5")%></option>
									<option name = "ArticleImage" value= "" >No Image</option>
					<% count = 1
						while count < pcount
					%>
