...
<% if Current = "Transfer Data" then %>
 ...
 <% if Current = "PNAA" then %>
   <td class = "body2" width = "90" height = "30" align = "center" background = "images/TabOn.jpg"><b><a href = "/administration/PNAA/default.asp" class = "menu2">PNAA</a></b></td>
   <% else %>
   <td class = "body2" width = "90" height = "30" align = "center" background = "images/TabOff.jpg"><b><a href = "/administration/PNAA/default.asp" class = "menu2">PNAA</a></b></td>
   <% end if %>
