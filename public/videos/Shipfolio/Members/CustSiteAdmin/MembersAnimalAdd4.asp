...
<form action= 'MembersAnimalAdd5.asp?wizard=True&PeopleID=<%=PeopleID %>&ID=<%=ID%>' method = "post" name = "myform">
    ...
    <script language="javascript1.2" type="text/javascript">
		...
		<textarea name="Description" ID="Description"  cols="80" rows="30"></textarea>
		</td>
	</tr>
<tr>
