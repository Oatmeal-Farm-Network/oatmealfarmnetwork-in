...
response.write("SessionProdID=" & Session("ProdID"))
...
Query =  " UPDATE sfAttributedetail Set attrDetailImage  = '" &  attrDetailImage & "' " 
...
' response.redirect("AdminProdAttributeFrame.asp?ProdID=" & ProdID & "&category1id=" & category1id  & "&category2id=" & category2id  & "&category3id=" & category3id )
%>
