...
<tr>
			<td  align = "center" class = "body"  colspan= "2" bgcolor = "burlywood" height = "24">
					<big><b>Text Block <%=textblocknum%></b></big> </b>
			</td>
		</tr>
		  <tr>
					...
					<table>
					   <tr>
					     <td class = "body">
							...
							<form action= 'RemovearticleImage.asp' method = "post">
						...
						<td>
							<td class = "body" valign = "top" width = "280">
								<form method="POST" action="ArticleImageOrientation.asp" >
								<b>Orientation: </b>
								   <% If TempImageCaption= "0" Then
									...
									<input type = "hidden" name="PageName" value= "ArticleHandleForm2.asp?ArticleID=<%=ArticleID %>" >
									<input type=submit value = "Submit" style="background-image: url('images/background.jpg'); border-width:1px" size = "110" Class = "body" >
								</form>
				
								<form method="POST" action="articleImageCaption.asp" >
								<b>Caption: </b>
								   <% If TempImageCaption= "0" Then
											TempImageCaption = ""
										End If %>
									<input name="Caption"  size = "12" value = "<%=TempImageCaption%>">
   ...
   <tr>
      <td >
<table border = "0" bordercolor = "antiquewhite" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 >
		...
		<tr>
			<td  align = "left" class = "body" valign = "top" colspan = "2">
					<TEXTAREA NAME="Text" cols="100" rows="20" wrap="file"><%=TempPageText%></textarea>
			</td>
		</tr>
		<tr>
