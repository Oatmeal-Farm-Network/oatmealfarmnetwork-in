...
<title><%= WebSiteName %>Black Alpacas for Sale</title>
...
<% PageTitle = "Black Alpacas for Sale" %>
...
<% 	conn = "Provider=Microsoft.Jet.OLEDB.4.0;" & _
	...
	sql = "SELECT distinct Animals.*, Pricing.*, Photos.Listpageimage, Ancestors.* FROM Animals, Pricing, Photos, Ancestors WHERE Animals.ID=Pricing.ID  And Animals.ID=Photos.ID And Animals.ID=Ancestors.ID and ForSale = Yes and (Colorcategory = 'Black' )  order by Female, Price DESC " 
