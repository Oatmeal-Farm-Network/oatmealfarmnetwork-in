...
' of a directory with write permissions, for example "C:\Inetpub\wwwroot"
  Dim uploadsDirVar
  uploadsDirVar =  "E:\Inetpub\wwwroot\virtual\fairclough\pinewayalpacas.com\www\uploads\listpage"
' ****************************************************
...
if Request.ServerVariables("REQUEST_METHOD") <> "POST" then
	...
	Filename = "http://www.pinewayalpacas.com/uploads/listpage/" & SaveFiles()
	...
	Query =  " UPDATE PageLayout Set Image4 = '" &  Filename & "' " 
