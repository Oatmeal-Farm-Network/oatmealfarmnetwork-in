			...
			<tr>
				...
				<td class = "body">
					<table>
					   <tr>
					     <td class = "body">
							<form name="frmSend" method="POST" enctype="multipart/form-data" action="<%=TempNewsuploadImageFile%>" >
							...
							<td class = "body" valign = "top" width = "280">
								...
								<b>Orientation: </b>
								   <% If TempImageCaption= "0" Then
									...
									<input type = "hidden" name="PageName" value= "NewsHandleForm2.asp?NewsID=<%=NewsID %>" >
