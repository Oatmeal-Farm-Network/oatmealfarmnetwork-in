...
<form action= 'AdminProductsAttributesHandleForm.asp' method = "post">
...
Yes<input TYPE="RADIO" name="ProdForSalex" Value = True checked>
No<input TYPE="RADIO" name="ProdForSalex" Value = False >
<% Else %>
Yes<input TYPE="RADIO" name="ProdForSalex" Value = True >
No<input TYPE="RADIO" name="ProdForSalex" Value = False checked>
<% End if%>
		</td>
	</tr>
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "100%" align = "right">
 <tr bgcolor = "#cccccc">
	<% if PrimaryAttribute = "Color" then %>	
        <td class = "body" bgcolor = #338333><div align = "center" ><b>Color</b>
         <br /><i><b>Primary Attribute</b></i>
 ...
 <% if PrimaryAttribute = "Dimension" then %>
		<td class = "body" bgcolor = #338333><div align = "center">
