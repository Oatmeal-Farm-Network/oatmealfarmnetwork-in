...
End If
 ...
 sql = "select animals.ID, ancestors.* from animals, Ancestors where animals.ID = Ancestors.ID and PeopleID =" & session("PeopleID") &  " and Instr(FullName, '" & Dam2 & "') "
...
%>
<!--#Include File="AdminAncestorCheckDataInclude.asp"-->
<%
Dam   = Ancestor
Dam2   = Ancestor2
...
set rs2=nothing
set conn = nothing
response.redirect("AdminAncestryFrame.asp?id=" & id & "&Speciesid=" & Speciesid & "&changesmade=True")
%>
 </Body>
</HTML>
