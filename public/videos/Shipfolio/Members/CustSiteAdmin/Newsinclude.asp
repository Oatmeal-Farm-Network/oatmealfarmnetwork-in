...
response.write("test=" & ImageCaption1)
...
<table border= "0">
<tr>
			<td  align = "center" class = "body" valign = "top" colspan= "2" bgcolor = "bbbbbb" height = "14" width = "700">
				...
				<td class = "body">
					<table>
					   <tr>
						...
						<tr>
							<td>
								<form method="POST" action="NewsImageCaption.asp" >
								<b>Caption: </b>
								   <% If ImageCaption1= "0" Then
											ImageCaption1 = ""
										End If %>
									<input name="Caption"  size = "12" value = "<%=ImageCaption1%>">
									<input type = "hidden" name="CaptionImageID" value= "1" >
							...
							<td>
								...
								<b>Caption: </b>
								   <% If ImageCaption2= "0" Then
											ImageCaption2 = ""
										End If %>
									<input name="Caption"  size = "12" value = "<%=ImageCaption2%>">
									<input type = "hidden" name="CaptionImageID" value= "2" >
									<input type=submit value = "Submit" style="background-image: url('images/background.jpg'); border-width:1px" size = "110" Class = "body" >
								</form>
							</td>
						</tr>
							...
							<td>
								...
								<b>Caption: </b>
								   <% If ImageCaption3= "0" Then
											ImageCaption3 = ""
										End If %>
									<input name="Caption"  size = "12" value = "<%=ImageCaption3%>">
									<input type = "hidden" name="CaptionImageID" value= "3" >
									<input type=submit value = "Submit" style="background-image: url('images/background.jpg'); border-width:1px" size = "110" Class = "body" >
								</form>
							</td>
						</tr>
							...
							<td>
								...
								<b>Caption: </b>
								   <% If ImageCaption4= "0" Then
											ImageCaption4 = ""
										End If %>
									<input name="Caption"  size = "12" value = "<%=ImageCaption4%>">
									<input type = "hidden" name="CaptionImageID" value= "4" >
									<input type=submit value = "Submit" style="background-image: url('images/background.jpg'); border-width:1px" size = "110" Class = "body" >
								</form>
							</td>
						</tr>
