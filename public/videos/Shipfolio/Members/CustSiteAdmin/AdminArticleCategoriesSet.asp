...
<!--#Include file="AdminArticlesTabsInclude.asp"-->
 	<table border = "0" cellspacing="0" cellpadding = "0" align = "center" width = "<%=screenwidth - 35 %>"><tr><td class = "roundedtop" align = "left">
        ...
        <tr><td class = "roundedBottom body" align = "left"  width = "430" valign = "top">
...
While CatCounter < FinalCatCounter
	CatCounter= CatCounter +1 %>
			...
			<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  ><tr><td> <form action= 'AdminArticleCategoryEdit.asp' method = "post" style="margin-bottom:0;" >
			<div style="display: inline;" align = "left">
			<input name="ArticleCategoryName" value ="<%= ArticleCategoryName(CatCounter,0) %>"  size = "40">
