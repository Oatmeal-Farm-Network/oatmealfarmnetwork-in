...
<td width = "4000" align = "center">
			...
			</center><form ENCTYPE="multipart/form-data" ACTION= "<%=WebSiteAddress%>/cgi-bin/uploadList.cgi" METHOD="POST"><center>
...
"Data Source=" & server.mappath(DatabasePath) & ";" & _
						"User Id=;Password=;" 
	sqld = "select Animals.ID, Animals.FullName, AdditionalPhotos.* from Animals, AdditionalPhotos where Animals.ID = AdditionalPhotos.ID and not (additionalPhotos.ID = 2000) ORDER by Animals.FullName ASC"
