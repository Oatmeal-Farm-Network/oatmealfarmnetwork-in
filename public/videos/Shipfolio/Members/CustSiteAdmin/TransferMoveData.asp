...
'response.write(SourceFullName)
	...
	Databasepath2 = "../../../../milkyway/alpacainfinity.com/DB/Alpaca_Infinity_Animals.mdb"
   Found = False
		conn = "Provider=Microsoft.Jet.OLEDB.4.0;" & _
		"Data Source=" & server.mappath(Databasepath2) & ";" & _
						"User Id=;Password=;" 
			 sql = "select * from Animals where  CustID= " &  session("AIID") & " and (FullName = '" &   SourceFullName  & "' or ARI = '" &   SourceARI  & "') ;" 
			'response.write(sql)
			...
			If Found = True Then %>
				<!--#Include virtual="/Administration/TransferFoundAnimal.asp"--> 

			<% Else %>
			
				<!--#Include virtual="/Administration/TransferNewAnimal.asp"--> 
