...
<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  valign ="top"    width = "800">

	<tr>
			<td  class = "body" align = "right" >
			Category:
		</td>
		<td width = "500" class = "body">
			<div>
...
<select name="box2" onchange="Box2IDpick(this.selectedIndex)"></select> * Required
</div>
