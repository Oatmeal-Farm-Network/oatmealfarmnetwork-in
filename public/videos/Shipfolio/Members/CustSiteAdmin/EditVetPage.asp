...
<HTML>
<HEAD>
 <title>Edit a Vet Article</title>
...
<%
			...
			set fo=fs.GetFolder("E:\\Inetpub\\wwwroot\\virtual\\lasflores1\\altiplano-alpacas.com\\www\\uploads\\Blog")
			pcount = 1
...
<table>
	<tr>
		<td valign = "top">
			 <form action= 'EditVetHandleForm.asp' method = "post">
...
<table border = "0" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "600">
	<tr>
		<td class = "body">
			...
			Select an article below and push the edit button to edit a specific Vet article:<br>
...
<table border = "0" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "600">
	<tr>
		...
		<br>
			...
			Select an article below and push the DELETE button to delete a specific vet article. Remember once it's gone, it's gone!:<br>
