...
<table leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0>
	<tr>
		...
		<H3>Large Images</H3>
			...
			your animal detail pages.
			<p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"></font></p>
			<p><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FF0000">only gif and jpg formats</font><br>
			</p>
			</center>
			
			<form ENCTYPE="multipart/form-data" ACTION="http://www.swallowridgealpacas.com/cgi-bin/uploadDetail.cgi" METHOD="POST"><center>
...
<input TYPE="SUBMIT" VALUE="Upload Now!">
    <p> <font size="1" face="Verdana, Arial, Helvetica, sans-serif">After clicking 
      &quot;Upload Now&quot; it may take a short while to send your image.</font><br>
		...
		<td width = "400" align = "center">
			<H3>Small Images</H3>
			These are the small images that you will want to use on<br> your alpacas for sale page:

			<p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"></font></p>
			
			<p><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FF0000">only gif and jpg formats</font><br>
			</p>
			</center><form ENCTYPE="multipart/form-data" ACTION="http://www.swallowridgealpacas.com/cgi-bin/uploadList.cgi" METHOD="POST"><center>
<input TYPE="FILE" NAME="file-to-upload-01" SIZE="35">
<p>
<input TYPE="SUBMIT" VALUE="Upload Now!">
    <p> <font size="1" face="Verdana, Arial, Helvetica, sans-serif">After clicking 
...
<table leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0>
	<tr>
		<td class = "body">
			 <H2>Associate Images
			<img src = "images/underline.jpg"></H2>
			After your images have been uploaded to your server they need to be associate with your site. Use the tools below to associate images with pages on your site.<br><br>
...
"Data Source=" & server.mappath("/data/alpacaDB.mdb") & ";" & _
						"User Id=;Password=;" 
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0>
	<tr>
		<td>
			...
			set fo=fs.GetFolder("E:\\Inetpub\\wwwroot\\virtual\\ruckliss\\swallowridgealpacas.com\\www\\uploads\\ListPage")
			pcount = 1
	...
	<tr>
		<td>
			...
			dim DFileName(400)
			set fs=Server.CreateObject("Scripting.FileSystemObject")
			set fo=fs.GetFolder("E:\\Inetpub\\wwwroot\\virtual\\ruckliss\\swallowridgealpacas.com\\www\\uploads\\DetailPage"  )
			pcount = 1
			for each x in fo.files
