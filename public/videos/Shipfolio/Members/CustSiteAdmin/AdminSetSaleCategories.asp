...
<% While CatCounter < FinalCatCounter
	CatCounter= CatCounter +1 %>
			...
			<td class = "body"> 
				<% 	
		if CategoryShow(CatCounter,0) = "Yes" Or CategoryShow(CatCounter,0) = True Then %>
			True<input TYPE="RADIO" name="categoryShow" Value = "Yes" checked>
			False<input TYPE="RADIO" name="categoryShow" Value = "No" >
		<% Else %>
			True<input TYPE="RADIO" name="categoryShow" Value = "Yes" >
			False<input TYPE="RADIO" name="categoryShow" Value = "No" checked>
		<% End If %>
			</td>
			<td class = "body"> 			
...
<b>When you delete a category you will loose all products with that category! Even if you create a new category with the same name, the old products will not automatically be reassigned!</b><br><br></td>
        </tr>
			<tr>
