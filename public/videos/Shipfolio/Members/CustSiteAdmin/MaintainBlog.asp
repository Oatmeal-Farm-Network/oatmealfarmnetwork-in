...
<form ENCTYPE="multipart/form-data" ACTION="http://www.altiplano-alpacas.com/cgi-bin/uploadBlog.cgi" METHOD="POST"><center>
...
<table border = "0" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "600">
	<tr>
		<td class = "body">
			...
			Select an article below and push the edit button to edit a specific blog article:<br>
...
<table border = "0" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "600">
	<tr>
		...
		<br>
			...
			<form action= 'DeleteBlog.asp' method = "post">
