...
<table border="0" cellpadding="5" cellspacing="0" width="800"  background = "images/PageBackground.jpg" align = "center">
   <tr>
      <td class = "body" colspan = "3">
	   ...
	   <blockquote>Congratulations on your purchase of a breeding to <b><%=Fullname%></b>.   Please confirm your purchase by supplying your contact information and pressing the "confirm order" button below. We will contact you to finalize the purchase contract, payment, and transportation. </blockquote>
	</td>
</tr> <tr>
		<td width = "10">&nbsp;</td>
...
<FORM NAME="ConfirmBidForm" ACTION="BreedingOrderConfirm.asp" METHOD="POST" onsubmit="javascript:return ValidForm(this)">	
	...
	sql = "SELECT maleWebView.*, BreedingAuction.* FROM MaleWebView, BreedingAuction WHERE animals.id = Breedingauction.animalid and Animals.ID = " & ID 
' response.write (sql)
    Set rs = Server.CreateObject("ADODB.Recordset")
    rs.Open sql, conn, 3, 3  
	
	
	alpacasPrice= rs("studfee")
  ...
  <tr>
		<td align="left" width = "135" valign = "top" class = "body" rowspan = "2">                       
	      ...
	      <td class= "body"  valign = "top" width = "300" >
								...
								<b>Regular Stud Fee:<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=BuyNowPrice%></b> <br>
									<%=rs("Color")%><br>
								DOB: <%=rs("DOB")%><br>
		</td>
	</tr>
