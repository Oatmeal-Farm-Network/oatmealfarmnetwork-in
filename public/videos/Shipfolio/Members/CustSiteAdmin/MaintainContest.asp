...
<form ACTION= "<%=WebSiteAddress%>/cgi-bin/uploadContest.cgi" method="post" enctype="multipart/form-data"> 
...
<%
			...
			set fo=fs.GetFolder(PhysicalPath & "\\uploads\\Contest")
			pcount = 1
  	...
  	<tr>
			<td  align = "center" valign = "top" width = "250">
				...
				<td  colspan = "3" valign = "top">
					<b>Prize Description</b> (Note: it's often best to write your text in a word processor and then copy and paste it here.)
					<textarea name="Text" cols="90" rows="8" wrap="VIRTUAL" ></textarea>
				</td>
		</tr>
		<tr>
				<td  colspan = "3" valign = "top">
					Select Image:<select size="1" name="ArticleImage1">
...
<table border = "0" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "600">
	...
	conn = "Provider=Microsoft.Jet.OLEDB.4.0;" & _
			  ...
			  sql = "select * from Contest where Page = 'News' order by IssueDate Desc" 
...
<table border = "0" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "600">
	<tr>
		...
		<br>
			...
			Select an article below and push the DELETE button to delete a specific Contest article. Remember once it's gone, it's gone!:<br>
	...
	conn = "Provider=Microsoft.Jet.OLEDB.4.0;" & _
			  ...
			  sql = "select * from Contest order by IssueDate Desc" 
	Set rs = Server.CreateObject("ADODB.Recordset")
    rs.Open sql, conn, 3, 3   
