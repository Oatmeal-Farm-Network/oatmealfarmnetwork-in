...
While CatCounter < FinalCatCounter
	CatCounter= CatCounter +1 %>
			...
			<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  ><tr><td> <form action= 'AdminCategoryEdit.asp' method = "post" style="margin-bottom:0;" >
...
'response.write(CategoryName(CatCounter,SubCatCounter) )
		...
		<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  ><tr><td><form action= 'AdminCategoryEdit.asp' method = "post" style="margin-bottom:0;" ><div style="display: inline;"><img src = "images/SubLine.jpg" height = "16">
		<input name="TempCategoryType" value ="<%=TempCategoryType%>"  type="hidden">
...
%>
		...
		<td width = "300"   class = "body" valign = "top">
			...
			<form action= 'AdminCategoryAddHandleForm.asp' method = "post">
				<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  valign ="top" >
				<tr>
			...
			<tr>
					<td  align = "center" valign = "middle" colspan = "2" class = "body">
						<input type=submit value = "Add Category" size = "110" class = "Submit" >
					</td>
			</tr>
			</table>
			</form>
...
<form action= 'AdminCategoryAddSubHandleform.asp' method = "post">
	<input name="CategoryType" type = "hidden" Value = "<%=TempCategoryType%>">
				<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  valign ="top" >
			...
			<tr>
					<td  align = "center" valign = "middle" colspan = "2">
						<input type=submit value = "Add Sub-Category" size = "110" class = "Submit" >
					</td>
			</tr>
			</table>
			</form>
...
<form action= 'AdminCategoryDeleteHandleform.asp' method = "post">
	<input name="CategoryType" type = "hidden" Value = "<%=TempCategoryType%>">
	<input   name="DeleteCategoryType" type = "hidden" value = "Category">	
			...
			<tr>
					<td  align = "center" valign = "middle" colspan = "2">
						<input type=submit value = "Delete a Category" size = "110" class = "Submit" >
					</td>
			</tr>
			</table>
			</form>
...
<form action= 'AdminCategoryDeleteHandleform.asp' method = "post">
	...
	<input name="DeleteCategoryType" type = "hidden"   value = "SubCategory">	
			...
			<tr>
					<td  align = "center" valign = "middle" colspan = "2">
						<input type=submit value = "Delete a Sub-Category" size = "110" class = "Submit" >
					</td>
			</tr>
			</table>
			</form>
