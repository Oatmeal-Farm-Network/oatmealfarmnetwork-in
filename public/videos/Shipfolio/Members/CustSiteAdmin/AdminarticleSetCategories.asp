...
dim ArticleCategoryShow(100,100)
...
<% end if  %>
 ...
 <tr><td colspan = "5"><form action= 'AdminArticleEditCategory.asp' method = "post" style="margin-bottom:0;" >
...
<% 
sql = "select * from ArticleCategories order by ArticleCategoryOrder " 
...
ArticleCategoryShow(CatCounter,0) = rs("ArticleCategoryShow")
rs.movenext
Wend
...
<a href = "AdminArticleMaintenance2.asp?ArticleCatID=<%=ArticleCatID(CatCounter,0)%>#BasicFacts" class = "body">
Edit Article</a></td>
<td><input name="ArticleCategoryName(<%=CatCounter%>)" value ="<%= ArticleCategoryName(CatCounter,0) %>"  size = "40"></td>
<td class="body2" align = "center">
<% if  ArticleCategoryShow(CatCounter,0)= "Yes" Or  ArticleCategoryShow(CatCounter,0) = True Then %>
Yes<input TYPE="RADIO" name="ArticleCategoryShow(<%=CatCounter%>)" Value = "Yes" checked>
No<input TYPE="RADIO" name="ArticleCategoryShow(<%=CatCounter%>)" Value = "No" >
<% Else %>
Yes<input TYPE="RADIO" name="ArticleCategoryShow(<%=CatCounter%>)" Value = "Yes" >
No<input TYPE="RADIO" name="ArticleCategoryShow(<%=CatCounter%>)" Value = "No" checked>
<% End If %>
</td>
<td width = "100">
<select size="1" name="ArticleCategoryOrder(<%=CatCounter%>)">	
<option  value= "<%= ArticleCategoryOrder(CatCounter,0) %>" selected><%= ArticleCategoryOrder(CatCounter,0) %></option>
<%	PGCounter = 0 
...
<a href = "AdminArticleEditImages.asp?ArticleCatID=<%=ArticleCatID(CatCounter,0)%>#BasicFacts" class = "body">
&nbsp;&nbsp;<img src= "images/edit.gif" alt = "edit" height ="12" border = "0"></a>
<% if not (ArticleCategoryName(CatCounter,0)  = "Home Page Slideshow" ) then %>|&nbsp;<a href = "#Delete" class = "body"><img src= "images/Delete.gif" alt = "edit" height ="14" border = "0"></a>
<% end if %>
</td>
</tr>
<% 
...
<tr><td class = " body" align = "center" height = "110" width = "100%"valign = "top">
 		<br>
			<form action= 'AdminArticleAddCatHandleForm.asp' method = "post">
...
<form action= 'AdminArticleDeleteCatHandleForm.asp' method = "post">
