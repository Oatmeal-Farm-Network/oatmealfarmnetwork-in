...
<HTML>
<HEAD>
 <title>Page Meta Tag Maintanance</title>
...
<table width = "700" align = "center" border="0" cellspacing="0" cellpadding="0" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">	
		
<tr>
		<td class = "body">
				<h1><div align = "center">Searche Engine Optimization 101</div></h1>
 <div align = "center"> by John Andresen </div><br>
...
If some or all of these criteria sound confusing to you, don’t feel bad, you aren’t alone. Below are some definitions and explanations of how they are implemented on most search engines:<br>
 <br>
<b>Site Address. </b>The address that people type in to find your site (i.e. www.mysite.com). This used to be of high importance to search engines, but with the whole world is trying to grab the best address, search engines have lowered the importance of the perfect address.  <br>
 <br>
...
I hope this article has helped you learn more about how search engines work.
