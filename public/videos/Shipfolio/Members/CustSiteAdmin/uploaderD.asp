...
function OutputForm()
%>
    <form name="frmSend" method="POST" enctype="multipart/form-data" action="uploaderD.asp" onSubmit="return onSubmitForm();">
	<B>File names:</B><br>
...
function SaveFiles
    ...
    if (UBound(ks) <> -1) then
        ...
        for each fileKey in Upload.UploadedFiles.keys
            SaveFiles = SaveFiles & Upload.UploadedFiles(fileKey).Fileaname & " (" & Upload.UploadedFiles(fileKey).Length & "B)<br> "
        next
...
<HTML>
<HEAD>
<TITLE>Upload Large Images</TITLE>
...
<table leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0>
	<tr>
		<td align = "center">
			<H3>Upload Large Images</H3>
			These are the images that you will want to use on detail page photos or additional photos.
<%
Dim diagnostics
