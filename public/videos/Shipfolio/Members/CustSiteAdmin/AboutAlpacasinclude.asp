...
conn = "Provider=Microsoft.Jet.OLEDB.4.0;" & _
  ...
  sql = "select * from Pagelayout where PageName = 'About Alpacas'"
'response.write(sql)
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "680">
	<tr>
		<td Class = "body">
			<H2>About Alpacas Page Content<br>
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "680">
	<tr>
		<td valign = "top">
			 <form action= 'AboutAlpacasPageHandleForm.asp' method = "post">
			...
			<tr>
				<td class = "body">
					<table>
					   <tr>
					     <td class = "body">
							<form name="frmSend" method="POST" enctype="multipart/form-data" action="AboutAlpacasuploadPageImage.asp" >
						...
						<tr>
							<td>
								<form method="POST" action="AboutAlpacasImageOrientation.asp" >
								<b>Orientation: </b>
						...
						<tr>
					    <td class = "body">
							<form action= 'RemoveAboutAlpacasImage.asp' method = "post">
			...
			<tr>
				<td class = "body">
					<table>
					   <tr>
					     <td class = "body">
							<form name="frmSend" method="POST" enctype="multipart/form-data" action="AboutAlpacasuploadPageImage2.asp" >
			...
			<tr>
				<td class = "body">
					<table>
					   <tr>
					     <td class = "body">
							<form name="frmSend" method="POST" enctype="multipart/form-data" action="AboutAlpacasuploadPageImage3.asp" >
			...
			<tr>
				<td class = "body">
					<table>
					   <tr>
					     <td class = "body">
							<form name="frmSend" method="POST" enctype="multipart/form-data" action="AboutAlpacasuploadPageImage4.asp" >
