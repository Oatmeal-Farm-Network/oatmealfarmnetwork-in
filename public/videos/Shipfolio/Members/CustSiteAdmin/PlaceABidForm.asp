...
If  NewBid = " " Then %>
   <table border="0" height = "400" cellpadding="5" cellspacing="0" width="800"  background = "images/PageBackground.jpg" align = "center">
   <table border="0" cellpadding="5" cellspacing="0" width="800"  background = "images/PageBackground.jpg">
    <tr>
      <td class = "body" colspan = "2">
       <br><h1 ><i>&nbsp;Please Enter  Bid</i><img src = "images/Line.jpg" width = "530" height = "2"></h1>
	</td>
</tr>
   <tr>
      <td class = "body" colspan = "3" valign = "top">
			<blockquote>Please enter a bid of <% = MinBid %> or more.</blockquote>
		</td>
	</tr>
	<tr>
		<td align = "center">
...
<%else
If Clng(Newbid) < Clng(minbid) then
%>
   <table border="0" height = "400" cellpadding="5" cellspacing="0" width="800"  background = "images/PageBackground.jpg" align = "center">
   <table border="0" cellpadding="5" cellspacing="0" width="800"  background = "images/PageBackground.jpg">
    <tr>
      <td class = "body" colspan = "2">
       <br><h1 ><i>&nbsp;Please Enter a Higher Bid</i><img src = "images/Line.jpg" width = "530" height = "2"></h1>
	</td>
</tr>
   <tr>
      <td class = "body" colspan = "3" valign = "top">
			<blockquote>Your bid of <% = FormatCurrency(NewBid,0) %> is less then the current minimum bid of <% = FormatCurrency(MinBid,0) %>. Please enter a bid of <% = MinBid %> or more.</blockquote>
		</td>
	</tr>
	<tr>
		<td align = "center">
...
<table border="0" cellpadding="5" cellspacing="0" width="800"  background = "images/PageBackground.jpg" align = "center">
   <tr>
      <td class = "body" colspan = "3">
       <br><h1 ><i>&nbsp;Confirming Your Bid</i><img src = "images/Line.jpg" width = "500" height = "2"></h1>
	   <blockquote>Thank you for your bid of <b><%=FormatCurrency(Newbid,0)%></b> on <b><%=Fullname%></b>. Please confirm your bid by supplying your contact information below:</blockquote>
	</td>
</tr> <tr>
		<td width = "10">&nbsp;</td>
...
<FORM NAME="ConfirmBidForm" ACTION="Confirm.asp" METHOD="POST" onsubmit="javascript:return ValidForm(this)">	
      	...
      	<tr> 
            <td height="30"  class = "body" valign = "top"> Questions or Comments: </td>
            	...
            	<tr> 
					...
					<input type = "hidden" name="Newbid" value= "<%=newbid%>" SIZE = "8">
					<input type = "hidden" name="ID" value= "<%=ID%>">
					<input type = "hidden" name="Owner" value= "<%=Owner%>">
					<input type = "hidden" name="Fullname" value= "<%=FullName%>">
                    		I  confirm my bid of <%=FormatCurrency(Newbid,0)%> on <%=Fullname%><br><input type="submit" value="Submit">
