...
<title><%= WebSiteName %> Order Confirm </title>
...
<table border="0" cellpadding="5" cellspacing="0" width="800"   height = "350" background = "images/PageBackground.jpg" align = "center" valign = "top">
   <tr>
      <td class = "body" colspan = "3" valign = "top" >
       <br><h1 ><i>&nbsp;Your Order is Confirmed</i><img src = "images/Line.jpg" width = "500" height = "2"></h1>
...
strSubject = "You Sold an Alpaca!"

strBody = "Below is the Purchase Information"

' Body Data
strBody = strBody & "<br>Alpaca's Name: "
strBody = strBody & Fullname
strBody = strBody & "<br>Alpaca's Owner: "
strBody = strBody & Owner
strBody = strBody & "<br>Buy Now Price: "
strBody = strBody & FormatCurrency(BuyNowPrice,0)
...
If InStr(str1,str2) > 0 Then
	strCommentText = Replace(str1, "'", "")
End If


Query =  "INSERT INTO AuctionSales ( custID,  animalID,  SoldPrice, OrderDateTime, Comments )" 
	...
	Query =  " UPDATE Auction Set SalePending = true"  
	Query =  Query + " where AnimalID = " & ID & ";" 
...
%>
	...
	<blockquote>	
		Thank you for your purchase of <%=Fullname%> for <%=FormatCurrency(BuyNowPrice,0)%>. Your order has been confirmed. We will contact you soon to finalize your order.<br><br>
