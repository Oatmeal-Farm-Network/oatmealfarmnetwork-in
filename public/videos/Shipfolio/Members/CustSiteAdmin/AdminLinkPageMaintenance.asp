...
<% TempCatID=request.querystring("CatID")
if len(TempCatID) > 0 then 
sql = "select * from LinkCategories where CatID =  " & TempCatID
rs.Open sql, conn, 3, 3 
if Not rs.eof then
CategoryNamex = rs("CategoryName")
pagename = CategoryNamex
end if
rs.close
end if
%>
...
<body >
<% else %>
<body onresize="window.location.replace(window.location.href.split('?')[0]  + '?ScreenWidth=' + self.innerWidth + '&CatID=' + CatID);">
<% end if
temppagename = PageName %>
<!--#Include file="AdminHeader.asp"-->
<% PageName = temppagename
Current3="LinksHome" 
dim LinkDescription(100,100)
Dim CatID(100,100)
...
sql = "select * from Links where CatID=" & TempCatID
rs.Open sql, conn, 3, 3   
rowcount = 1
...
<H1><div align = "left"><%=CategoryNamex %> Page Maintenance</div></H1>
</td></tr>
...
<input name="Returnpage" type= "hidden" value = "AdminLinkPageMaintenance.asp?CatID=<%=TempCatID %>">
...
<textarea name="PageText"  ID="PageText" cols="60" rows="20"   class = "body"  ><%= PageText %></textarea>
</td></tr>
<tr>
...
<tr><td class = "roundedBottom body" width = "100%">
...
str2 = "li2"
If InStr(str1,str2) > 0 Then
Missing= Replace(str1, "li2", "</li>")
End If
str1 = Missing
str2 = "LI"
If InStr(str1,str2) > 0 Then
Missing= Replace(str1, "LI", "<li>")
End If
...
%>
<tr><td width = "170" class = "body2" align = "right" height = "30">
Title*:
</td>
<td class = "body">
...
<% rs.close  
sql = "select * from Links, Linkcategories where Links.CatID = LinkCategories.CatID and LinkCategories.CatID=" & TempCatId & " order by CategoryName,  LinkText"
rs.Open sql, conn, 3, 3   
rowcount = 1
Recordcount = rs.RecordCount +1
%>
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "100%" align = "center">
<tr><th class = "body2" width = "80" align = "center"><b>Image</b></th>
...
<%	End If %>
	...
	<a href = "AdminPageLinkEdit.asp?LinkID=<%= LinkIDArray(rowcount) %>" ><img src = "<%=LinkImage2(rowcount)%>" width = "50" border = "0">  </a>
...
<td>
<a href = "AdminPageLinkEdit.asp?LinkID=<%= LinkIDArray(rowcount) %>" class = "body">&nbsp;&nbsp;<img src= "images/edit.gif" alt = "edit" height ="12" border = "0"></a>|&nbsp;<a href = "AdminLinkDelete.asp?LinkID=<%= LinkIDArray(rowcount) %>&returnpage=adminlinkpagemaintenance.asp&CatID=<%=tempcatId %>" class = "body"><img src= "images/Delete.gif" alt = "edit" height ="14" border = "0"></a>


</td>
</tr>
<tr><td class = "body" colspan = "5">
<%=LinkdescriptionArray(rowcount)%>
...
Http://<input name="Link" size = "40"><br />
	   <b>Category:</b><br />
<% 
sql = "select * from LinkCategories where CatID= " & TempcatID & " order by CategoryName " 
rs.Open sql, conn, 3, 3 
CatCounter= 0
While Not rs.eof 
...
LinkDescription(CatCounter, 0) = rs("LinkDescription")
