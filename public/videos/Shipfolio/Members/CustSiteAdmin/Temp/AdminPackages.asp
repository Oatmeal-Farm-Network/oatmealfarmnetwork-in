...
<BODY  border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0  bgcolor = "white">
   ...
   <% '<!--#Include file="AdminPackageHeader.asp"--> %>
...
%>
	...
	<td width = "150" align = "center">
		<% if len(PackagePhoto(rowcount))> 4 then %>
			...
			<a href = "AdminPackagePhoto.asp?PackageID=<%=PackageID(rowcount)%>" class = "body">Change Image</a>
		<% else %>
...
%>
	...
	<form action= 'AdminAnimalHandleForm.asp' method = "post">
	<tr  >
