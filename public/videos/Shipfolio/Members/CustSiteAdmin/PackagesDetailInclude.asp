...
<%While Not rs2.eof 
		...
		<td align="left" width = "135" valign = "top" class = "body" rowspan = "2">                          
	      ...
	      <td class= "body"  valign = "top" >
								<a href = "Details.asp?ID=<%=alpacaID%>&DetailType=<%=DetailType%>&Detail.x=53&Detail.y=21" class = "body"><big><%=Trim(rs2("FullName"))%></big></a>
			...
			<tr>
				<td class= "body"  valign = "top" >
								<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 >
									<tr>
										<% If Len(rs2("Avalue")) > 2 Then %>
												<td valign = "top" class = "body" width = "95">
												Regular Price:
											<br>
										</td>
										<% End If %>
