...
<table leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0>
	...
	<td width = "10">&nbsp;</td>
		<td class = "body">
			...
			To delete an Listing simply select the listing below and push the button.<br> <b>But careful. Once a listing is deleted from your database, it's gone!</b><br><br>
		</td>
	</tr>
</table>
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 valign = "top" >
	...
	<td width = "10">&nbsp;</td>
		<td class = "body" valign = "top">
			...
			<% Else %>
			<form action= 'DeleteListinghandleform2.asp' method = "post">
				 ...
				 <td>
					...
					%>
						<option name = "AID1" value="<%=aID(count)%>">
							<%=aName(count)%> <font class = "small"> (<%=aAdType(count) %>) </font>
						</option>
					<% 	count = count + 1
					wend %>
					</select>
