...
<table border = "0"  bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "400" align = "left">
    <tr>
	...
	<tr>
		...
		<td>
			<input name="ServiceSireLink" size = "40">
		</td>
	</tr>
	<tr>
		<td class = "body" align = "right">
		...
		<td class = "body">
			Huacaya<input TYPE="RADIO" name="Breed" Value = "Huacaya" >
			Suri<input TYPE="RADIO" name="Breed" Value = "Suri" checked><br>
		</td>
	</tr>
	<tr>
		<td class = "body" align = "right">
...
%>
	...
	<% 	if trim(TBreed(rowcount)) = "Huacaya" then %>
