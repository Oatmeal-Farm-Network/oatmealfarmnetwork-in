...
sqlA = "select * from Ancestrypercents where ID=" & ID & " order by PercentPeruvian Desc, PercentID Desc"
...
PercentCanadian = rsA("PercentCanadian")
...
StudDescription= rs("StudDescription1") & rs("StudDescription2") 
...
ShowWithDam= rs("ShowWithDam")
ShowWithSire= rs("ShowWithSire")
...
BreedlookupID2 = BreedID2
BreedlookupID3 = BreedID3
BreedlookupID4 = BreedID4
