...
%>
<% If Len(ProductID) > 0 and ShowLOA = True and AutoTransfer = True then %>
 <!--#Include virtual="/administration/transfers/TransferMoveProductData.asp"-->
<% end if %>



 <form action= "AdminProductsGeneralStatsHandleForm.asp" method = "post" name="myform"> 

<table border = "0" cellspacing="0" cellpadding = "0" align = "center" width = "100%" >
<tr><td class = "roundedtop" align = "left">
		<H1>Basic Facts <font class="body" color = "maroon">* = Required Field</font></H1>
        </td></tr>
...
<table border = 0 cellspacing = 5 cellpadding = 5 width = 100%>
  <tr>
		<td class = "body2" align=right width = 140>
			<b><font color = "maroon">Name*</font></b>
		</td>
		<td class ="body" align = "left">
			<input name="ProdName" value="<%=ProdName %>" size = "50" class = "formbox">
		</td>
	</tr>
	<tr>
	<td class = "body2" align=right >
		...
		<td class ="body" align = "left">
			<input name="SKU" value="<%=SKU %>" size = "50" class = "formbox">
		</td>
	</tr>
	
	<tr>
  	<td class = "body2" align=right valign = "top">
			<br><b><font color = "maroon">Categories*</font></b>
		</td>
    <td valign = "top" >
<iframe src="AdminAddProductCategoriesInclude.asp?Category1ID=<%=Category1ID %>&Category2ID=<%=Category2ID %>&Category3ID=<%=Category3ID %>&SubCategory1ID=<%=SubCategory1ID %>&SubCategory2ID=<%=SubCategory2ID %>&SubCategory3ID=<%=SubCategory3ID %>" height = '240' width = '600'  frameborder= '0' seamless = Yes scrolling = no></iframe>
</td></tr>
...
<font color=#777777>If this product was made from one of your animals (usually their fiber/wool) then select the animal and a link will connect the product and animal on your website.</font>
...
<b>Price</b></td>
<td>
<input type = text value = "<%=formatcurrency(ProdPrice, 2) %>" name = "ProdPrice" class = formbox size = 3 />
</td>
</tr>
<tr>
<td class = "body2" align=right valign = top>
...
SalePrice=formatcurrency(SalePrice, 2)
end if %>
<input type = text value = "<%=SalePrice %>" name = SalePrice class = formbox size = 3 />
</td>
</tr>
<tr>
<td class = "body2" align=right valign = top>
<b>Qunatity Available</b></td>
<td>
<input type = text value ="<%=ProdQuantityAvailable %>" name = ProdQuantityAvailable class = formbox size = 3 />
</td>
</tr>
<tr>
<td class = "body2" align=right valign ="top" >
...
<b>Colors</b>
 ...
 <table border = "0" width = "440" border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 >
<tr>
	<td class = "body2" align = "center" width = "100"></td>
	<td class = "body2" align = "center" ><b>Color</b></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 1&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color1' size=30 maxlength=60 value="<%=Color1 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 2&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color2' size=30 maxlength=60 value="<%=Color2 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 3&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color3' size=30 maxlength=60 value="<%=Color3 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 4&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color4' size=30 maxlength=60 value="<%=Color4 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 5&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color5' size=30 maxlength=60 value="<%=Color5 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 6&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color6' size=30 maxlength=60 value="<%=Color6 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 7&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color7' size=30 maxlength=60 value="<%=Color7 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 8&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color8' size=30 maxlength=60 value="<%=Color8 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 9&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color9' size=30 maxlength=60 value="<%=Color9 %>"></td>
</tr>

<tr>
	<td class = "body2"  align = "right" width = "90">
	Color 10&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='Color10' size=30 maxlength=60 value="<%=Color10 %>"></td>
</tr>
</table>
</td>
</tr>
...
<tr>
	<td class = "body2" align = "center" width = "100"></td>
	<td class = "body2" align = "center" ><b>Size</b></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 1&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodsize1' size=30 maxlength=60 value="<%=prodsize1 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 2&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodSize2' size=30 maxlength=60 value="<%=prodSize2 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 3&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodSize3' size=30 maxlength=60 value="<%=prodSize3 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 4&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodSize4' size=30 maxlength=60 value="<%=prodSize4 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 5&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodSize5' size=30 maxlength=60 value="<%=prodSize5 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 6&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodSize6' size=30 maxlength=60 value="<%=prodSize6 %>"></td>
</tr>
<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 7&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodSize7' size=30 maxlength=60 value="<%=prodSize7 %>"></td>
</tr>

<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 8&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodSize8' size=30 maxlength=60 value="<%=prodSize8 %>"></td>
</tr>

<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 9&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodSize9' size=30 maxlength=60 value="<%=prodSize9 %>"></td>
</tr>

<tr>
	<td class = "body2"  align = "right" width = "90">
	Size 10&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='prodSize10' size=30 maxlength=60 value="<%=prodSize10 %>"></td>
</tr>
</table>
</td>
</tr>
...
<tr>
	<td class = "body2" align = "center" width = "100"></td>
	<td class = "body2" align = "center" ><b>Type</b></td>
	<td class = "body" align = "left" width = "130"><b>Percent</b></td>
</tr>

<tr>
	<td class = "body2"  align = "right" width = "90">
	Material 1&nbsp;</td>
	<td class = "body" ><input type=text class = "formbox" name='ProdFiberType1' size=30 maxlength=60 value="<%=ProdFiberType1 %>"></td>
	<td>
	<input type=text name='prodFiberPercent1' class = "formbox" size=2 maxlength=4 value="<%=prodFiberPercent1 %>" onBlur="checkNumeric(this,-5,5000,',','.','-');">%
				</td>
			</tr>
		<tr>
				<td class = "body2"  align = "right" width = "90">
					Material 2&nbsp;</td>
				<td class = "body"><input type=text class = "formbox" name='ProdFiberType2' size=30 maxlength=60 value="<%=ProdFiberType2 %>"></td>
				<td>
					<input type=text name='prodFiberPercent2' class = "formbox" size=2 maxlength=4 value="<%=prodFiberPercent2 %>" onBlur="checkNumeric(this,-5,5000,',','.','-');">%
				</td>
			</tr>
			<tr>
				<td class = "body2"  align = "right" width = "90">
					Material 3&nbsp;</td>
				<td class = "body"><input type=text class = "formbox" name='ProdFiberType3' size=30 maxlength=60 value="<%=ProdFiberType3 %>"></td>
				<td>
					<input type=text name='prodFiberPercent3' class = "formbox" size=2 maxlength=4 value="<%=prodFiberPercent3 %>" onBlur="checkNumeric(this,-5,5000,',','.','-');">%
				</td>
			</tr>
			<tr>
				<td class = "body2"  align = "right" width = "90">
					Material 4&nbsp;</td>
				<td class = "body"><input type=text name='ProdFiberType4' class = "formbox" size=30 maxlength=60 value="<%=ProdFiberType4 %>"></td>
				<td>
					<input type=text name='prodFiberPercent4' size=2 class = "formbox" maxlength=4 value="<%=prodFiberPercent4 %>" onBlur="checkNumeric(this,-5,5000,',','.','-');">%
				</td>
			</tr>
			<tr>
				<td class = "body2"  align = "right" width = "90">
					Material 5&nbsp;</td>
				<td class = "body"><input type=text name='ProdFiberType5' class = "formbox" size=30 maxlength=60 value="<%=ProdFiberType5 %>"></td>
				<td>
					<input type=text name='prodFiberPercent5' size=2 class = "formbox" maxlength=4 value="<%=prodFiberPercent5 %>" onBlur="checkNumeric(this,-5,5000,',','.','-');">%
				</td>
			</tr>
			</table>
<br>
<font color = "#777777">List the different materials used in the creation of your product and the percent composition if appropriate (i.e. a silk and alpaca sweater may be 80% alpaca and 20% silk.)</font>
