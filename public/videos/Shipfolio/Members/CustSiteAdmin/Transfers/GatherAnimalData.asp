...
SourceLOAID = rs("LOAID")
SourceWeight = rs("Weight")
SourceHeight = rs("Height")
SourceGaited = rs("Gaited")
SourceWarmblooded= rs("Warmblooded")
SourceTemperment= rs("Temperment")
SourceStudDescription= rs("StudDescription1") & rs("StudDescription2")
SourceBreedLookupID= rs("BreedID")
SourceBreedID2= rs("BreedID2")
SourceBreedID3= rs("BreedID3")
SourceBreedID4= rs("BreedID4")
SourceExternalLink= rs("ExternalLink")
SourceDescription= rs("Description1") & rs("Description2")
...
rs.close 
sql = "select * from SpeciesBreedlookupTable where SpeciesID = "  & SourceSpeciesID  & ";" 
rs.Open sql, conn, 3, 3   
If Not rs.eof Then
