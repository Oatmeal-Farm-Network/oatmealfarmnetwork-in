...
"Data Source=" & server.mappath(DatabasePath) & ";" & _
 ...
 sql2 = "select * from SiteDesign where Peopleid = 66;" 
			'response.write(sql2)
...
<td width= "214" align = "right">
							...
							<a href = "/administration/AdminLogout.asp" class = "Menu2" >Logout</a>&nbsp;&nbsp;&nbsp;
					</td>
</tr>
</table>
</td></tr>
...
<tr><td>
<!--#Include file="AdminTransferHeaderTabsInclude.asp"--> 
