...
<head>
<!--#Include virtual="//test/GlobalVariables.asp"-->
<meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
<meta http-equiv="Content-Language" content="en-us">
<title><%= WebSiteName %> Start-up Assistance</title>
...
<table border="0" cellpadding="5" cellspacing="0" width="800"  background = "images/PageBackground.jpg">
    <tr>
      <td width = "800" >
        <br><h1 ><i>Start-up Assistance</i><img src = "images/Line.jpg" width = "720" height = "2"></h1>
		</td>
	</tr>
    <tr>
      <td class = "body" valign = "top" >
        <blockquote>
			...
			<img border="0" src="images/startup.jpg" align= "right" width="299" height="298">
...
<ul>
	<li>Providing newcomers with "understandable step-by-step start-up assistance" for successful animal AND business operations.</li> 

<li>Making our top-of-the-line champion colored herdsires available to other ranchers' females, for a limited number of breedings.</li>

<li>Marketing and selling no more than 10 to 15 top-quality offspring annually, priced below their market value. Like a fine custom home builder, we target only a limited number of sales and breedings each year.</li>
</ul>

Our approach to consumers is to initiate and develop a personal business relationship with a small number of loyal customers. In a purposeful manner, we attempt to WOW them with our honesty, expertise, individualized attention, and top-of-the-line alpacas at mid-range prices.<br>
			<br>
