...
<HTML>
<HEAD>
 <title>Add Auction Header Results Page</title>
...
Query =  " UPDATE AuctionHeader Set FieldContent = '" +  Title + "' " 
...
Query =  " UPDATE AuctionHeader Set FieldContent = '" +  Text + "' " 
Query =  Query + " where FieldID = 0;" 
'response.write(Query)	
DataConnection.Execute(Query) 

Query =  " UPDATE AuctionHeader Set FieldContent = '" +  Text2 + "' " 
Query =  Query + " where FieldID = 2;" 
'response.write(Query)	
DataConnection.Execute(Query) 
...
<table width = "660" align = "center">
	<tr >
		<td align = "right">
			<br><a  Class = "Links" href="auctions.asp"> Return to the Edit  Auctions Page</a>
			<br>
		</td>
	</tr>
</table>
