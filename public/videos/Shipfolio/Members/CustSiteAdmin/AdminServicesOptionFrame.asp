...
<% End if%>
        ...
        <td class = "body">
       <form method="POST" action="AdminServicesOptionFrame.asp?ServicesID=<%=ServicesID %>&ServicesOptionID=<%=ServicesOptionID %>&DeleteOption=True" ><input type=submit value = "X" class = "regsubmit2" ></form> 
        </td>
        </tr>
       </table>
...
<% while not rss.eof
  ...
  <td align = 'center' ><form method="POST" action="AdminServicesOptionFrame.asp?ServicesID=<%=ServicesID %>&ServicesOptionsAttributesID=<%= ServicesOptionsAttributesID %>&ServicesOptionID=<%=ServicesOptionID %>&DeleteAttribute=True" > <input type=submit value = "X" class = "regsubmit2" ></form></td>
  </tr>        
