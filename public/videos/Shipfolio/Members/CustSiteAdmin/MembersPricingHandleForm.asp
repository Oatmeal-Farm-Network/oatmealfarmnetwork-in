...
Query =  Query & " where ShippingToCountry = '" & ShippingToCountry(rowcount) & "' and AnimalID = " & ID & ";" 
...
Set connLOA = Nothing 
rowcount= rowcount +1
response.redirect("membersPricingFrame.asp?ID=" & ID & "&SpeciesID=" & SpeciesID & "&category=" & category & "&changesmade=True")
%>
</Body>
</HTML>
