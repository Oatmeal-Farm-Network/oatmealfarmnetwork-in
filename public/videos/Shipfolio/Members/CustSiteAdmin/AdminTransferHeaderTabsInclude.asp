...
<% if Current = "Transfer Data" then %>
 ...
 <% if Current = "PAA" then %>
   <td class = "body2" width = "90" height = "30" align = "center" background = "images/TabOn.jpg"></td>
   <% else %>
   <td class = "body2" width = "90" height = "30" align = "center" background = "images/TabOff.jpg"></td>
   <% end if %>
