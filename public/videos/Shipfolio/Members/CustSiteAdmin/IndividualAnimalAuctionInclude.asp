...
<table border = "0"   leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 >
	<tr>
		...
		<table border = "0" width = "300"  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 >
			<tr>
				<td class = "body" valign = "top" width = "22">&nbsp;Color: </td>
			...
			<tr>
				...
				<tr>
				<td class = "body" valign = "top" width = "20">&nbsp;Owner: </td>
				<td class = "body" width = "280"><%=Owner %></td>
			</tr>
...
<%else%>
		...
		<tr><%If category = "Dam" Then %>
			...
			<% If Not(currentbid =  "No bids yet") Then %> 
			</tr>
			...
			<% End If %>
				...
				<td class = "body" valign = "top">Place a bid:</td>
				<td class = "body">
			...
			<input type="submit" value = "Place Bid" style="background-image: url('images/ButtonBackground.jpg'); border-width:1px" size = "100" Class = "menu" ><br>(enter <%= minbid%> or more)
