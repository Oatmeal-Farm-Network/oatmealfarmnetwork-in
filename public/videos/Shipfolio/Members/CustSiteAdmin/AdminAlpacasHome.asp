...
<link rel="icon" href="http://www.livestockoftheworld.com/Infinityknot.ico" /> 
...
<tr><td class = "roundedtop" align = "left">
		<H1><div align = "left">List of Alpacas</div></H1>
        </td></tr>
...
<%  sql = "select distinct Pricing.*, animals.ID, FullName, PublishForSale, PublishStud, Category from Animals, Pricing where Animals.ID =Pricing.ID  order by FullName"

'response.write (sql)
    Set rs = Server.CreateObject("ADODB.Recordset")
    rs.Open sql, conn, 3, 3  
    if rs.eof then %>
   Currently you do not have any alpacas listed. To add alpacas please select the <a href = "AdminAnimalAdd1.asp" class = "body">Add Alpaca</a> tab.
 <% else    
	rowcount = 1
dim ID(99999) 
dim Name(99999)  
