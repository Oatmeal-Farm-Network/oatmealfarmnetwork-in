...
session("Description") =""
response.redirect("membersEditAnimal.asp?FirstTime=True&PeopleID=" & PeopleID & "&SpeciesID=" & SpeciesID & "&ID=" & ID ) %>
 </Body>
</HTML>