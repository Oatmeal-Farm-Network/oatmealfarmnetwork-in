...
While CatCounter < FinalCatCounter
	CatCounter= CatCounter +1 %>
			...
			<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  ><tr><td> <form action= 'EditArticleCategory.asp' method = "post" style="margin-bottom:0;" >
			<div style="display: inline;">
			<input name="ArticleCategoryName" value ="<%= ArticleCategoryName(CatCounter,0) %>"  size = "20">
...
%>
		...
		<td width = "300"   class = "body" valign = "top">
			...
			<form action= 'AddArticleCathandleform.asp' method = "post">
				<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  valign ="top" >
				<tr>
...
<form action= 'DeleteArticlecatHandleform.asp' method = "post">
	<input name="CategoryType" type = "hidden" Value = "<%=TempCategoryType%>">
