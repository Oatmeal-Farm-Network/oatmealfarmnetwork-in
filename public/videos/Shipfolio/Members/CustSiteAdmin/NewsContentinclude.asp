<% If Len(NewsPageText(num)) > 2 then%>
					<% If Len(Image(num)) < 2 then%>
						<table border = "6" bordercolor = "#E5C9A2" bgcolor = "#E5C9A2" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" width = "700">
						   <tr>
