...
DOBYear = "0"
End If
sql2 = "select Animals.ID from Animals where PeopleID = " & session("PeopleID") & " and id = " & id & "" 
...
Query =  Query & " where ID = " & AlpacasID & ";" 
Conn.Execute(Query) 
response.redirect("AdminGeneralStatsFrame.asp?ID=" & AlpacasID & "&changesmade=True")
 %>
</body>
</html>