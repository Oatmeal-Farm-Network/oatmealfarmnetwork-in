...
str1 = lcase(Filename)
str2 = "jpg"
If InStr(str1,"jpg") > 0 or InStr(str1,"jpeg") > 0 or InStr(str1,"gif") > 0 or InStr(str1,"png") > 0 Then
imageOK = True
End If 

if imageOK = True then
Query =  " UPDATE SiteDesignHeaderImages Set HeaderImage = '" &  Filename & "' "
Query =  Query & " where HeaderID =" & HeaderID
Conn.Execute(Query)

else
Response.Redirect("AdminUpdateHeader.asp?wrongformat=True#images")
end if
Conn.Close
		
end if
Response.Redirect("AdminUpdateHeader.asp?Filename=" & Filename)
%>
</BODY>
</HTML>