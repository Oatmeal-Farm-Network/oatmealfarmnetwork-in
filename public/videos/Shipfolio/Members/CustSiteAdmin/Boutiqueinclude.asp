...
conn = "Provider=Microsoft.Jet.OLEDB.4.0;" & _
  ...
  sql = "select * from Pagelayout where PageName = 'Boutique'"
'response.write(sql)
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "680">
	<tr>
		<td valign = "top">
			 <form action= 'BoutiquePageHandleForm.asp' method = "post">
...
<table border = "0" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 >
		...
		<tr>
			...
			<td  align = "right">
			<input type=submit value = "Update" Class = "body" >
		</td>
		</tr>
		<tr>
			<td colspan = "2" align = "left" valign = "top" class = "body" valign = "top">
					<TEXTAREA NAME="Text" cols="44" rows="36" wrap="file"><%=PageText1%></textarea>
			</td>
		</tr>
		<tr>
		<td  valign = "middle" colspan = "2" align = "center">
			...
			<tr>
				<td class = "body">
					<table>
					   <tr>
					     <td class = "body">
							<form name="frmSend" method="POST" enctype="multipart/form-data" action="StoreuploadPageImage.asp" >
						...
						<tr>
					    <td class = "body">
							<form action= 'RemoveStoreImage.asp' method = "post">
			...
			<tr>
				<td class = "body">
					<table>
					   <tr>
					     <td class = "body">
							<form name="frmSend" method="POST" enctype="multipart/form-data" action="StoreuploadPageImage2.asp" >
			...
			<tr>
				<td class = "body">
					<table>
					   <tr>
					     <td class = "body">
							<form name="frmSend" method="POST" enctype="multipart/form-data" action="StoreuploadPageImage3.asp" >
			...
			<tr>
				<td class = "body">
					<table>
					   <tr>
					     <td class = "body">
							<form name="frmSend" method="POST" enctype="multipart/form-data" action="StoreuploadPageImage4.asp" >
