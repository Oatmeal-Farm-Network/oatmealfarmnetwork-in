...
Query =  "INSERT INTO Fiber ( ID, SampleDate,  Average, StandardDev, COV,  ShearWeight, CF, Curve,  CrimpPerInch, Length, BlanketWeight, GreaterThan30)" 
...
<table  border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0>
	<tr>
		<td class = "body"><img src = "images/WizardHeader.jpg">
			<a name="Add"></a>
			<blockquote><H1>Step 4: Description</H1>
			<img src = "images/Important_Triangle.png" height = "20">We strongly suggest that you compose your animal suggestions in a separate word processor such MS Word then copy and paste them into your admin area.</blockquote>
		</td>
	</tr>
...
<form action= 'AddAnAlpaca5.asp' method = "post" name = "myform">
<table border = "0" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "750">
	<tr>
		<textarea name="Description" cols="87" rows="26"  onKeyDown="textCounter(this.form.Description,this.form.remLentext,1600);" onKeyUp="textCounter(this.form.Description,this.form.remLentext,1600);"></textarea>
