...
<body>
<a name="EPD"></a>
 <table border = "0" cellspacing="0" cellpadding = "0" align = "left"  width = "100%" ><tr><td class = "roundedtopandbottom" align = "left">
...
if PercentFGreaterThan30Percent = 0 then
...
<td class = "body2" align = "center"><input name="SDAFDPercent" value="<%= SDAFDPercent%>"  size = "1" maxlength = 2 class = "formbox"> %</td>
