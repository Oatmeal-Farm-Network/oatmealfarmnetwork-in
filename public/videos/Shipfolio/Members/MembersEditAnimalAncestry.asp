...
dim aName(60)
	...
	sql2 = "select Animals.AnimalID, Animals.FullName from Animals where speciesid =" & speciesID & " and BusinessID =" & BusinessID & " order by trim(Fullname) "
...
damscounter = 1
	sqldams = "select Animals.AnimalID, Animals.FullName from Animals where (category  = 'Experienced Female' or category  = 'Inexperienced Female' ) and BusinessID = " & BusinessID & " and speciesid =" & speciesID & "  order by trim(Fullname)"
...
sirescounter = 1
	sqlsires = "select Animals.AnimalID, Animals.FullName from Animals where (category  = 'Experienced Male' or category  = 'Inexperienced Male')  and BusinessID = " & BusinessID & " and speciesid =" & speciesID & " order by trim(Fullname) "
