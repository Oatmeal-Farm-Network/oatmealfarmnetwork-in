...
if Request.ServerVariables("REQUEST_METHOD") <> "POST" then
	...
	End If
		Response.Write("AdType=" & AdType)  
if trim(AdType)= "MegaAdComboBackground" then    
Query =  " UPDATE Ads Set AdImageBackground = '" &  Filename & "' " 
...
if len(AdID) > 0 then
Query =  " UPDATE Ads Set AdImage = '" &  Filename & "' " 
