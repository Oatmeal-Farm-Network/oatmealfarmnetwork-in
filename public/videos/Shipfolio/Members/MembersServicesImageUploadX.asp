...
Filename =  LongWeblink  & SaveFiles()
    str1 = Filename
	str2 = "'"
	...
	Query =  " UPDATE Services Set Photo" & photonum & " = '" &  Filename & "' " 
...
photonum = photonum - 1
	...
	redirect = "MembersServicesUploadPhotos.asp?ServicesID=" & ServicesID & "#" & photonum
