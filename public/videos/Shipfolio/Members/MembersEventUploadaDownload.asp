...
TempPageLayoutID = Request.querystring("PageLayoutID")
EventID = Request.querystring("EventID")
BlockNum = Request.querystring("BlockNum")
filenamex = Request.querystring("filename2")
...
If uploadgood = True then
	...
	Query =  " UPDATE EventPageLayout2 Set Upload = '" &  Filename & "', UploadText=' " & uploadText & "' "
	Query =  Query & " where EventID = " & EventID & ";" 
    response.write("Query=" & Query )
    Conn.Execute(Query) 
end if 

Response.Redirect(filenamex & "?EventID=" & EventID )
