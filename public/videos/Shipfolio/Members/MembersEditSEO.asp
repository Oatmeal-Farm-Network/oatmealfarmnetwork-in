...
%>
    ...
    <% Current3 = "SEO" %>
<!--#Include file="MembersPagesTabsInclude.asp"-->
...
Dim LinkNameList(40000)	
	sql2 = "select Pagelayout.LinkName, Pagelayout.PageName from Pagelayout, PageSEO where PageAvailable = True and  Pagelayout.PageLayoutId = PageSEO.PageLayoutId "	
	acounter = 1
	...
	rs2.close
	sql2 = "select Linkname from Pagelayout, PageSEO where  PageAvailable = True and Pagelayout.PageLayoutId = PageSEO.PageLayoutId and   PageSEO.PageName =  '" & PageName & "'"
	Set rs2 = Server.CreateObject("ADODB.Recordset")
	rs2.Open sql2, conn, 3, 3 
...
<form  action="MembersEditSEO.asp" method = "post">
