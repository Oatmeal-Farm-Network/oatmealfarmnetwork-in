...
<div class ="row">
    <div class = "col body roundedtopandbottom" valign = "top" width = 200>
     ...
     <select size="1" name="country_id" style="width: 190px" class = "formbox">
       ...
       sql = "select distinct people.country_id, name from people, business, country where people.businessid = business.businessid  and people.country_id = Country.country_id and businesstypeid=" & BusinessTypeID &" order by name"
...
<% showownersearch = false
   if showownersearch = True then %>
     <div class ="row">
         <div class ="col">
         <form method="POST" action="RanchSearchResults.asp" class = "body">
            Owners' Name&nbsp;<br />
...
while not rs.eof 
    ...
    Link2= "https://" & AdFooterLink(x)
     ...
     AdFooterLink(x) = "Farms/RanchHome.asp?CurrentBusinessID=" & BusinessID
    end if
