...
<div class ="row">
    <div class ="col" >
      Membership Categories<br />
        ...
        <br />   <br />
            <a class="roundedtopandbottomyellow body" href="/Join/USA/ArtisanAccounts.asp">&nbsp;Artisan Food Producer&nbsp;</a> &nbsp;
...
<% end if %>
     ...
     <tr><td height = 1 colspan = <%=colspan%> bgcolor = "#abacab"></td></tr>
      ...
      <tr >
         ...
         <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Intro&Subscription=Artisan' method = "post"><input type=submit value = "SELECT" class = "roundedtopandbottomyellow" ></form></center>
         
         </td>
         <td align = "center">
            <b><%=CurrencyCode %><%= BasicMonthlyRate%>&nbsp;<%=LocalCurrency%>  / Month</b> 
             <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Basic&Subscription=Artisan' method = "post"><input type=submit value = "SELECT" class = "roundedtopandbottomyellow" ></form>
            ...
            <td align = "center">
             ...
             Not Available Yet
        <% else %>  
         <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Business&Subscription=Artisan' method = "post"><input type=submit value = "SELECT" class = "roundedtopandbottomyellow" ></form>
         <% end if %>       
   ...
   if showMarketplaces = True then %>
         <td align = "center"><b><%=CurrencyCode %><%= GlobalMonthlyRate%>&nbsp;<%=LocalCurrency%>  / Month</b>
          <form action= 'SetupAccountPlus.asp?BusinessTypeID=<%=BusinessTypeID %>&Membership=Global&Subscription=Artisan' method = "post"><input type=submit value = "SELECT" class = "roundedtopandbottomyellow" ></form></center></td></td>
      </tr>
    <% end if  %>
    </table>
<br />
