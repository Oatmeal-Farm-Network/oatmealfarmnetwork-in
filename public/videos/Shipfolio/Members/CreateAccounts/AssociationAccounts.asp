...
<% Title= "Join the Global Farmers' Market for Agricultural Associations"
Description = "Connect your agricultural association with restaurants and home cooks worldwide through the Global Farmers' Market. Simplify the farm-to-fork journey and foster direct relationships, ensuring the freshest produce, meats, and ingredients for everyone."
...
<!--#Include virtual="/Header.asp"--><div class="container-fluid" id="grad1" >
    ...
    <div>
      <div class = "body">
        <h1>Association Membership Options</h1>
          </div>
        </div>
    </div>
    </div>
...
BusinessTypeID = 1
MembershipType = "Association Memberships"
MembershipImage = "AssociationAccouiHeader.jpg"
...
<div class ="row">
    ...
    <div class="col">
       Membership Categories<br />
         <a class="roundedtopandbottomyellow body" href="/Join/USA/AssociationAccounts.asp">&nbsp;Association&nbsp;</a>&nbsp;
  ...
  <a class="roundedtopandbottomyellow body" href="/Join/USA/FarmAccounts.asp">&nbsp;Farm / Ranch&nbsp;</a>&nbsp;
      <span class="line-break-md"><br></span>
            <a class="roundedtopandbottomyellow body" href="/Join/USA/FoodHubAccounts.asp">&nbsp;Food Hub&nbsp;</a> &nbsp;
            <a class="roundedtopandbottomyellow body" href="/Join/USA/RestaurantAccounts.asp">&nbsp;Restaurant&nbsp;</a> 
            <a class="roundedtopandbottomyellow body" href="/Join/USA/OtherAccounts.asp">&nbsp;Other&nbsp;</a> 
    </div>
  </div>
...
<br />
  ...
  <tr  >
         <td colspan ="4"><font size = 4>Visible at </font><a href="https://agricultureassociations.world/" target="_blank" class = "body" ><font size = 4>AgricultureAssociations.world</font></a>
...
<% end if %>
 ...
 <tr><td height = 1 colspan = <%=colspan%>  bgcolor = "#abacab"></td></tr>
       <tr >
         <td width = "220"><font size = 4>Maintain Members List</font></td>
        <td align = "center"><font color="#6f9243">&#x2714;</font></td>
         <td align = "center"><font color="#6f9243">&#x2714;</font></td>
             <% if showpremium = true then %>
         <td align = "center"><font color="#6f9243">&#x2714;</font></td>
