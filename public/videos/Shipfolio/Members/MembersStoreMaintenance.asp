...
<% Current1="Products"
Current2 = "StoreSettings" %> 
<!--#Include file="MembersHeader.asp"-->
 
 <table border = "0" cellspacing="0" width = "<%=screenwidth - 32 %>" cellpadding = "0" align = "center" ><tr><td  align = "left">
...
<input name="TaxRate"  size = "3" value = "<%= TaxRate %>">%
    ...
    <% end if %>
	<br />	<table border = "0" bordercolor = "bbbbbb" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "500"><tr><td align = "center"><input type=submit value = "Submit Changes" class = "regsubmit2" ></td></tr></table>
		</form>
