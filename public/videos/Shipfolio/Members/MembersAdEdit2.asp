...
<div>
    <div>
        <H1>Edit Product: <%=ProdName %><a name="Add"></a></H1>
         <form action="membersAdEdit2.asp" method = "post">
         <% Dim XIDArray(1000)
            Dim XProdname(1000)
            sql2 = "select * from sfProducts where peopleid = " & peopleid & " order by Prodname"
            acounter = 1
...
<div>
	<div bgcolor = "#e6e6e6">
        <center><iframe src="/members/MembersProductPublishFrame.asp?ProdID=<%=ProdID %>" frameborder =0 width = "100%" height = "170" scrolling = "no" bgcolor = "#e6e6e6" align = "center" ></iframe></center>
    </div>
</div>
<div>
   <div>
        ...
        <i>Note: The information below applies to all of your products that you list.</i><br />
		...
		<input name="PaypalEmail"  size = "60" value = "<%=PaypalEmail %>" class = "formbox"><br>
...
<div >
    <div class = roundedtopandbottom align=left>
        <iframe src="membersProductGeneralStatsFrame.asp?ProdID=<%=ProdID %>" height = '950' width = '100%' frameborder= '0' valign='abstop' seamless = Yes scrolling = no ></iframe>
    </div>
</div>
<div>
    <div class = roundedtopandbottom align=left>
        <iframe src="membersProductdescriptionFrame.asp?ProdID=<%=ProdID %>" height = '568' width = '100%' frameborder= '0' valign='abstop' seamless = Yes scrolling = no></iframe>
    </div>
</div>
<% 
...
<div >
    <div class = roundedtopandbottom align=left>
        ...
        <iframe src ="membersShippingFrame.asp?ProdID=<%=ProdID %>&screenwidth=<%=screenwidth %>" height="388" width="100%" frameborder = "0" scrolling = "auto" valign = "top" align = "center" ></iframe>
        <br>
    </div>
</div>
<% 
...
<div >
    ...
    <iframe src="membersProductsAttributeValuesFrame.asp?ProdID=<%=ProdID %>&prodPurchasemethod=<%=prodPurchasemethod %>&ProdPrice=<%=ProdPrice %>" height = '<%=Frameheight %>' width = '100%' frameborder= '0' valign='abstop' seamless = Yes scrolling = auto></iframe>
</div>
</div>
...
if showtaxes = true then %>
<div>
    <div align = "left" class = "roundedtop">
        <H1>Taxes</H1>
    </div>
</div>
<div>
