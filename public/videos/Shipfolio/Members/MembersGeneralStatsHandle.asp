...
' Output the DOB parts
'Response.Write("Day: " & DOBday & "<br>")
'Response.Write("Month: " & DOBmonth & "<br>")
'Response.Write("Year: " & DOByear & "<br>")
end if
...
DOBYear = "0"
End If
sql2 = "select Animals.animalID from Animals where BusinessID = " & BusinessID & " and AnimalID = " & AnimalID & "" 
...
For rowcount = 0 To TotalRegistrations 
...
Query =  Query & " where AnimalID = " & AnimalID & " and RegType = '" & SpeciesRegistrationType(rowcount) & "';" 
'response.write("<br>update=" & query)
Conn.Execute(Query) 
next
Conn.Execute(Query) 
...
Conn.close
set Conn = nothing 
response.redirect("MembersEditAnimalBasics.asp?BusinessID=" & BusinessID & "&AnimalID=" & AnimalID & "&changesmade=True")
 %>
