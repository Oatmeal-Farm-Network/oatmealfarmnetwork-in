...
<%
Dim BusinessTypeID : BusinessTypeID = 28 
BusinessTypeName =  "Business Resources" 
BusinessTypeIcon = "/icons/Handshake.png"
...
<% If Len(BusinessFacebook) > 10 Then %><a href="<%=ValidateAndFixLink(BusinessFacebook) %>" target="_blank"><img src="/icons/facebook.png" alt="Facebook" /></a><% End If %>
<% If Len(BusinessX) > 10 Then %><a href="<%=ValidateAndFixLink(BusinessX) %>" target="_blank"><img src="/icons/TwitterX.png" alt="Twitter/X" /></a><% End If %>
<% If Len(BusinessInstagram) > 10 Then %><a href="<%=ValidateAndFixLink(BusinessInstagram) %>" target="_blank"><img src="/icons/instagramicon.png" alt="Instagram" /></a><% End If %>
<% If Len(BusinessPinterest) > 10 Then %><a href="<%=ValidateAndFixLink(BusinessPinterest) %>" target="_blank"><img src="/icons/PinterestLogo.png" alt="Pinterest" /></a><% End If %>
<% If Len(BusinessTruthSocial) > 10 Then %><a href="<%=ValidateAndFixLink(BusinessTruthSocial) %>" target="_blank"><img src="/icons/Truthsocial.png" alt="Truth Social" /></a><% End If %>
<% If Len(BusinessBlog) > 10 Then %><a href="<%=ValidateAndFixLink(BusinessBlog) %>" target="_blank"><img src="/icons/BlogIcon.png" alt="Blog" /></a><% End If %>
<% If Len(BusinessYouTube) > 10 Then %><a href="<%=ValidateAndFixLink(BusinessYouTube) %>" target="_blank"><img src="/icons/YouTube.jpg" alt="YouTube" /></a><% End If %>
<% If Len(BusinessOtherSocial1) > 10 Then %><a href="<%=ValidateAndFixLink(BusinessOtherSocial1) %>" target="_blank"><img src="/icons/GeneralSocialIcon.png" alt="Social Media" /></a><% End If %>
<% If Len(BusinessOtherSocial2) > 10 Then %><a href="<%=ValidateAndFixLink(BusinessOtherSocial2) %>" target="_blank"><img src="/icons/GeneralSocialIcon.png" alt="Social Media" /></a><% End If %>
