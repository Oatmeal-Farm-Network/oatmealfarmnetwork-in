...
<table  border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" width = "<%=Textwidth + 18 %>" align = "center">	
	<tr>
		<td class = "body2" colspan = "2" ><br><h2>Vet Check</h2></td>
	</tr>
  	<tr>
