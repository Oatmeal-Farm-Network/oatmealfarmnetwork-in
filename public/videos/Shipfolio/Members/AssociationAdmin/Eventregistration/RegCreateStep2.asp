...
If Edit = "True" then
if len(BusinessWebsiteID) > 0 then
...
<%
if len(BusinessAddressID) > 0 then
...
rs.close
	...
	Query =  "INSERT INTO Event (associationID, AddressID, EventName, EventTypeID, WebsiteID, BusinessID, PublishedDate, "
	Query =  Query & " EventLocationID   )"
	Query =  Query & " Values (" & session("AssociationID") & ", "
	Query =  Query & " " & EventLocationAddressID & ", "  
...
%>
<table border = "0" cellspacing="0" cellpadding = "0" align = "center" width = "<%=screenwidth  %>"><tr><td align = "left">
...
<tr>
		<td class ="body2" valign = "top" colspan = "2" >
			...
			<br><center><br><font color = red>*</font> indicates a Required field.</center>
		</td>
	</tr>
	<tr>
...
<tr><td >
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=5 cellspacing=5  width = "100%" align = "center">
<tr>							<td class = "body2" width = "200" align = right>
								Name of Location
							</td>
							<td class = "body2" align = "left" >
								<%=EventLocationName%>
