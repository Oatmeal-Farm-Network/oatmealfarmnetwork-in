...
<tr><td class = "body2" colspan  "3" height = "1">
	Currently there are no classes listed. To add classes please select <a href ="ClassesAdd.asp?EventID=<%=EventID%>" class = "body">Add Classes</a>.
	</td></tr>
...
<% 	
   ...
   <% end if 
	...
	<% end if %>
	     <td class="body2" >
	      &nbsp; <a href = "ClassesEditDetails.asp?ClassInfoID=<%=ClassInfoID%>&EventID=<%=EventID%>" class = "body"><%=ClassInfoTitle %></a>
	     </td>
     	<td class="body2" align = "center">
	      ...
	      <a href = "ClassesDeleteHandleForm0.asp?ClassInfoID=<%=ClassInfoID%>&ClassInfoTitle=<%=ClassInfoTitle %>&EventID=<%=EventID%>" ><img src = "images/delete.jpg" width = "15" border = "0" alt = "Delete Class"></a>
...
order = "Even"
 ...
 ClassesFound = False
 sql2 = "SELECT * from Registrationtemp where PeopleID = " & CurrentOrderPeopleID & " and Quantity > 0 and EventID=" & EventID & " Order by RegistrationDateTime Desc,  ServiceDescription desc "
...
<% else %>
Currently there are no class / workshop registrations.
