...
if len(PeopleID) > 0 then
  AccountCreated = True
  	session("PeopleID") = PeopleID
  	response.Redirect("iFrameEventRegister2.asp")
end if
...
<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  valign ="top"  width = "279" height = "155"><tr><td class = "body" colspan = "2" >		<form action= 'iFrameEventRegister2.asp' method = "post">
...
<tr>
 ...
 <blockquote> <center><h2>Forgot Your Password?</H2></center>
  <a href = "sendpassword.asp" class = "body" target = "blank">Click Here</a> to have your password emailed to you.</blockquote>
		...
		<form action= 'iFrameEventRegister2.asp' method = "post">
		<blockquote>
		<% if len(PeopleID) > 0 then %>
...
<form action= "iFrameEventRegister2.asp?EventID=<%=EventID%>&Update=True#FormTop" name="OrderForm" method = "post">
...
<%
 ...
 sqlp = "select * from AnimalHalterClassesLookup where SpeciesID = 1"
      ...
      <% if len(AnimalIDArray(counterx))> 0 then %>
         ...
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=AnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister2.asp?RemoveHalterAnimal=True&AnimalID=<%=AnimalIDArray(counterx)%>#Halter" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & PeopleID & " and RegistrationType = 'Production'"
  ...
  <select size="1" name="ProductionAnimalIDArray(<%=counterx %>)" width = "300" style="width: 300px" onchange="submit();">
    ...
    sqlp = "select * from AnimalProductionClassesLookup where SpeciesID = 1"
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(ProductionAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=ProductionAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister2.asp?RemoveProductionAnimal=True&AnimalID=<%=ProductionAnimalIDArray(counterx)%>#Production" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & PeopleID & " and RegistrationType = 'Companion'"
  ...
  <select size="1" name="CompanionAnimalIDArray(<%=counterx %>)"  width = "300" style="width: 300px" onchange="submit();">
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(CompanionAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=CompanionAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister2.asp?RemoveCompanionAnimal=True&AnimalID=<%=CompanionAnimalIDArray(counterx)%>#Companion" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & PeopleID & " and RegistrationType = 'Fleece'"
  ...
  <select size="1" name="FleeceAnimalIDArray(<%=counterx %>)" width = "300" style="width: 300px"  onchange="submit();">
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(FleeceAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=FleeceAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister2.asp?RemoveFleeceAnimal=True&AnimalID=<%=FleeceAnimalIDArray(counterx)%>#Fleece" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
sql = "select * from RegisteredAnimals where EventId = " & EventID & " and PeopleID =" & PeopleID & " and RegistrationType = 'SpinOff'"
  ...
  <select size="1" name="SpinOffAnimalIDArray(<%=counterx %>)"  width = "300" style="width: 300px" onchange="submit();">
      ...
      <td class = "body" align = "center" width = "140">
      <% if len(SpinOffAnimalIDArray(counterx))> 0 then %>
         <a href = "EventAddAnimal.asp?AddAnimal=False&EditAnimal=True&AnimalAdded=True&AnimalID=<%=SpinOffAnimalIDArray(counterx)%>" class = "body">Edit</a> | <a href = "iFrameEventRegister2.asp?RemoveSpinOffAnimal=True&AnimalID=<%=SpinOffAnimalIDArray(counterx)%>#SpinOff" class = "body">Remove</a>
      <% end if %>
	  </td>
	 </tr>
	<% 
...
<form action= "iFrameEventRegisterPayment2.asp?EventID=<%=EventID%>&EventName=<%=EventName%>&OrderTotal=<%=OrderTotal%>&PeopleID=<%=PeopleID%>#Top" name="OrderForm" method = "post">
