...
<table border = "0"  cellpadding=0 cellspacing=0 width = "<%=Textwidth %>" align = "center" >
	<tr>
	   <td  valign = "top"   colspan = "3"><br><h2><%=EventName %> Vendors</h2></td>
	</tr>
...
<tr>
  	...
  	<td class = "body" ><%= Numfreetables %> tables.
	</td>
	</tr>
<% end if  %>
...
<tr>
  	...
  	<td class = "body"><%= formatcurrency(Costpertable, 2) %>
</td>
  	</tr>
 <% end if %>
...
<tr>
  	...
  	<td class = "body" ><%= MaxExtraTables %>
</td>
  	</tr>
 <% end if  %>
 <tr>
  	<td class = "body" colspan = "2" ><%=VendorStallDescription %></td></tr>
</table>
	     </td>
	   </tr>
...
<%  sql = "select distinct PeopleID from Registration where EventID = " & EventID & " and instr(ServiceDescription , 'vendor') and Quantity > 0 "
...
if not (PeopleFirstName = "John" and PeopleLastName = "Andresen") then
%>
...
<tr>
<td width = "120" align = "center" valign = "top">
<a href = "http://www.layzacresalpacas.com" target = "_blank"><Img src = "http://www.andresenevents.com/images/LZALogo.jpg" width = "110" alt = "Lazy Acres Alpacas" border = "0"/></a>
<br />
</td>
<td valign = "top" class = "body" >
<b>Lay Z Acres Alpacas<br />
Carrie Lay</b><br />
35453 Hendricks Road<br />
Creswell, OR  97426<br />
<a href = "http://www.layzacresalpacas.com" target = "blank">www.LayzAcresAlpacas.com</a><br />
541-913-2898<br />
