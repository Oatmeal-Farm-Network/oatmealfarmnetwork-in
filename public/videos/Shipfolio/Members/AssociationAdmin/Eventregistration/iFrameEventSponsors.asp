...
<BODY border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"   align = "center"><table border = "0" width = "770" height = "100%" bgcolor = "<% =backgroundcolor%>" align = "center"><tr><td valign = "top" align = "center">
...
<table border = "0"  cellpadding=0 cellspacing=0 width = "760" align = "center" >
	<tr>
	   <td  valign = "top"   colspan = "3"><br><h2><%=EventName %> Sponsors4</h2></td>
	</tr>
...
<%  end if %>
 ...
 <table border = "0"  cellpadding=0 cellspacing=0 width = "300" align = "center" valign = "top">
	<tr>
