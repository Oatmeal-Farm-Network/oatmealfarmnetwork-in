...
If Request.Querystring("UpdateFiberArts" ) = "True" Then
...
%>
<!--#Include file="FiberArtsHeader.asp"--> 

<table border = "0"  cellpadding=0 cellspacing=0 width = "960" align = "center" >
	<tr>
	   <td  valign = "top"   colspan = "3"><br><h2>Fiber Arts Overview</h2></td>
	</tr>
...
sql = "select * from Services, ServiceTypeLookup where Services.ServiceTypeLookupID = ServiceTypeLookup.ServiceTypeLookupID and ServiceType = 'FiberArts' and EventID =  " & EventID & " Order by ServicesID Desc"
'response.write(sql)
...
<form  name=FiberArtsform method="post" action="FiberArtsHome.asp?EventID=<%=EventID%>&UpdateFiberArts=True">
