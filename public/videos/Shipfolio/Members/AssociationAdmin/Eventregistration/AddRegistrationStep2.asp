...
<a name="Top"></a>
<table border = "0" cellspacing="5" cellpadding = "5" align = "center" width = "<%=textwidth%>" >
<tr><td class = "roundedtopandbottom" align = "left">
		<H1><div align = "left">Add a Registration - Step 2 Place Order</div></H1>
        </td></tr>
        <tr><td align = "center" width = "<%=textwidth%>">
<br>
...
<table  border="0"  cellspacing="5" cellpadding="5" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  width = "<%=screenwidth - 35%>" align = "center">	
<tr><td class = "roundedtopandbottom" align = "left">
