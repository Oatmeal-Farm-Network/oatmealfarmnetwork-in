...
<title>SF Product Sale Page</title>
...
<table border="0" cellpadding="1" cellspacing="0" bgcolor="<%= C_BORDERCOLOR1 %>" width="<%= C_WIDTH %>" align="center">
  <tr>
          ...
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		        ...
		        <td align="center" background="<%= C_BKGRND2 %>"  bgcolor="<%= C_BGCOLOR2 %>"><center><b><font face="<%= C_FONTFACE2 %>" color="<%= C_FONTCOLOR2 %>" SIZE="<%= C_FONTSIZE2 %>">Sales Page</font></b></center></td>
    ...
    If rsSearch.EOF Then
        ...
        & "<tr>" _
        & "<td><center><font face=" & C_FONTFACE4 & " color=" & C_FONTCOLOR4 & " SIZE=" & C_FONTSIZE4 & ">There are currently no sale items available from inventory</font></center></td></tr>" _
        & "<tr>" _
