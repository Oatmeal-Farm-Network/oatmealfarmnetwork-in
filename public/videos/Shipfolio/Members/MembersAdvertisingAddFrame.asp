...
<form  name=UpdateOrderForm method="post" action="MembersAdvertisingAddFrame.asp?Updatetable=True">
...
Query =  "Select AdType from Ads  where adWebsite = 'Alpaca Infinity' and AdMonth= '" &  Month(currentdate)  & "' and AdYear= '" & Year(currentdate)  & "' and AdType='Logo Ad' and AdPaidFor=True" 
...
<input type="hidden" name="Item_name_1" value="Purple Level Dutch Auctions">
...
<input type="hidden" name="quantity_1" value="<%=PurpleDutchAuctions %>">
