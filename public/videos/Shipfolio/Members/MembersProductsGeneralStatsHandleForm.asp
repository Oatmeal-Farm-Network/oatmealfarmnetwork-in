...
prodCategory1=Request.Form("prodCategory1") 
prodCategory2=Request.Form("prodCategory2") 
prodCategory3=Request.Form("prodCategory3") 
...
if len(session("prodCategory3ID")) > 0 and len(session("prodSubCategory3ID")) > 0 then
...
<body >
<% response.redirect("MembersProductEditBasic.asp?ProdID=" & prodID & "&changesmade=True" ) %>
