...
<% 
AboutLink = "AboutGeese.asp"
Description = " Geese are sometimes raised as livestock for their meat, eggs, and down feathers. Geese are waterfowl species native to Europe and North America, and are known for their rich, flavorful meat and high-quality eggs. The down feathers of geese are also highly valued for their insulating properties and are used to make a variety of products, including pillows, comforters, and clothing. <br><br>Geese are typically raised in free-range or semi-free-range systems. Goose meat is considered a delicacy and is used in a variety of dishes, while the eggs are considered healthy and are used in cooking and baking. Goose down is highly sought after for its warmth and softness, and is used in a variety of luxury products.<br> "
Title = "About Geese & Geese Breeds"
image = "Geeseheader.jpg"
 %>
...
<div class="container ">
  <div>
    ...
    <h1><img src="<%=BreedIcon %>" alt="About <%= trim(Breed) %> <%=SpeciesNamePlural %>" height="40" />&nbsp;Breeds of <%=SpeciesNamePlural %></h1>
  ...
  <p>
   <%=Description%>
      ...
      <form method="post" action="<%=AboutLink%>">
         <center> <input type="submit" class="regsubmit2" value="Learn More&nbsp;" /></center><br><br>
      </form>
