...
<% Description = "Chickens (Gallus gallus domesticus) are domesticated birds that are raised for meat and eggs. There are over 24 billion chickens worldwide. Raising chickens is relatively inexpensive. Because of the low cost, chicken meat (also called chicken) is one of the most common kinds of meat in the world.<br>"
AboutLink = "AboutChickens.asp"
title= "Chicken Breeds" 
image = "Chickenheader2.jpg"
letter = "a"
 %>
