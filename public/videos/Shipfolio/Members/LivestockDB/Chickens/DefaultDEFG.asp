...
<% Description = "Find Breed information on  Derbyshire Redcap, Dominique, Dorking, Easter Egger, Egyptian Fayoumi, Ermellinata di Rovigo, Faverolles, French Naked Neck"
Title = "Chicken Breeds That Start with D,E,F, and G"
 %>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=13 and (left((trim(LOWER(breed))), 1) = 'd' or left((trim(LOWER(breed))), 1) = 'e' or left((trim(LOWER(breed))), 1) = 'f' or left((trim(LOWER(breed))), 1) = 'g' ) Order by trim(Breed)"
