...
<% Description = "Find Breed information on Campine, Catalana, Chantecler, Cornish (a.k.a. Indian Game), Cubalaya"
Title = "Chicken Breeds | Livestock Of The World"
Title = "Chicken Breeds That Start with C"
 %>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=13 and left((trim(LOWER(breed))), 1) = 'c' Order by trim(Breed)"
