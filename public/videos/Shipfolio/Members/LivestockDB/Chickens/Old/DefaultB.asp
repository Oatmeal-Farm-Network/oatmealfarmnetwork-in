...
<% Description = "Find Breed information on Barnevelder, Bianca di Saluzzo, Bionda Piemontese, Braekel (Brakel), Brahma, Buckeye"
Title = "Chicken Breeds That Start with B" 
 %>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=13 and left((trim(LOWER(breed))), 1) = 'b' Order by trim(Breed)"
