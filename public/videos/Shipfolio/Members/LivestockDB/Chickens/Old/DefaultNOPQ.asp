...
<% Title = "Chicken Breeds That Start with N, O, P, and Q"
 %>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=13 and (left((trim(LOWER(breed))), 1) = 'n' or left((trim(LOWER(breed))), 1) = 'o' or left((trim(LOWER(breed))), 1) = 'p' or left((trim(LOWER(breed))), 1) = 'q' ) Order by trim(Breed)"
