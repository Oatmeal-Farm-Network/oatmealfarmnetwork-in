...
<% Title = "Chicken Breeds That Start with R"
 %>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=13 and left((trim(LOWER(breed))), 1) = 'r' Order by trim(Breed)"
