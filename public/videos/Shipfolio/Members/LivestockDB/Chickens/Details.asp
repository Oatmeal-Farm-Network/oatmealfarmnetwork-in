...
Response.AddHeader "Location","http://www.LivestockofAmerica.com/Alpacas/"
end if 

sql = "select People.PeopleID, animals.FullName, animals.speciesid, PaypalEmail from People, animals where People.PeopleID= animals.PeopleID and id = " & ID
...
metadescription = stripHTML(description)
else
metadescription = ""
end if
...
<meta property="og:url" content="<%=currenturl %>?ID=<%=ID %>&viewstud=<%=viewstud %>" />
<meta property="og:site_name" content="<%=WebSiteName %>" />
<meta property="og:image" content="<%=buttonimages(1) %>" />
