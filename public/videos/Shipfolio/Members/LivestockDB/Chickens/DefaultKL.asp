...
<% Description = "Find Breed information on  Kraienköppe (Twentse), Lakenvelder, Leghorn chickens."
Title = "Chicken Breeds That Start with K and L"
 %>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=13 and (left((trim(LOWER(breed))), 1) = 'k' or left((trim(LOWER(breed))), 1) = 'l'  ) Order by trim(Breed)"
