...
<% Description = "Find Breed information on Holland, Iowa Blue, Italian Naked-neck, Italian Polish, Ixworth, Java, Jersey Giant."
Title = "Chicken Breeds That Start with H, I, and J"
 %>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=13 and (left((trim(LOWER(breed))), 1) = 'h' or left((trim(LOWER(breed))), 1) = 'i' or left((trim(LOWER(breed))), 1) = 'j' ) Order by trim(Breed)"
