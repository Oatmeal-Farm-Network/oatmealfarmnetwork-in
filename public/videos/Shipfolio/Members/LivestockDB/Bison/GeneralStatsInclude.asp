...
&nbsp;<a href = "http://www.livestockoftheworld.com/<%=TempCurrentBreed %>/breeds.asp?BreedLookupID=<%=BreedID%>&SpeciesID=<%=SpeciesID  %>" class = "body" target="_blank" ><%=Currentbreed%></a>

<% if len(BreedID2) > 0 and not(BreedID = BreedID2) and BreedID2>0 then %>,<a href = "http://www.livestockoftheworld.com//<%=TempCurrentBreed %>/breeds.asp?BreedLookupID=<%=BreedID2%>&SpeciesID=<%=SpeciesID  %>" class = "body" target="_blank"><%=Currentbreed2%></a>
<% end if %>

<% if len(BreedID3) > 0  and not(BreedID = BreedID3) and BreedID3>0 then %>, <a href = "http://www.livestockoftheworld.com//<%=TempCurrentBreed %>/breeds.asp?BreedLookupID=<%=BreedID3%>&SpeciesID=<%=SpeciesID  %>" class = "body" target="_blank"><%=Currentbreed3%></a>
<% end if %>

<% if len(BreedID4) > 0  and not(BreedID = BreedID4) and BreedID4>0 then %>, <a href = "http://www.livestockoftheworld.com//<%=TempCurrentBreed %>/breeds.asp?BreedLookupID=<%=BreedID4%>&SpeciesID=<%=SpeciesID  %>" class = "body" target="_blank"><%=Currentbreed4%></a>
<% end if %> 
</td></tr>	
<% end if %>
<% end if %>
