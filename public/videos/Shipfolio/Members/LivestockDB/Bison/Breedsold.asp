...
<div class="container-fluid" id="grad1">
    <div align = center>
      ...
      <div>
      <div class = "body">
       <br /><h1><img src= "<%=BreedIcon %>" border = "0"  alt = "About <%= trim(Breed) %>&nbsp;<%=SpeciesNamePlural  %>" Height = "40"/>About <%= trim(Breed) %>&nbsp;<%=SpeciesNamePlural  %></h1>
      </div>
      </div>
    </div>
    </div>
...
<table border = "0" cellspacing="0" cellpadding = "0" align = "center" bgcolor = "white" width = "100%" height = 400>
    <tr>
        <td valign = top>
        <table border = "0" cellspacing="5" cellpadding = "5" align = "center"  width = "100%">
        <tr>
            <td class = "body" align = "left" valign = "top" width = "100%" height = "140" valign = top>
...
<table align = "<%=BreedImageOrientation %>" width = "600" style="margin-left:12px;margin-right:12px;"><tr><td><img src = "<%= BreedImage%>" alt = "<%=BreedImageCaption%>" width = "600"/></td></tr><tr><td class = "body"><%=BreedImageCaption %></td></tr></table><br /><br />
<% end if %>
<% if  len(trim(Breeddescription) ) > 12 then%>
<%= trim(Breeddescription) %>
<% else %>
Sorry, we do not have a description of <%= trim(Breed) %>&nbsp;<%=SpeciesNamePlural  %>. But if you have one that you would like to submit please <a href = "/contactus.asp">contact us </a>and let us know!
<% end if %>
<br />
<br />
