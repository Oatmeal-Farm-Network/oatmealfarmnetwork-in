...
<% Description = "How you feel when you sit in a field with alpacas or when you touch their incredibly soft fiber is what it's all about. We can't describe it; you just have to feel it. But we have shared here what we can."
Title = "About Alpacas & Alpaca Breeds"
image = "/Members/LivestockDB/Alpacas/aboutalpacasheader2.webp"
AboutLink = "AboutAlpacas.asp"
 %>
<Title><%=Title %></Title>
...
<div class="container ">
    ...
    <center><img src="<%=Image%>" alt="About <%=SpeciesNamePlural %>" width = 100% /></center>

  <p>
   <%=Description%>
  </p>
      <form method="post" action="AboutAlpacas.asp">
          <center><input type="submit" class="regsubmit2" value="Learn More&nbsp;" /><br><br></center>
      </form>
  <a name="Breeds"></a>
  <%
