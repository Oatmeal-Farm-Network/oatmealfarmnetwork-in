...
<% Description = "Ducks belong to the Anatidae family, which also includes geese and swans. They are found all over the world, in both freshwater and saltwater habitats, and are known for their distinctive quacking vocalization. Ducks are omnivores and feed on a variety of foods, including plants, insects, and small fish."
Title = "About Ducks"
image = "https://www.OatmealfarmNetwork.com/Ducks/Ducksheader.jpg"
 %>
<Title><%=Title %></Title>
...
<div class = "container">
  <div>
   <div class = "body">
 <center><img src = "/LivestockDB/Ducks/Ducksheader.jpg" width = 100% alt = "About Deer"/></center><br />
...
Ducks belong to the Anatidae family, which also includes geese and swans. They are found all over the world, in both freshwater and saltwater habitats, and are known for their distinctive quacking vocalization. Ducks are omnivores and feed on a variety of foods, including plants, insects, and small fish.
 <form  name=Login method="post" action="AboutDucks.asp" align = right><br />
