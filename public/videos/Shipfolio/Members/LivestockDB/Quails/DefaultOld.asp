...
<% Description = "Quails are raised as livestock for their meat and skin, which is used to make leather products such as shoes, handbags, and belts. Quail farms are common in the southern United States such as Louisiana, Florida, and Texas, where Quails are bred and raised in captivity."
Title = "About Quails & Quails Breeds"
image = "/livestockdb/Quails/QuailHeader.webp"
 %>
<Title><%=Title %></Title>
...
<div class="container-fluid" id="grad1">
    <div align = center>
      ...
      <div>
      <div class = "body">
       <h1><img src= "<%=BreedIcon %>" border = "0"  alt = "<%=SpeciesNamePlural  %>"  height = "40"/>About <%=signularanimal %></h1><br />
      </div>
      </div>
    </div>
    </div>
...
<div class = "container">
  <div>
   <div class = "body">
 <center><img src = "/LivestockDB/Quails/QuailHeader.jpg" width = 100% alt = "About Quail"/></center><br />
...
Quails are popular for their meat and eggs, which are considered a delicacy in many countries. Quail meat is tender, flavorful and low in fat, and the eggs are small, but packed with flavor and nutrients.
 ...
 <form  name=Login method="post" action="AboutQuails.asp" align = right><br />
