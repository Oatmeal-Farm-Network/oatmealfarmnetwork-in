...
<%AboutLink = "AboutGoats.asp"
Description = "The goat is one of the 12 Chinese zodiac animals. It represents introversion, creativity, shyness and being a perfectionist.  Goats were one of the first animals to be domesticated and have been used for their milk, meat, hair, and skins all over the world. There are over 100 distinct breeds of goat and there are more than 924 million live goats in the world.<br> "
Title = "About Goat Breeds"
image = "Goatheader.jpg"
letter = "x, y, and z"
 %>
