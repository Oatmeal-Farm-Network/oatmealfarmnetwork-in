...
<%
title= "Working Dogs breeds starting with P or Q" 
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1 and working = 1 and SpeciesID=3 and ( left((trim(LOWER(breed))), 1) = 'p' or left((trim(LOWER(breed))), 1) = 'q') Order by trim(Breed)"
