...
<%
title= "Working Dogs breeds starting with U,V,W,X,Y, or Z" 
...
<a name="Breeds"></a>
<h2>Breeds of <%=Pagename %> - UVWXYZ</h2>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1 and working = 1 and SpeciesID=3 and ( left((trim(LOWER(breed))), 1) = 'u' or left((trim(LOWER(breed))), 1) = 'v' or left((trim(LOWER(breed))), 1) = 'w' or left((trim(LOWER(breed))), 1) = 'x' or left((trim(LOWER(breed))), 1) = 'y' or left((trim(LOWER(breed))), 1) = 'z') Order by trim(Breed)"
