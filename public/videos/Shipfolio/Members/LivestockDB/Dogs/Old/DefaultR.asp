...
<%
title= "Working Dogs breeds starting with R" 
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1 and working = 1 and SpeciesID=3 and ( left((trim(LOWER(breed))), 1) = 'r') Order by trim(Breed)"
