...
<div class = "container">
  <div>
   <div class = "body">
     <center><img src = "Dogsheader.jpg" width = 100% alt = "About Dogs"/></center><br />
...
In ancient Egypt, dogs were entrusted with vital roles in hunting, herding, and safeguarding. Hellenic and Roman civilizations followed suit, employing these noble creatures in a myriad of tasks, from guarding livestock and property to waging war.
 <form  name=Login method="post" action="AboutDogs.asp" align = right><br />
<input type="submit" class = "regsubmit2" value="READ MORE"  >
</form>
<br />
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1 and working = 1 and SpeciesID=3 and left((trim(LOWER(breed))), 1) = 'a' Order by trim(Breed)"
