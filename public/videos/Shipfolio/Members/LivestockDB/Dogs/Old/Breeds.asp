...
<script type="application/ld+json">
{
  ...
  "mainEntity": "https://www.LivestockOfTheWorld.com"  ]  }
</script>
...
<div class="container-fluid" id="grad1">
    <div align = center>
      ...
      <div>
      <div class = "body">
       <h1><img src= "<%=BreedIcon %>" border = "0"  alt = "About <%= trim(Breed) %>&nbsp;<%=SpeciesNamePlural  %>"  height = "40"/>About <%= trim(Breed) %>&nbsp;<%=SpeciesNamePlural  %></h1>
      </div>
      </div>
    </div>
    </div>
...
<tr><td><img src = "<%= BreedImage%>" alt = "<%=BreedImageCaption%>" width = "450"/></td></tr><tr><td class = "body"><%=BreedImageCaption %></td></tr></table><br /><br />
<% end if %>
