...
<%
title= "Working Dogs breeds starting with N" 
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1 and working = 1 and SpeciesID=3 and left((trim(LOWER(breed))), 1) = 'n' Order by trim(Breed)"
