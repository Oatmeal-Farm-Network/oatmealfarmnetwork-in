...
<%
title= "Working Dogs breeds starting with F" 
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1 and working = 1 and SpeciesID=3 and left((trim(LOWER(breed))), 1) = 'f' Order by trim(Breed)"
