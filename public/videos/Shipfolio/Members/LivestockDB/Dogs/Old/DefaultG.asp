...
<%
title= "Working Dogs breeds starting with G" 
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1 and working = 1 and SpeciesID=3 and left((trim(LOWER(breed))), 1) = 'g' Order by trim(Breed)"
