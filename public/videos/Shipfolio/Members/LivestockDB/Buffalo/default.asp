...
<% Description = "The term buffalo is used to refer to several different species of bovine animals, including the African buffalo and water Buffalo. Sometimes the term is used incorrectly to refer American  Bison, Bison are not a type of Buffalo. In most cases demesticated Buffalo are Water Buffalo.<br /><br>Water Buffalo (also known as Asian buffalo, or domestic Asian water buffalo) are a large domestic bovid that is native to Southeast Asia. They are one of the largest domestic animals, with adult males weighing between 800-1,200 kilograms (1,765-2,646 pounds) and adult females weighing between 500-800 kilograms (1,102-1,764 pounds).<br>"
Title = "Buffalo Breeds"
image = "Buffaloheader.jpg"
AboutLink = "AboutBuffalo.asp"
...
<div class="container ">
    ...
    <p>
     <%=Description%>
        ...
        <form method="post" action="AboutBison.asp">
            <center><input type="submit" class="regsubmit2" value="Learn More&nbsp;" /></center><br>
        </form>
  <a name="Breeds"></a>
  <%
  Set rs2 = Server.CreateObject("ADODB.Recordset")
