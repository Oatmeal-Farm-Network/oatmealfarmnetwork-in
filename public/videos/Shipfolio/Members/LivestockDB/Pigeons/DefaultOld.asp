...
<% Description = "Pigeons are raised as livestock for their meat and for their use in racing and performance events. Pigeon meat is considered a delicacy in some parts of the world, and is used in a variety of dishes. Pigeon racing is a popular sport in many countries, including the United States, the United Kingdom, and Australia."
Title = "About Pigeons & Pigeon Breeds"
image = "https://www.OatmealFarmNetwork.com/Pigeons/Pigeonheader.jpg"
 %>
<Title><%=Title %></Title>
...
<div class = "container">
  <div>
   <div class = "body">
 <center><img src = "Pigeonheader.jpg" width = 100% alt = "About Pigeons"/></center><br />
 ...
 <form  name=Login method="post" action="AboutPigeons.asp" align = right><br />
