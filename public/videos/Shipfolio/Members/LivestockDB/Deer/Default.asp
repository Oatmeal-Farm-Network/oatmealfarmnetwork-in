...
<% Description = "Deer are raised as livestock for their meat and skin, which is used to make leather products such as shoes, handbags, and belts. Alligator farms are common in the southern United States such as Louisiana, Florida, and Texas, where Deer are bred and raised in captivity."
image = "Deerheader.jpg"
Title = "Deer Breeds"
AboutLink = "AboutDeer.asp"
 %>
<Title><%=Title %></Title>
...
<div class="container intro-section ">
  ...
  <div class="learn-more-button-container">
      <form method="post" action="<%=AboutLink%>">
          <input type="submit" class="regsubmit2" value="Learn More&nbsp;" /><br><br>
      </form>
  </div>
