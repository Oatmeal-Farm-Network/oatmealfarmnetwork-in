...
<a name="Breeds"></a>
<h2>Breeds of <%=Pagename %> - T,U,V</h2>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=8 and ( left((trim(LOWER(breed))), 1) = 't' or left((trim(LOWER(breed))), 1) = 'u' or left((trim(LOWER(breed))), 1) = 'v'  ) Order by trim(Breed)"
