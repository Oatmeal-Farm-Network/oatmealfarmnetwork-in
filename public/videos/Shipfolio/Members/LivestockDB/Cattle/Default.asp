...
<div class="container">
  ...
  <%
  Set rs2 = Server.CreateObject("ADODB.Recordset")
  sql2 = "select top 44 Breed, BreedLookupID, BreedDescription, BreedImage, BreedVideo, BreedImageOrientation, BreedImageCaption from SpeciesBreedLookupTable where left((trim(LOWER(breed))), 1) = '" & Letter & "' and SpeciesID=" & speciesID & " Order by trim(Breed)"
  rs2.Open sql2, conn, 3, 3
