...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=8 and ( left((trim(LOWER(breed))), 1) = 'c' ) Order by trim(Breed)"
