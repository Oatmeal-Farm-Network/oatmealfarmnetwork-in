...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "<%=Title %> &nbsp;<%=SpeciesNamePlural  %>",
...
%>
 ...
 <div class = "container" >
      <div>
      <div class = "body">
         <img src = "Cattleheader.jpg" width = "100%" alt = "About Cattle"/><br />
...
<a href = "DefaultORQ.asp" class = Body>ORQ</a> |
...
<a href = "DefaultTUV.asp" class = Body>TUV</a> |
<a href = "DefaultXYZ.asp" class = Body>WXYZ</a>
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=8 and ( left((trim(LOWER(breed))), 1) = 'a' ) Order by trim(Breed)"
