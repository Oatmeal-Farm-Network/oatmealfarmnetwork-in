...
<a href = "DefaultORQ.asp" class = Body>O, R, Q</a>|
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=8 and ( left((trim(LOWER(breed))), 1) = 'b' ) Order by trim(Breed)"
