...
<table align = "<%=BreedImageOrientation %>" width = "450" style="margin-left:12px;margin-right:12px;"><tr><td><img src = "<%= BreedImage%>" alt = "<%=BreedImageCaption%>" width = "450"/></td></tr><tr><td class = "body"><%=BreedImageCaption %></td></tr></table><br /><br />
<% end if %>
