...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=" & SpeciesID & " and left((trim(LOWER(breed))), 1) = '" & lcase(trim(Letter)) & "' Order by trim(Breed)"
...
<tr><td bgcolor = "#F0BC42" height = 40><h3><img src = "https://www.livestockoftheworld.com/images/px.gif" alt ="About <%=Breed2  %> <%=SpeciesNamePlural %>" width = 3 height = 30 /><%=Breed2  %></h3></td></tr>
<tr><td bgcolor = '#888888' height = 1></td></tr>
