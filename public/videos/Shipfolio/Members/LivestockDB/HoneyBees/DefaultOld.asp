...
<% Description = "Lern about Italian, Caucasian, Carniolan, Cordovan, German, Russian, Buckfast, Minnesota Hygienic, Africanized, and Western Honey Bees." 
Image = "/HoneyBees/honeybeeheader.jpg"
%>

<Title>Honey Bee Species | Honey Bees</Title>
<meta name="title" content="Honey Bee Breeds | Honey Bees" />
<meta property="og:title" content="Honey Bee Breeds | Honey Bees" />
...
<div class="container-fluid" id="grad1">
    <div align = center>
      ...
      <div>
      <div class = "body" >
      <h1><img src= "<%=BreedIcon %>" border = "0"  alt = "About <%= trim(Breed) %>&nbsp;<%=SpeciesNamePlural  %>" height = "40" />Honey Bees<br /><br /></h1>
      </div>
      </div>
        <div>
      </div>
...
<div class = "container">
  <div>
   <div class = "body">
     ...
     <center><img src = "Honeyheader2.jpg" width = 100% alt = "About Honey Bees"/></center><br />
