...
image = "https://www.OatmealFarmNetwork.com/Pigs/Pigheader.jpg"
 %>
<Title><%=Title %></Title>
...
<div class="container-fluid" id="grad1">
    <div align = center>
      ...
      <div>
      <div class = "body">
       <h1><img src= "<%=BreedIcon %>" border = "0"  alt = "<%=SpeciesNamePlural  %>"  height = "40"/>About <%=signularanimal %>s</h1><br />
      </div>
      </div>
    </div>
    </div>
...
Pigs are omnivores and are intelligent animals. With around 1 billion individuals alive at any time, the domesticated pig is one of the most numerous large mammals on the planet. The meat of pigs is widely eaten by people across the world. 
 ...
 <form  name=Login method="post" action="AboutPigs.asp" align = right><br />
