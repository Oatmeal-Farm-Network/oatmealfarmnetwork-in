...
<% Title = "Horse Breeds that Start with X, Y, or Z"
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=5 and ( left((trim(LOWER(breed))), 1) = 'x' or left((trim(LOWER(breed))), 1) = 'y' or left((trim(LOWER(breed))), 1) = 'z' ) Order by trim(Breed)"
