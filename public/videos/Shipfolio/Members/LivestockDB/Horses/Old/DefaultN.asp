...
<% Title = "Horse Breeds that Start with N"
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=5 and left((trim(LOWER(breed))), 1) = 'n' Order by trim(Breed)"
