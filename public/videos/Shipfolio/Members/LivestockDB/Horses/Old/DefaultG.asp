...
<% Title = "Horse Breeds that Start with G"
...
sql2 = "select * from SpeciesBreedLookupTable where breedavailable = 1  and SpeciesID=5 and left((trim(LOWER(breed))), 1) = 'g' Order by trim(Breed)"
