...
Query =  " UPDATE sfproducts Set prodCategoryId = " &  SourceCategory1ID   & " ,"
...
ConnLOA.Execute(Query) 
	...
	Query =  Query & " productImage2 = '" &  SourceProductImage2   & "' ,"
	Query =  Query & " productImage3 = '" &  SourceProductImage3   & "' ,"
	Query =  Query & " productImage4 = '" &  SourceProductImage4   & "' ,"
	Query =  Query & " productImage5 = '" &  SourceProductImage5   & "' ,"
	Query =  Query & " productImage6 = '" &  SourceProductImage6   & "' ,"
	Query =  Query & " productImage7 = '" &  SourceProductImage7   & "' ,"
	Query =  Query & " productImage8 = '" &  SourceProductImage8  & "' "
