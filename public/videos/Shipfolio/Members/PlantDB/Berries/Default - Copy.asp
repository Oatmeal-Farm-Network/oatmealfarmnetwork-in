...
<div class="container-fluid " align="center" style="max-width: 1400px; min-height: 67px;">
  <div class="row">
    <div class="col body text-left">
      <img src="VegetablesHeading.webp" width="100%" alt="Delicious <%=Planttype%>" />
      <br /> <br />
    ...
    %>
        <div class="col-lg-4 col-md-6 col-sm-12 body text-left">
          <div class="flex items-center">
            ...
            <a href="/PlantDB/<%=DirectoryName%>/Varietals.asp?PlantID=<%=plantID %>" >
                      <center><img src='<%=PlantImage%>' alt="<%=plantName %>" width = 200px /></center>
            </a>
            <div style="margin-left: 1rem;">
              <a href="/PlantDB/<%=DirectoryName%>/Varietals.asp?PlantID=<%=plantID %>" class="body"><%=plantName %> (<%=varietyCount %>&nbsp;<%=Varietyterm%>)</a><br />
              <%=PlantDescription %>
            </div>
          </div>
          <br /><br />
