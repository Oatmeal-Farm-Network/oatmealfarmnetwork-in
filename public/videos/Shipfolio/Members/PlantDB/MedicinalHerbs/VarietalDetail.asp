...
<style>
.container-fluid,.container{width:100%;margin-left:auto;margin-right:auto;}
.container-fluid{padding-left:1rem;padding-right:1rem;}
.container{max-width:1400px;}

p{margin-bottom:1rem;color:#374151;line-height:1.6;}
.row{display:flex;flex-wrap:wrap;margin-left:-0.75rem;margin-right:-0.75rem;}
.col-12,.col-md-6,.col-lg-4{padding-left:0.75rem;padding-right:0.75rem;box-sizing:border-box;margin-bottom:1.5rem;}
@media (min-width:768px){.col-md-6{width:50%;}}
@media (min-width:992px){.col-lg-4{width:33.333%;}}
.text-left{text-align:left;}
.text-center{text-align:center;}
a.body{color:#3b82f6;text-decoration:none;font-weight:bold;}
a.body:hover{text-decoration:underline;}
.detail-section{background-color:#fff;border:1px solid #e5e7eb;border-radius:0.5rem;padding:1.5rem;box-shadow:0 1px 3px 0 rgba(0,0,0,0.1),0 1px 2px 0 rgba(0,0,0,0.06);margin-bottom:1.5rem;}
.detail-list{list-style:none;padding:0;margin:0;}
.detail-list li,.nutrient-item{margin-bottom:0.5rem;color:#374151;font-size:0.95rem;}
.detail-list li strong,.nutrient-item strong{color:#1f2937;margin-right:0.5rem;}
.nutrient-list{list-style:disc;padding-left:1.5rem;margin-top:0.5rem;}
.nutrient-description{font-size:0.85rem;color:#6b7280;margin-left:1.5rem;display:block;}
.varietal-image{max-width:100%;height:auto;border-radius:0.5rem;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1),0 2px 4px -1px rgba(0,0,0,0.06);margin-bottom:1.5rem;}
.flex{display:flex;}
...
/* Consolidated varietal-image rules */
.varietal-image{width:12rem;height:12rem;object-fit:cover;border-radius:0.5rem;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1),0 2px 4px -1px rgba(0,0,0,0.06);}
...
@media (min-width:768px){
    ...
    .varietal-image{width:16rem;height:16rem;} /* Overrides base .varietal-image styles */
