...
<%Planttype = "Edible Grass" 
DirectoryName = "Grasses"
PlantTypeID = 14
...
<div class="container-fluid d-none d-lg-block" align="center" style="max-width: 1400px; min-height: 67px;">
    <div class="row">
        <div class="col body text-left">
            <img src="GrassesHeader.webp" width="100%" alt="Delicious <%=Planttype%>" />
            <br /> <br />
        ...
        %>
                <div class="col-lg-4 col-md-6 col-sm-12 body text-left">
                    <div class="flex items-center">
                        <a href="/Members/PlantDB/" & DirectoryName & "/Varietals.asp?PlantID=<%=plantID %>" class="body image-container">
                                            <img src='<%=PlantImage%>' alt="<%=plantName %>" />
                        </a>
                        <div style="margin-left: 1rem;">
                            <a href="/Members/PlantDB/<%=DirectoryName%>/Varietals.asp?PlantID=<%=plantID %>" class="body"><%=plantName %> (<%=varietyCount %> Varieties)</a><br />
                            <%=PlantDescription %>
                        </div>
                    </div>
                    <br /><br />
    ...
    <div class="row">
        ...
        %>
                <div class="col-sm-6 col-12 body text-left">
                    <div class="flex items-center">
                        <a href="/Members/PlantDB/Bulbs/Varietals.asp?PlantID=<%=plantID_sm %>" class="body image-container" style="width: 100px; height: 100px;">
                        ...
                        <div style="margin-left: 0.5rem;">
                            <a href="/Members/PlantDB/Bulbs/Varietals.asp?PlantID=<%=plantID_sm %>" class="body"><%=plantName_sm %> (<%=varietyCount_sm %> Varieties)</a><br />
