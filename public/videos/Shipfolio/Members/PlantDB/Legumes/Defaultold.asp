...
sql = "SELECT P.PlantID, P.PlantName, P.PlantDescription, GrownForFood, COUNT(PV.PlantVarietyID) AS VarietyCount " & _
      "FROM Plant P " & _
      "LEFT JOIN PlantVariety PV ON P.PlantID = PV.PlantID " & _
      "WHERE P.PlantTypeID = " & PlantTypeID & " and GrownForFood = 'True'" & _
      "GROUP BY P.PlantID, P.PlantName, P.PlantDescription, GrownForFood " & _
...
<div class="container-fluid d-none d-lg-block" align="center" style="max-width: 1400px; min-height: 67px;">
    <div class="row">
        <div class="col body text-left">
            <img src="https://placehold.co/1200x200/FFC107/FFFFFF?text=Delicious+<%=Directoryname%>" width="100%" alt="Delicious <%=Planttype%>" />
            <br /> <br />
