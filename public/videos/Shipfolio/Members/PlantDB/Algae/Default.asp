    ...
    <div class="row">
        ...
        %>
                <div class="col-sm-6 col-12 body text-left">
                    <div class="flex items-center">
                        <a href="Varietals.asp?PlantID=<%=plantID_sm %>" class="body image-container" style="width: 100px; height: 100px;">
                        ...
                        <div style="margin-left: 0.5rem;">
                            <a href="Varietals.asp?PlantID=<%=plantID_sm %>" class="body"><%=plantName_sm %> (<%=varietyCount_sm %> Varieties)</a><br />
