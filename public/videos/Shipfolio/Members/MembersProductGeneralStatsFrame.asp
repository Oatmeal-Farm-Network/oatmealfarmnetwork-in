...
prodCategory1ID = prodCategory1ID
end if
...
prodCategory3ID = prodCategory3ID
end if
...
<font color=red><b>*</font> Product Name</b>&nbsp;<br>
<input name="ProdName" value="<%=ProdName %>" class = "formbox" style="width: 400px; text-align: left">
<br />
...
<input name="SKU" value="<%=SKU %>"  class = "formbox" style="width: 400px; text-align: left"><br>

<b>Quantity</b><br>
<input name="ProdQuantityAvailable" value="<%=ProdQuantityAvailable %>" type="number" class = "formbox" style="width: 400px; text-align: left" />

<br /><b><font color=red>*</font>!Categories</b><br />

<iframe src="membersAddProductCategoriesInclude.asp?prodCategory1ID=<%=prodCategory1ID %>&prodCategory2ID=<%=prodCategory2ID %>&prodCategory3ID=<%=prodCategory3ID %>&prodSubCategory1ID=<%=prodSubCategory1ID %>&prodSubCategory2ID=<%=prodSubCategory2ID %>&prodSubCategory3ID=<%=prodSubCategory3ID %>" height = '250' width = '640'  frameborder= '0' seamless = Yes scrolling = no></iframe>

<% LivestockAvailable = True
if LivestockAvailable = True then 
%>

<% sql2 = "select distinct Animals.ID, Animals.FullName from Animals where peopleid = " & PeopleID & " order by Fullname"
acounter = 1
...
<br>
<b>Made In</b><br>
 <select name="ProdMadeIn" value="<%=ProdMadeIn%>"  class = "formbox" style="width: 400px; text-align: left">
...
<select  name="ProdAnimalID" class = "formbox" style="width: 400px; text-align: left">
<% 
if len(ProdAnimalID) > 0 then %>
...
<tr>
<td class = body valign = top><h3>Materials or Ingredients!</h3>
...
<tr>
    <td class = "body" align = "center" width = "260" height = 15><b>Materiel</b></td>
    <td class = "body" align = "center" width = 140><b>Percent</b></td>
</tr>
<tr>
    <td class = "body" ><input type=text name='ProdFiberType1' size=40 maxlength=60 value="<%=ProdFiberType1 %>" class = "formbox" style="width: 260px; text-align: left"></td>
    <td ><input type=number name='prodFiberPercent1' size=2 maxlength=4 value="<%=prodFiberPercent1 %>" class = "formbox" style="width: 40px">%</td>
</tr>
<tr>
    <td class = "body"><input type=text name='ProdFiberType2' size=40 maxlength=60 value="<%=ProdFiberType2 %>" class = "formbox" style="width: 260px; text-align: left"></td>
    <td><input type=number name='prodFiberPercent2' size=2 maxlength=4 value="<%=prodFiberPercent2 %>" class = "formbox" style="width: 40px">%</td>
</tr>
<tr>
    <td class = "body"><input type=text name='ProdFiberType3' size=40 maxlength=60 value="<%=ProdFiberType3 %>" class = "formbox" style="width: 260px; text-align: left"></td>
    <td><input type=number name='prodFiberPercent3' size=2 maxlength=4 value="<%=prodFiberPercent3 %>" class = "formbox" style="width: 40px">%</td>
</tr>
<tr>
    <td class = "body"><input type=text name='ProdFiberType4' size=40 maxlength=60 value="<%=ProdFiberType4 %>" class = "formbox" style="width: 260px; text-align: left"></td>
    <td><input type=number name='prodFiberPercent4' size=2 maxlength=4 value="<%=prodFiberPercent4 %>" class = "formbox" style="width: 40px">%</td>
</tr>
<tr>
    <td class = "body"><input type=text name='ProdFiberType5' size=40 maxlength=60 value="<%=ProdFiberType5 %>" class = "formbox" style="width: 260px; text-align: left"></td>
    <td><input type=number name='prodFiberPercent5' size=2 maxlength=4 value="<%=prodFiberPercent5 %>" class = "formbox" style="width: 40px">%</td>
</tr>
<tr>
    <td class = "body" colspan = 2><i><font color = "#404040">List the different materials used in the creation of your product and the percent composition if appropriate (i.e. a silk and wool sweater may be 67% wool and 33% silk.)</font></i><br />
    </td>
</tr>
</table>
  </td>
...
<tr><td colapsn = 2>
     ...
     <div align = "center"><input type=submit name= "button1" value = "SUBMIT" class = "regsubmit2"  <%=Disablebutton %> ></div>
</td></tr>
</table>
