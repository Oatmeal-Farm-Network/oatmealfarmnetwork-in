...
'NumberofAnimals = cint(NumberofAnimals)
...
if len(tempSpeciesID) >0 and len(category) > 0 then 
...
if len(PriceComments) > 1 then
tempPriceComments=session("PriceComments") 
PriceComments=tempPriceComments
end if

if len(tempDescription) > 1 then
tempDescription=session("Description") 
...
%>
    ...
    <div class="row">
        <div class="col-sm-12">
            <H1>Add a New Animal Listing</H1><a name="Top"></a>
        </div>
</div>
  <div class="row">
        <div class="col-sm-12">
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 width = "100%"  align = "left">
<tr><td class = "body">
<h2><font color = "brown">Step 1: Short Form</font></h2>
...
if Duplicate then %>
<div align = "left"><br /><b><h2><font color = "maroon" size = 4>You already have an animal entered with that Name / Title. Please enter another Name / Title!</font></h2></b></div><br />
<% end if %>
<% MissingName=Request.QueryString("MissingName")
if MissingName then %>
<div align = "left">&nbsp;<b><font color = "maroon" size = 4>Please enter a Name / Title for your listing! </font></b></div><br />
<% end if %>
<% MissingCategory=Request.QueryString("MissingCategory")
if MissingCategory then %>
<div align = "left">&nbsp;<b><font color = "maroon" size = 4>Please select a category!</font></b></div><br />
<% end if %>
<% MissingBreed=Request.QueryString("MissingBreed")
if  MissingBreed then %>
<div align = "left">&nbsp;<b><font color = "maroon" size = 4>Please Select a breed!</font></b></div><br />
<% end if %>
</td></tr>
</table>
...
<% if MissingName then %>
<br />
<b>Name / Title *</b><span class="custom info"><b>Name /Title</b>This can be a full name like <i>XYZ Ranches Peruvian MagaStud</i> or a title like <i>Registered Brown Boar</i></span><b></b>
<% else %>
<b>Name /Title *</b><span class="custom info"><b>Name /Title</b>This can be a full name like <i>XYZ Ranches Peruvian MagaStud</i> or a title like <i>Registered Brown Boar</i></span><b></b>
<% end if %>
<% 
...
If category = "Non-Breeder" then showncategory = "Non-Breeder"
...
<option value="Preborn Male">Preborn Male Chick</option>
<option value="Preborn Female">Preborn Female Chick</option>
</select>
<% else
...
If category = "Non-Breeder" or category = "Non-Breeders" then showncategory = "Non-Breeders"
...
<option value="Preborn Males">Preborn Male Chicks</option>
<option value="Preborn Females">Preborn Female Chicks</option>
</select>
...
<option value="Experienced Male">Experienced Male <small>(Proven/Tested Fertility)</small></option>
<option value="Inexperienced Male ">Inexperienced Male <small>(Untested Fertility)</small></option>
<option value="Experienced Female">Experienced Female <small>(Proven/Tested Fertility)</small></option>
<option value="Inexperienced Female">Inexperienced Female <small>(Untested Fertility)</small></option>
<option value="Non-Breeder">Non Breeding Animal</option>
<option value="Preborn Male">Preborn Male</option>
<option value="Preborn Female">Preborn Female</option>
<option value="Preborn Baby">Preborn Baby (Either Gender)</option>
</select>
<% else 

if category = "Experienced Male" then category = "Experienced Males"
if category = "Experienced Female" then category = "Experienced Females"
if category = "Inexperienced Male" then category = "Inexperienced Males"
if category = "Inexperienced Female" then category = "Experienced Females"
if category = "Preborn Male" then category = "Preborn Males"
if category = "Preborn Female" then category = "Preborn Females"
if category = "Preborn Baby" then category = "Preborn Babies"


%>
<select size="1" name="Category" class = 'formbox' width="330" style="width: 330px">
<option value= "<%=Category%>" selected><%=Category%></option>
<option value="Experienced Males">Experienced Males <small>(Proven/Tested Fertility)</small></option>
<option value="Inexperienced Males">Inexperienced Males <small>(Untested Fertility)</small></option>
<option value="Experienced Females">Experienced Females<small>(Proven/Tested Fertility)</small></option>
<option value="Inexperienced Females">Inexperienced Females <small>(Untested Fertility)</small></option>
<option value="Assortment">Assortment <small>(Variety of Genders and/or Fertility )</small></option>
<option value="Non-Breeders">Non Breeding Animals</option>
<option value="Preborn Males">Preborn Males</option>
<option value="Preborn Females">Preborn Females</option>
<option value="Preborn Babies">Preborn Babies (Either gender)</option>
</select>
<% end if %>
...
<% else %>
<tr>
<% if NumberofAnimals = "1" and SpeciesSalesType="Individual" then %>
...
<% if SpeciesSalesType = "Fowl" or speciesID = 19 then 
else %>
<tr><td align = left>
...
<% if numberofanimals = 1 then
tempSpeciesID =SpeciesId
'response.write("tempSpeciesID=" & tempSpeciesID )
if len(tempSpeciesID) >0 then %>
...
if len(tempSpeciesID) > 0 then 
 sql2 = "select * from SpeciesRegistrationTypeLookupTable where SpeciesID=" & tempSpeciesID & " order by SpeciesRegistrationType"
Set rs2 = Server.CreateObject("ADODB.Recordset")
rs2.Open sql2, conn, 3, 3
while not(rs2.eof)  
RegNumber = ""
...
<% End if %>
<% if SpeciesSalesType="Fowl" and (category = "Preborn Baby" or category = "Preborn Babies" or category = "Preborn Males" or category = "Preborn Males" or category = "Preborn Male Chicks" or category = "Preborn Females" or category = "Preborn Female") then %>
<% if SpeciesSalesType="Fowl" and (category = "Preborn Baby" or category = "Preborn Babies") then %>
<tr>
	<td class = "body" height = "30" align = "left">
      <b>Fertized Egg Price</b><br>
            <% tempPrice4 = Price4
            if Price4 = "0" then
            tempPrice4  = "" 
            end if %>
		$<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='price4' size=10 maxlength=10 Value= "<%= tempPrice4%>">
		</td>
	</tr>
        <tr>
			<td class = "body" height = "30" align = "left">
		...
		&nbsp;&nbsp;<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='MinOrder4' size=10 maxlength=10 Value= "<%= tempMinOrder4%>"><br />
		</td>
	</tr>
        <tr>
			<td class = "body" height = "30" align = "left">
		...
		&nbsp;&nbsp;<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='MaxOrder4' size=10 maxlength=10 Value= "<%= tempMaxOrder4%>"><br /><br>
		</td>
	</tr>
<% end if %>

<% if category = "Preborn Baby" or category = "Preborn Babies" or category = "Preborn Males" or category = "Preborn Males" or category = "Preborn Male Chicks" or category = "Preborn Females" or category = "Preborn Female" then %>
<tr>
	<td class = "body" height = "30" align = "left">
    <br />
            <b>
		...
		$<input class = 'formbox' type=text onKeypress="return checkInput(event);"	name='Price' size=10 maxlength=10 Value= "<%= tempPrice%>"><font color="#404040">
		</td>
	</tr>
    <tr>
		<td class = "body" align = "left">
		...
		&nbsp;&nbsp;<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='MinOrder1' size=10 maxlength=10 Value= "<%= tempMinOrder1%>"><br />
		</td>
	</tr>
    <tr>
			<td class = "body" height = "30" align = "left">
		...
		&nbsp;&nbsp;<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='MaxOrder1' size=10 maxlength=10 Value= "<%= tempMaxOrder1%>"><br /><br>
		</td>
	</tr>
<% end if %>
<% if category = "Preborn Females" or category = "Preborn Female" then %>
...
<tr>
	<td class = "body" height = "30" align = "left">
      <b>Female Price</b><br>
		...
		$<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='price2' size=10 maxlength=10 Value= "<%= tempPrice2%>">
		</td>
	</tr>
        <tr>
			<td class = "body" height = "30" align = "left">
		...
		&nbsp;&nbsp;<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='MinOrder2' size=10 maxlength=10 Value= "<%= tempMinOrder2%>"><br />
		</td>
	</tr>
        <tr>
			<td class = "body" height = "30" align = "left">
		...
		&nbsp;&nbsp;<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='MaxOrder2' size=10 maxlength=10 Value= "<%= tempMaxOrder2%>"><br /><br>
		</td>
	</tr>
<% end if %>
<% if category = "Preborn Males" or category = "Preborn Males" then %>
    <tr>
	<td class = "body" height = "30" align = "left">
      <b>Male Price</b><br>
            <% tempPrice3 = Price3
		...
		$<input class = 'formbox' type=text onKeypress="return checkInput(event);"	name='Price3' size=10 maxlength=10 Value= "<%= tempPrice3%>">
		</td>
	</tr>
    <tr>
	<td class = "body" height = "30" align = "left">
       <b>Min Order</b><br>
		...
		&nbsp;&nbsp;<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='MinOrder3' size=10 maxlength=10 Value= "<%= tempMinOrder3%>"><br />
		</td>
	</tr>
        <tr>
			<td class = "body" height = "30" align = "left">
		...
		&nbsp;&nbsp;<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='MaxOrder3' size=10 maxlength=10 Value= "<%= tempMaxOrder3%>"><br /><br>
		</td>
	</tr>

   <tr>
   <td class = Body>
    <b><font color = #404040>Note: You will be able to add shipping information on the next page.</font></b>
   </td>
   </tr>
<% end if %>
<% else %>
		...
		$<input class = 'formbox' type=text onKeypress="return checkInput(event);" name='price' size=10 maxlength=10 Value= "<%= tempPrice%>"><br /><font color="grey">Must be a number.</font>
		</td>
	</tr>
    <tr>
		<td class = "body" ><b>% Discount:</b>&nbsp;
	...
	<tr>
		<td class = "body" ><b>Discount Price:</b>&nbsp;
...
<% end if %>
<% If (trim(category) = "Experienced Female" Or trim(category) = "Inexperienced female") and (not SpeciesSalesType = "Fowl") Then %>
<tr >
		<td class = "body" height = "30">
		<a class="tooltip" href="#"><b>Embryos For Sale?</b><span class="custom info" align = "left"><em>Embryos For Sale?</em>Are you offering for sale embryos donated by this animal?</span></a>
...
$<input type=text onKeypress="return checkInput(event);" name="EmbryoPrice" size=5 maxlength=5 Value= "<%= EmbryoPrice%>"> per embyo.
				</td>
		</tr>
<% end if

 If (trim(category) = "Experienced Male" Or trim(category) = "Inexperienced Male") and (not SpeciesSalesType = "Fowl") Then 
		...
		<tr>
				<td class = "body" height = "30" align = "left"><b>Stud Fee</b>
					$<input type=text onKeypress="return checkInput(event);" name='StudFee' size=10 maxlength=10 Value= "<%= StudFee%>">
				</td>
		</tr>
		<tr >
				<td class = "body" height = "30" align = "left">
		...
		<br><br>
         ...
         <tr >
		<td class = "body" height = "30">
		<a class="tooltip" href="#"><b>Semen For Sale?</b><span class="custom info"><em>Semen For Sale?</em>Are you offering for sale semen donated by this animal?</span></a>
...
$<input type=text onKeypress="return checkInput(event);" name="SemenPrice" size=3 maxlength=6 Value= "<%= SemenPrice%>"> per straw.
				</td>
		</tr>
...
<% else %>
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=5 cellspacing=5 bordercolor = #000000 width = "<%=screenwidth-32 %>"  align = "left">
<tr><td class = "body" align = "left">
...
A listing can be for a single animal or for a group of animals.<br /><br />
<font color = "#993333"><b><center>Required Fields are Indicated in Red.</center></b></font>
</td></tr>
<tr><td valign = "top"><br>
<form  name=form method="post" action="MembersAnimalAdd1.asp?wizard=True&PeopleID=<%=PeopleID %>">
<table align= 'center'>
<tr><td class = "body">
<font color = "#993333"><b>Number of Animals in Listing</b></font> <br />
<div align = "right"><font color = "#404040">(If selling eggs leave number as ''1'')</div></font>
</td>
<td class = "body">
...
<tr>
<td class = "body">
<b><font color = "#993333">Category</font></b>
</td>
<td>
...
<tr><td class = "body" valign = "top"><b><font color = "#993333">What Species is the Animal?</font></b><br />
...
<select size="16" name="SpeciesID" class = "formbox" style="width: 320px;" >
<% if len(SpeciesID) > 0 then 
Preferedspecies = "" %>
<option value= "<%=SpeciesID %>" selected><%=AnimalType %></option>
<% end if %>
...
if SpeciesID = Preferedspecies then %>
<option  value= "<%=Preferedspecies%>" selected><%=Preferedspeciesname%></option>
<% else %>
<option  value= "<%=SpeciesID%>" ><%=species%></option>
<% end if %>
<% rs.movenext
wend
rs.close
...
<br /><br />
<div class = "formbox">
<h3><b><center>When to List <br />Individual Animals or Groups</center></b></h3>
<br />
If you have a lot of information to share on individual animals then we recommend that you list them individually. Also we highly recommend that you enter separate listings per breed. Buyers are more likely to respond if a listing has the information they are looking for (i.e. someone looking for an angora goat most likely will not take the time to review a listing with 12 Holstein cattle, 2 Nubian goats, 2 Huacaya alpacas, and 1 angora goat.) <br /><br />
</div>
<br />
<div class = "formbox">
<h3><b><center>Listing Eggs</center></b></h3>
<br />
If you have fertilized eggs (chicks) for sale then use this page to list them for sale. However, if you have unfertilized eggs for sale – for eating, crafts, etc.  – then <a href="MembersClassifiedAdPlace.asp?screenwidth=<%=screenwidth %>" class = "body">list them as a product for sale</a>. <br /><br />
</div>
