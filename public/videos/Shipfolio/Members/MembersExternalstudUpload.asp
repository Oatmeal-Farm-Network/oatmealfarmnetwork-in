...
' of a directory with write permissions, for example "C:\Inetpub\wwwroot"
  Dim uploadsDirVar
  UploadPath = "https://www.livestockoftheworld.com/Uploads/"
...
Query =  " UPDATE Femaledata Set ExternalStudPhoto= '" &  Filename & "' " 
...
response.redirect("MembersFemaleDataFrame.asp?ID=" & ID & "&changesmade=True")
%>
</BODY>
</HTML>
