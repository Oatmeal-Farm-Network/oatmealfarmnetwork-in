    ...
    <div class = "col body roundedtopandbottom" valign = "top" width = 200>
            ...
            <div class = "row">
              <div class = "col" align= "left">
                <% action = "SearchResultsPage.asp?businessTypeID=" & BusinessTypeID  %>
                  <form method="POST" action="<%=action%>" class = body>
     ...
     <div class ="row">
         <div class ="col">
            ...
            Name = request.querystring("Name")
             ...
             <input type=text size=22px name = "Name" value = "<%=Name %>" class = "formbox"  >
             <input type=submit value = "Search" class = "regsubmit2"  class = "body" >&nbsp;
                </form>
