...
Double check your order and then select the "Make Your Payment with PayPal" button at the bottom of this page:
</td>
</tr>
</table>
...
<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" target= "Blank" method="post">
    ...
    <input type="hidden" name="notify_url" value="Http://www.AndresenEvents.com/iFrameEventOrderCompletion2.asp">   
