...
<tr>
<td width = "232" valign = "top" class = "body"><h3><center><b>Register for an Event</b></center></h3>
...
<td width = "232" valign = "top" class = "body"><h3><center><b>Create Your Event</b></center></h3>
Andresen Events puts you in chanrge of your event registration with simple but powerful tools to create, manage, and sell out your event. It's free to sign up and get started.
</td>
<td width = "3"><img src = "images/px.gif" width = "1" height = "1"></td>
<td width = "232" valign = "top" class = "body"><h3><center><b>Manage Your Event</b></center></h3>
...
<div align = "right"><a href = "RegistrySearch.asp?Action=List" class = "menu">Register Now</a><img src = "images/px.gif" width = "5" height = "1"></div><br>
</td>
<td width = "3"><img src = "images/px.gif" width = "1" height = "1"></td>
<td width = "232" valign = "top" class = "body">
<div align = "right"><a href = "regcreateSignIn.asp?Action=List" class = "menu">Create an Event Now</a><img src = "images/px.gif" width = "5" height = "1"></div><br>
</td>
<td width = "3"><img src = "images/px.gif" width = "1" height = "1"></td>
<td width = "232" valign = "top" class = "body">
<div align = "right"><a href = "regLogin.asp" class = "menu">Manage Your Event Now</a><img src = "images/px.gif" width = "5" height = "1"></div><br>
</td>
</tr>
<tr><td colspan = "5" class="body">
	<h3><b>Open Soon for Alpaca Shows</b></h3>
	Very soon we will be provide registration services for Alpaca Shows, and soon after we will offer registration services for a wide range of other types of events.
</td>
</tr> 
</table>
...
<tr><td bgcolor = "#5C82C2" height = "25"><a href = "regcreateSignIn.asp?Action=List" class = "whitebody">&nbsp;<font size = "2">Create Your Event</font></a></td></tr>
<tr><td height = "9"  ><img src = "px.gif" width = "1" height = "1"></td></tr>
<tr><td bgcolor = "#CC6D6A" height = "25"><a href = "regLogin.asp" class = "whitebody">&nbsp;<font size = "2">Manage Your Event</font></a></td></tr></table>
