...
<tr>
				<td class = "body" align ="left">
					<a name = "Featured"></a><h1><%=Sectiontitle1%></h1>
				</td>
			</tr>
			<tr>
		     	<td  class = "body"><br>
		...
		<% If Len(Sectiontitle2) > 2 Then %>
		<tr>
				<td class = "body" align ="left">
					<a name = "Featured"></a><br><h1><%=Sectiontitle2%></h1>
				</td>
			</tr>
		<tr>
				<td class = "body" align ="left" bgcolor = "#670000" height = "1"><img src = "images/px.gif" height = "1"></td>
		...
		<% If Len(Sectiontitle3) > 2 Then %>
		<tr>
				<td class = "body" align ="left">
					<a name = "Featured"></a><br><h1><%=Sectiontitle3%></h1>
				</td>
			</tr>
		<tr>
				<td class = "body" align ="left" bgcolor = "#670000" height = "1"><img src = "images/px.gif" height = "1"></td>
		...
		<% End If %>
		 <tr>
			...
			<% If Len(Sectiontitle4) > 2 Then %>
		<tr>
				<td class = "body" align ="left">
					<a name = "Featured"></a><br><h1><%=Sectiontitle4%></h1>
				</td>
			</tr>
		<tr>
				<td class = "body" align ="left" bgcolor = "#670000" height = "1"><img src = "images/px.gif" height = "1"></td>
...
<% If Len(Sectiontitle5) > 2 Then %>
		<tr>
				<td class = "body" align ="left">
					<a name = "Featured"></a><br><h1><%=Sectiontitle5%></h1>
				</td>
			</tr>
		<tr>
				<td class = "body" align ="left" bgcolor = "#670000" height = "1"><img src = "images/px.gif" height = "1"></td>
		...
		<% End If %>
		 <tr>
			...
			<% If Len(Sectiontitle6) > 2 Then %>
		<tr>
				<td class = "body" align ="left">
					<a name = "Featured"></a><br><h1><%=Sectiontitle6%></h1>
				</td>
			</tr>
		<tr>
				<td class = "body" align ="left" bgcolor = "#670000" height = "1"><img src = "images/px.gif" height = "1"></td>
		...
		<% End If %>
		 <tr>
			...
			<% If Len(Sectiontitle7) > 2 Then %>
		<tr>
				<td class = "body" align ="left">
					<a name = "Featured"></a><br><h1><%=Sectiontitle7%></h1>
				</td>
			</tr>
		<tr>
				<td class = "body" align ="left" bgcolor = "#670000" height = "1"><img src = "images/px.gif" height = "1"></td>
