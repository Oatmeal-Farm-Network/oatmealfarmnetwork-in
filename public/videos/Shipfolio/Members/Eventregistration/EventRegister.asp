...
<form action= "EventRegister.asp?EventID=<%=EventID%>&Update=True#FormTop" name="OrderForm" method = "post">
...
<table  border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" width = "900" align = "center">	
<tr>
...
<form action= "EventRegisterPayment.asp?EventID=<%=EventID%>&EventName=<%=EventName%>&OrderTotal=<%=OrderTotal%>&PeopleID=<%=PeopleID%>" name="OrderForm" method = "post">
<div align = "right">
