...
<title>Edit Extra Options</title>
...
<tr><td class = "body2" colspan  "3" height = "1">
	...
	if rs.eof then 
%>
Currently there are no Extra Options listed. To add Extra Options please <a href ="ExtraOptionsAdd.asp?EventID=<%=EventID%>" class = "menu2">click here</a>.<br>
