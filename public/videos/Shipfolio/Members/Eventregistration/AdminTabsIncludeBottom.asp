...
<td  height = "20" width = "100" align = "center"  class = "tabBottomOn" align = "center"><b><a href = "/Administration/AdminBusinessHome.asp" class = "menu2">Businesse</a></b></td>
<% else %>
...
<% ShowAuctions = false
if ShowAuctions = True or session("PeopleID") = 674 or session("PeopleID") = 820 then   
