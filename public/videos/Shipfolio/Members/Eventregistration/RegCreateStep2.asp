...
'rowcount = CInt
rowcount = 1 
EventTimeZoneID = Request.Form("EventTimeZoneID")
...
'******************************************************************************************
If Edit = "True" and  len(BusinessAddressID) > 0then
...
'****************************************************************************************************
if Edit = "True" and len(BusinessPhoneID) > 0 then
...
if Edit = "True" or len(BusinessID) > 0 then
...
if Edit = "True" then
	...
	Query =  Query & " EventTimeZoneID = " & EventTimeZoneID & "," 
	Query =  Query & " where EventID = " & EventID & ";" 
...
if len(ScheduleStartTimeHour) > 0 then
...
response.redirect("RegCreateStep2Confirm.asp?EventID=" & EventID )
%>
