				...
				<table  border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"    valign = "top">
				  ...
				  <td width = "10">&nbsp;
					...
					<td class= "body"  valign = "top" colspan = "3" width = "600" align = "center">
						<table  border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"    valign = "top" width = "480">
						     <tr>
							  ...
							  <tr>
							  <tr>
								<td class= "body"  valign = "top"  width = "220">
								...
								<td class= "body"  valign = "top"  width = "260"></td>
							 </tr>
							 <tr>
								<td class = "body" colspan = "2">
									...
									If showlink = True Then %>
										<a href = "Productdetails.asp?prodID=<%=prodID %>" class = "body" >Click Here to Learn More</a>
