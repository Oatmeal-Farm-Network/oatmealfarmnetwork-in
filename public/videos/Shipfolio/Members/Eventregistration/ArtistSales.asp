		...
		SCounter = 0
						...
						rs.Open sql, conn, 3, 3   
							...
							rs.close
     						...
     						sql = "SELECT Distinct  * FROM sfProducts, sfCategories WHERE  sfProducts.prodCategoryId = sfCategories.CatID and sfProducts.CustID = " & custID & " order by sfProducts.prodCategoryId, ProdPrice DESC " 
...
<table   border="0" cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  align = "center"  valign ="top"  width = "625" height = "200">
	<tr>
	    ...
	    <td class = "body"  align = "left"  height = "83" valign = "top">
				...
				<table border = "0" width = "625"   leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0  align = "center" >
					<tr>
									...
									<td colspan = "2" ><h1>My Artwork for Sale</h1></td>
	
						
					</tr>
					<tr>
						<td colspan = "2"   height = "2"  background = "images/Underline.jpg"><img src = "images/px.gif" width = "625" height = "2"></td>
					</tr>
		...
		%>
					...
					<tr>
						<td colspan = "2"   height = "20"  >
							<H2><%=CategoryName%>dddd<br></H2>
						</td>
					</tr>
					<tr>
						<td colspan = "2"   height = "2"  background = "images/Underline.jpg"><img src = "images/px.gif". height = "2" width = "625"></td>
					</tr>
					<tr>
						<td colspan = "2"   height = "5"  ><img src = "images/px.gif" height = "2" width = "625"></td>
					</tr>
				</table>
