...
'response.write("eventID = " & eventID & "<br><br>")
'response.write("Edit = " & Edit & "<br><br>")
If Edit = "True" then
...
'response.write("<br><br>sql2 = " & sql2 & "<br><br>")
...
'response.write("EventLocationEmail = " & EventLocationEmail )
'**************************************************************************************************************
'  FIND THE EVENT TYPE
'**************************************************************************************************************
...
<br>
<form  name=form method="post" action="EditEvent2.asp">
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=5 cellspacing=5 width = "800" align = "center">
	...
	<tr>
		<td class ="body2" valign = "top" colspan = "2" >
			<H1>Edit Basic Facts about Your Event</H1>
		</td>
	</tr>	
...
%>
	...
	<tr>
	   ...
	   <tr>
        ...
        <br>
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=5 cellspacing=5 bgcolor = "#DBF5F3" width = "450" height = "422" align = "center">
				<tr>
				  <td  colspan = "2">
				     <h3>Event Location</h3>
						...
						<tr>
							...
							<td class = "body2" align = "left" >
								<input name="EventLocationName" Value ="<%=EventLocationName%>"  size = "23" maxlength = "61">
							</td>
						</tr>
						<tr>
							<td class = "body2" align = "right">
						...
						<tr>
							...
							<td  align = "left" valign = "top" class = "body2">
								<input name="PaymentZip"  size = "8" value = "<%=EventLocationZip%>">
							</td>
						</tr>
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=5 cellspacing=5 bgcolor = "#DBF5F3" width = "450" height = "622" align = "center">
				<tr>
				  <td  colspan = "2">
		...
		<script language="javascript1.2">
  		// attach the editor to the textarea with the identifier 'textarea1'.
  		 WYSIWYG.attach("textarea2");
		</script> 

			<TEXTAREA NAME="EventDescription" cols="70" rows="11" wrap="file" id = "textarea1"><%=EventDescription%></textarea>
				  ...
				  <td  colspan = "2" class = "body2">
					...
					<tr>
						...
						<td class = "body2" colspan = "2">
								...
								<img src = "images/px.gif" width = "20" height = "1"><small>Enter the name of the person or organization the chack should be written to.</small>
					...
					<tr>
						...
						<tr>
							<td  align = "left" class = "body2" colspan = "2">
								<img src = "images/px.gif" width = "22" height = "1">State / Provence: &nbsp;
					...
					<td  align = "left" valign = "top" class = "body2">
						<select size="1" name="PaymentCountry">
						 <% if len(PaymentCountry) > 1 then %>
						 	<option value="<%=PaymentCountry %>" selected><%=PaymentCountry %></option>
...
<table width = "918"  align = "center" bgcolor = "#DBF5F3" border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"   >
<tr>
	...
	<input name="Edit"  type = "hidden" value = "<%=Edit%>">
		...
		<input type=button value="Update"  class = "regsubmit2" onclick="verify();">
		<br>	<br>
