...
<table border = "0"  cellpadding=0 cellspacing=0 width = "<%=textwidth %>" align = "center" >
	<tr>
	   <td  valign = "top"   colspan = "3"><br><h2>Fleece Show</h2></td>
	</tr>
...
<table  border="0"  cellspacing="0" cellpadding="0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" width = "310" align = "center" ">
  <tr><td height = "4"><img src = "images/px.gif" height = "1" width = "1"></td>	
	<tr>
		...
		<tr>
   			<td class = "body" align = "center" ><h3>Fleece Show Fees</H3></td>
		</tr>
	</table>
</td>
</tr>
...
<tr><td colspan = "2" height = "5">&nbsp;</td></tr>
	...
	<% if len(FeePerFleece) > 0  or len(Price4) >0  then  %>
	...
	<% if len(FeePerFleece) >0 then  %>
	    <tr>
	      <td class = "smallbody" align = "right" width = "450">Fee Per Fleece:</td>
	      <td class = "smallbody" >&nbsp;<%=formatcurrency(FeePerFleece,2)%></td>
	    </tr>
	<% End If %>
    ...
    <% if len(Price1DiscountEndDate) > 3 then
    	If DateDiff("d", Price1DiscountEndDate, Date) > 1 Then %>
     	...
     	<% else %>
		   	<tr >
		   		<td class = "smallbody" align = "right">Discount Fee Per Fleece:</td>
