...
if SpeciesID = 2 then
	...
	<tr><td>
	<%	response.redirect("MembersAnimalAdd4.asp?AnimalID=" & AnimalID & "&SpeciesID=" & SpeciesID & "&NumberofAnimals=" & NumberofAnimals & "&BusinessID=" & BusinessID )
end if  
dim aID(40000)
dim aName(40000)

	sql2 = "select Animals.animalID, Animals.FullName from Animals order by Fullname"
...
<table border = "0" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"  cellpadding=0 cellspacing=0 bordercolor = ""  align = "center"  >
	...
	<tr><td>
<form action= 'MembersAnimalAdd4.asp?wizard=True&BusinessID=<%=BusinessID %>&AnimalID=<%=AnimalID%>&SpeciesID=<%=SpeciesID%>&NumberofAnimals=<%=NumberofAnimals%>&BusinessID=<%=BusinessID%>' method = "post" name = "myform">
