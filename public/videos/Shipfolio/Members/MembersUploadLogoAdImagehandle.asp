...
Query =  "Delete from Ads where Adtype = 'logo' and peopleID = " &  PeopleID  & " ; "
response.write("Query =" & Query  )
Conn.Execute(Query) 

Query =  "INSERT INTO Ads (PeopleID, AdImage, Adtype )" 
...
Response.Redirect("Default.asp?PeopleID=" & PeopleID  )
%>
</BODY>
</HTML>
