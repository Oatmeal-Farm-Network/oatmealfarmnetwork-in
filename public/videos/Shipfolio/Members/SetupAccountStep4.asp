...
strBody = strBody & "<a href = 'https://www.harvesthub.world/AccountConfirmation.asp?PeopleID=" & PeopleID &"'> http://www.HarvestHub.world/AccountConfirmation.asp</a><br><br>" & vbCrLf
...
strBody = strBody & "Activation Link: <a href = 'https://www.harvesthub.world/Join/USA/AccountConfirmation.asp?PeopleID=" & PeopleID & "'> https://www.HarvestHub.world/Join/USA/AccountConfirmation.asp</a><br>" & vbCrLf

strBody = strBody & "<br>Activation Code:<b>"  &  ActivationCode & "</b><br><br>" & vbCrLf
strBody = strBody & "If you've got any questions, or reckon you need some help, don't be shy to holler at us. We sure do appreciate your decision to ride with  Global Grange!<br>" & vbCrLf

strBody = strBody & "<tr><td><br><img src='https://www.globallivestocksolutions.com/logos/220pxwide/GGLogoImageSmall.png' alt='GG Logo' id='header-img' width=300px ><td></tr></table>"
...
With iMsg2  
 ...
 .From = "support@globalgrange.world"
 .To = PeopleEmail
 .bcc = "John@globalGrange.world"
...
If the email's a no-show, here's what to do:
		<ol>
			<li>Check your bulk mail folder / spam list to ensure you ain't blocking emails from support@globalgrange.world.</li>
			...
			<li>If none of that gets the job done, don't hesitate to drop us a line at <a href = "mailto:support@globalgrange.world" class = "body">support@globalgrange.world</a>.</li>
		</ol>
        <br />
