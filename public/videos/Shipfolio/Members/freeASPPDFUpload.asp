...
If uploadgood = True then

str1 = LCase(fileItem.FileName)
str2 = " "
If InStr(str1,str2) > 0 Then
	fileItem.FileName= Replace(str1, " ", "")
End If
...
str2 = "%20"
If InStr(str1,str2) > 0 Then
	fileItem.FileName= Replace(str1, "%20", "")
End If
str1 = LCase(fileItem.FileName)
str2 = "'"
If InStr(str1,str2) > 0 Then
...
Randomize
			fileItem.FileName =  CInt((minute(now) + Day(now) + Month(now) + Year(now))) & int(rnd() * 102 ) & fileItem.FileName
path="C:\inetpub\wwwroot\Livestockoftheworld\Uploads\"
response.write("Path=" & Path)

			streamFile.SaveToFile path & fileItem.FileName, 2
			streamFile.close
			response.Write("fileItem.FileName=" & fileItem.FileName )
End if
