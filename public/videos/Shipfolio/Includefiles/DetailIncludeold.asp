...
if speciesid = 25 or speciesid = 27 or speciesid = 19 then
...
<tr><td class = 'body'><% if count > 10 then %><%= adstart %> - <%= adend %> Listings of <%=count %>&nbsp;<br /><% end if %></td>
...
<% else %>
<div align = Right><%=count %> Result<% if count > 1 then %>s<% end if %><br /></div>
<% end if %>
<% 
...
if speciesid = 25 or speciesid = 27 or speciesid = 28 or speciesid = 19  then
