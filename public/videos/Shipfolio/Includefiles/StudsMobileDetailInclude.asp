...
sql= sql & " FROM Animals, Pricing,  Ancestrypercents, Photos, colors , address, People, SpeciesBreedLookupTable "
sql= sql & " WHERE animals.speciesID = " & speciesID & " and animals.PeopleID = People.PeopleID  and  animals.BreedID = SpeciesBreedLookupTable.BreedLookupID and People.AddressID = address.AddressID And pricing.id=Animals.id and Ancestrypercents.id=Animals.id And Photos.id=Animals.id  and Colors.id=Animals.id and subscriptionlevel > 0 and PublishStud = 1 and people.country_id = " & country_id & "  and  sold = 0 " & Categorysearch & Breedsearch & Colorsearch &  OBOSearch & currentminStudFeeSearch & currentmaxStudFeeSearch &  QAncestry & QPercentAccoyo & CategorySearch & Statesearch  
sql= sql & " ) "
sql= sql & " SELECT * "
...
<div class="container-fluid" align = "center" >
    ...
    <div class = "row nowrap" align = "center"  style="background-color: #f9f6ee">
      ...
      <a href = "/Animals/Details.asp?ID=<%=AnimalID%>&DetailType=<%=DetailType%>&CurrentPeopleID=<%=CurrentpeopleID %>" >
          <center><img src = "<%= PhotoID %>" class="img" alt = "Image" style="border:1px solid black;" align="center" width ="80%" ></center></a>
        </div>
</div>
